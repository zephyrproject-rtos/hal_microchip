/*
 * Copyright (c) 2025 Emirates Automation
 * SPDX-License-Identifier: Apache-2.0
 */


#ifndef DT_BINDINGS_SAM_SAM0_SAM_D11_MICROCHIP_SAM_H_
#define DT_BINDINGS_SAM_SAM0_SAM_D11_MICROCHIP_SAM_H_

/*
 * @name Microchip SAM gpio port list.
 * @{
 */
...
/**
 * @name Microchip SAM peripheral list.
 * @{
 */
...
/**
 * @name Microchip SAM pin function list.
 * @{
 */
...
/**
 * @name Microchip SAM pinmux bit field mask and positions.
 * @{
 */
...
/**
 * @brief Microchip SAM pinmux bit field.
 * @anchor SAM_PINMUX
 *
 * Fields:
 *
...
#endif  /* DT_BINDINGS_PINCTRL_Microchip_SAM_H_ */
