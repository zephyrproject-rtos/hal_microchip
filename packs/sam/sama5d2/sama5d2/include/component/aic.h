...
#define AIC_SMR_PRIORITY(value)               (AIC_SMR_PRIORITY_Msk & (_UINT32_(value) << AIC_SMR_PRIORITY_Pos)) /* Assignment of value for PRIORITY in the AIC_SMR register */
...
#define AIC_IPR0_PID1(value)                  (AIC_IPR0_PID1_Msk & (_UINT32_(value) << AIC_IPR0_PID1_Pos)) /* Assignment of value for PID1 in the AIC_IPR0 register */
...
#define AIC_IPR2_SYS(value)                   (AIC_IPR2_SYS_Msk & (_UINT32_(value) << AIC_IPR2_SYS_Pos)) /* Assignment of value for SYS in the AIC_IPR2 register */
