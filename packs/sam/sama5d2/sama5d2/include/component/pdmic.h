...
#define PDMIC_CR_SWRST(value)                 (PDMIC_CR_SWRST_Msk & (_UINT32_(value) << PDMIC_CR_SWRST_Pos)) /* Assignment of value for SWRST in the PDMIC_CR register */
...
#define PDMIC_CR_ENPDM(value)                 (PDMIC_CR_ENPDM_Msk & (_UINT32_(value) << PDMIC_CR_ENPDM_Pos)) /* Assignment of value for ENPDM in the PDMIC_CR register */
...
#define PDMIC_MR_CLKS(value)                  (PDMIC_MR_CLKS_Msk & (_UINT32_(value) << PDMIC_MR_CLKS_Pos)) /* Assignment of value for CLKS in the PDMIC_MR register */
...
#define PDMIC_MR_PRESCAL(value)               (PDMIC_MR_PRESCAL_Msk & (_UINT32_(value) << PDMIC_MR_PRESCAL_Pos)) /* Assignment of value for PRESCAL in the PDMIC_MR register */
...
#define PDMIC_CDR_DATA(value)                 (PDMIC_CDR_DATA_Msk & (_UINT32_(value) << PDMIC_CDR_DATA_Pos)) /* Assignment of value for DATA in the PDMIC_CDR register */
...
#define PDMIC_IER_DRDY(value)                 (PDMIC_IER_DRDY_Msk & (_UINT32_(value) << PDMIC_IER_DRDY_Pos)) /* Assignment of value for DRDY in the PDMIC_IER register */
...
#define PDMIC_IER_OVRE(value)                 (PDMIC_IER_OVRE_Msk & (_UINT32_(value) << PDMIC_IER_OVRE_Pos)) /* Assignment of value for OVRE in the PDMIC_IER register */
...
#define PDMIC_IDR_DRDY(value)                 (PDMIC_IDR_DRDY_Msk & (_UINT32_(value) << PDMIC_IDR_DRDY_Pos)) /* Assignment of value for DRDY in the PDMIC_IDR register */
...
#define PDMIC_IDR_OVRE(value)                 (PDMIC_IDR_OVRE_Msk & (_UINT32_(value) << PDMIC_IDR_OVRE_Pos)) /* Assignment of value for OVRE in the PDMIC_IDR register */
...
#define PDMIC_IMR_DRDY(value)                 (PDMIC_IMR_DRDY_Msk & (_UINT32_(value) << PDMIC_IMR_DRDY_Pos)) /* Assignment of value for DRDY in the PDMIC_IMR register */
...
#define PDMIC_IMR_OVRE(value)                 (PDMIC_IMR_OVRE_Msk & (_UINT32_(value) << PDMIC_IMR_OVRE_Pos)) /* Assignment of value for OVRE in the PDMIC_IMR register */
...
#define PDMIC_ISR_FIFOCNT(value)              (PDMIC_ISR_FIFOCNT_Msk & (_UINT32_(value) << PDMIC_ISR_FIFOCNT_Pos)) /* Assignment of value for FIFOCNT in the PDMIC_ISR register */
...
#define PDMIC_ISR_DRDY(value)                 (PDMIC_ISR_DRDY_Msk & (_UINT32_(value) << PDMIC_ISR_DRDY_Pos)) /* Assignment of value for DRDY in the PDMIC_ISR register */
...
#define PDMIC_ISR_OVRE(value)                 (PDMIC_ISR_OVRE_Msk & (_UINT32_(value) << PDMIC_ISR_OVRE_Pos)) /* Assignment of value for OVRE in the PDMIC_ISR register */
...
#define PDMIC_DSPR0_HPFBYP(value)             (PDMIC_DSPR0_HPFBYP_Msk & (_UINT32_(value) << PDMIC_DSPR0_HPFBYP_Pos)) /* Assignment of value for HPFBYP in the PDMIC_DSPR0 register */
...
#define PDMIC_DSPR0_SINBYP(value)             (PDMIC_DSPR0_SINBYP_Msk & (_UINT32_(value) << PDMIC_DSPR0_SINBYP_Pos)) /* Assignment of value for SINBYP in the PDMIC_DSPR0 register */
...
#define PDMIC_DSPR0_SIZE(value)               (PDMIC_DSPR0_SIZE_Msk & (_UINT32_(value) << PDMIC_DSPR0_SIZE_Pos)) /* Assignment of value for SIZE in the PDMIC_DSPR0 register */
...
#define PDMIC_DSPR0_OSR(value)                (PDMIC_DSPR0_OSR_Msk & (_UINT32_(value) << PDMIC_DSPR0_OSR_Pos)) /* Assignment of value for OSR in the PDMIC_DSPR0 register */
...
#define PDMIC_DSPR0_SCALE(value)              (PDMIC_DSPR0_SCALE_Msk & (_UINT32_(value) << PDMIC_DSPR0_SCALE_Pos)) /* Assignment of value for SCALE in the PDMIC_DSPR0 register */
...
#define PDMIC_DSPR0_SHIFT(value)              (PDMIC_DSPR0_SHIFT_Msk & (_UINT32_(value) << PDMIC_DSPR0_SHIFT_Pos)) /* Assignment of value for SHIFT in the PDMIC_DSPR0 register */
...
#define PDMIC_DSPR1_DGAIN(value)              (PDMIC_DSPR1_DGAIN_Msk & (_UINT32_(value) << PDMIC_DSPR1_DGAIN_Pos)) /* Assignment of value for DGAIN in the PDMIC_DSPR1 register */
...
#define PDMIC_DSPR1_OFFSET(value)             (PDMIC_DSPR1_OFFSET_Msk & (_UINT32_(value) << PDMIC_DSPR1_OFFSET_Pos)) /* Assignment of value for OFFSET in the PDMIC_DSPR1 register */
...
#define PDMIC_WPMR_WPEN(value)                (PDMIC_WPMR_WPEN_Msk & (_UINT32_(value) << PDMIC_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the PDMIC_WPMR register */
...
#define PDMIC_WPMR_WPKEY(value)               (PDMIC_WPMR_WPKEY_Msk & (_UINT32_(value) << PDMIC_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the PDMIC_WPMR register */
...
#define PDMIC_WPSR_WPVS(value)                (PDMIC_WPSR_WPVS_Msk & (_UINT32_(value) << PDMIC_WPSR_WPVS_Pos)) /* Assignment of value for WPVS in the PDMIC_WPSR register */
...
#define PDMIC_WPSR_WPVSRC(value)              (PDMIC_WPSR_WPVSRC_Msk & (_UINT32_(value) << PDMIC_WPSR_WPVSRC_Pos)) /* Assignment of value for WPVSRC in the PDMIC_WPSR register */
#define PDMIC_WPSR_Msk                        _UINT32_(0x00FFFF01)                                 /* (PDMIC_WPSR) Register Mask  */


/* PDMIC register offsets definitions */
