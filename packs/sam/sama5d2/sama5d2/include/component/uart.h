...
#define UART_CR_RETTO(value)                  (UART_CR_RETTO_Msk & (_UINT32_(value) << UART_CR_RETTO_Pos)) /* Assignment of value for RETTO in the UART_CR register */
...
#define UART_CR_STTTO(value)                  (UART_CR_STTTO_Msk & (_UINT32_(value) << UART_CR_STTTO_Pos)) /* Assignment of value for STTTO in the UART_CR register */
...
#define UART_CR_Msk                           _UINT32_(0x00001DFC)                                 /* (UART_CR) Register Mask  */
...
#define UART_IER_TIMEOUT(value)               (UART_IER_TIMEOUT_Msk & (_UINT32_(value) << UART_IER_TIMEOUT_Pos)) /* Assignment of value for TIMEOUT in the UART_IER register */
...
#define UART_IDR_TIMEOUT(value)               (UART_IDR_TIMEOUT_Msk & (_UINT32_(value) << UART_IDR_TIMEOUT_Pos)) /* Assignment of value for TIMEOUT in the UART_IDR register */
...
#define UART_IMR_TIMEOUT(value)               (UART_IMR_TIMEOUT_Msk & (_UINT32_(value) << UART_IMR_TIMEOUT_Pos)) /* Assignment of value for TIMEOUT in the UART_IMR register */
...
#define UART_SR_TIMEOUT(value)                (UART_SR_TIMEOUT_Msk & (_UINT32_(value) << UART_SR_TIMEOUT_Pos)) /* Assignment of value for TIMEOUT in the UART_SR register */
...
#define UART_SR_Msk                           _UINT32_(0x000083E3)                                 /* (UART_SR) Register Mask  */
...
#define UART_RTOR_TO(value)                   (UART_RTOR_TO_Msk & (_UINT32_(value) << UART_RTOR_TO_Pos)) /* Assignment of value for TO in the UART_RTOR register */
