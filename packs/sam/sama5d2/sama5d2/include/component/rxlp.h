...
#define RXLP_CR_RSTRX(value)                  (RXLP_CR_RSTRX_Msk & (_UINT32_(value) << RXLP_CR_RSTRX_Pos)) /* Assignment of value for RSTRX in the RXLP_CR register */
...
#define RXLP_CR_RXEN(value)                   (RXLP_CR_RXEN_Msk & (_UINT32_(value) << RXLP_CR_RXEN_Pos)) /* Assignment of value for RXEN in the RXLP_CR register */
...
#define RXLP_CR_RXDIS(value)                  (RXLP_CR_RXDIS_Msk & (_UINT32_(value) << RXLP_CR_RXDIS_Pos)) /* Assignment of value for RXDIS in the RXLP_CR register */
...
#define RXLP_MR_FILTER(value)                 (RXLP_MR_FILTER_Msk & (_UINT32_(value) << RXLP_MR_FILTER_Pos)) /* Assignment of value for FILTER in the RXLP_MR register */
...
#define RXLP_MR_PAR(value)                    (RXLP_MR_PAR_Msk & (_UINT32_(value) << RXLP_MR_PAR_Pos)) /* Assignment of value for PAR in the RXLP_MR register */
...
#define RXLP_RHR_RXCHR(value)                 (RXLP_RHR_RXCHR_Msk & (_UINT32_(value) << RXLP_RHR_RXCHR_Pos)) /* Assignment of value for RXCHR in the RXLP_RHR register */
...
#define RXLP_BRGR_CD(value)                   (RXLP_BRGR_CD_Msk & (_UINT32_(value) << RXLP_BRGR_CD_Pos)) /* Assignment of value for CD in the RXLP_BRGR register */
...
#define RXLP_CMPR_VAL1(value)                 (RXLP_CMPR_VAL1_Msk & (_UINT32_(value) << RXLP_CMPR_VAL1_Pos)) /* Assignment of value for VAL1 in the RXLP_CMPR register */
...
#define RXLP_CMPR_VAL2(value)                 (RXLP_CMPR_VAL2_Msk & (_UINT32_(value) << RXLP_CMPR_VAL2_Pos)) /* Assignment of value for VAL2 in the RXLP_CMPR register */
...
#define RXLP_WPMR_WPEN(value)                 (RXLP_WPMR_WPEN_Msk & (_UINT32_(value) << RXLP_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the RXLP_WPMR register */
...
#define RXLP_WPMR_WPKEY(value)                (RXLP_WPMR_WPKEY_Msk & (_UINT32_(value) << RXLP_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the RXLP_WPMR register */
...
/* RXLP register offsets definitions */
