...
/* -------- ISC_DAD : (ISC Offset: 0x00) (R/W 32) DMA Address Register -------- */
#define ISC_DAD_AD0_Pos                       _UINT32_(0)                                          /* (ISC_DAD) Channel Address Position */
#define ISC_DAD_AD0_Msk                       (_UINT32_(0xFFFFFFFF) << ISC_DAD_AD0_Pos)            /* (ISC_DAD) Channel Address Mask */
#define ISC_DAD_AD0(value)                    (ISC_DAD_AD0_Msk & (_UINT32_(value) << ISC_DAD_AD0_Pos)) /* Assignment of value for AD0 in the ISC_DAD register */
#define ISC_DAD_Msk                           _UINT32_(0xFFFFFFFF)                                 /* (ISC_DAD) Register Mask  */


/* -------- ISC_DST : (ISC Offset: 0x04) (R/W 32) DMA Stride Register -------- */
#define ISC_DST_ST0_Pos                       _UINT32_(0)                                          /* (ISC_DST) Channel Stride Position */
#define ISC_DST_ST0_Msk                       (_UINT32_(0xFFFF) << ISC_DST_ST0_Pos)                /* (ISC_DST) Channel Stride Mask */
#define ISC_DST_ST0(value)                    (ISC_DST_ST0_Msk & (_UINT32_(value) << ISC_DST_ST0_Pos)) /* Assignment of value for ST0 in the ISC_DST register */
#define ISC_DST_Msk                           _UINT32_(0x0000FFFF)                                 /* (ISC_DST) Register Mask  */
...
#define ISC_CLKCFG_ICDIV(value)               (ISC_CLKCFG_ICDIV_Msk & (_UINT32_(value) << ISC_CLKCFG_ICDIV_Pos)) /* Assignment of value for ICDIV in the ISC_CLKCFG register */
...
#define ISC_CLKCFG_ICSEL(value)               (ISC_CLKCFG_ICSEL_Msk & (_UINT32_(value) << ISC_CLKCFG_ICSEL_Pos)) /* Assignment of value for ICSEL in the ISC_CLKCFG register */
...
#define ISC_CLKCFG_MCSEL(value)               (ISC_CLKCFG_MCSEL_Msk & (_UINT32_(value) << ISC_CLKCFG_MCSEL_Pos)) /* Assignment of value for MCSEL in the ISC_CLKCFG register */
...
#define ISC_CBC_CTRL_ENABLE(value)            (ISC_CBC_CTRL_ENABLE_Msk & (_UINT32_(value) << ISC_CBC_CTRL_ENABLE_Pos)) /* Assignment of value for ENABLE in the ISC_CBC_CTRL register */
...
#define ISC_CBC_CFG_CCIR(value)               (ISC_CBC_CFG_CCIR_Msk & (_UINT32_(value) << ISC_CBC_CFG_CCIR_Pos)) /* Assignment of value for CCIR in the ISC_CBC_CFG register */
...
#define ISC_CBC_CFG_CCIRMODE(value)           (ISC_CBC_CFG_CCIRMODE_Msk & (_UINT32_(value) << ISC_CBC_CFG_CCIRMODE_Pos)) /* Assignment of value for CCIRMODE in the ISC_CBC_CFG register */
...
#define ISC_CBC_BRIGHT_BRIGHT(value)          (ISC_CBC_BRIGHT_BRIGHT_Msk & (_UINT32_(value) << ISC_CBC_BRIGHT_BRIGHT_Pos)) /* Assignment of value for BRIGHT in the ISC_CBC_BRIGHT register */
...
#define ISC_CBC_CONTRAST_CONTRAST(value)      (ISC_CBC_CONTRAST_CONTRAST_Msk & (_UINT32_(value) << ISC_CBC_CONTRAST_CONTRAST_Pos)) /* Assignment of value for CONTRAST in the ISC_CBC_CONTRAST register */
...
#define ISC_DAD_REG_OFST               _UINT32_(0x00)      /* (ISC_DAD) DMA Address Register Offset */
#define ISC_DST_REG_OFST               _UINT32_(0x04)      /* (ISC_DST) DMA Stride Register Offset */
...
/* ISC_SUB0 register API structure */
typedef struct
{
  __IO  uint32_t                       ISC_DAD;            /* Offset: 0x00 (R/W  32) DMA Address Register */
  __IO  uint32_t                       ISC_DST;            /* Offset: 0x04 (R/W  32) DMA Stride Register */
