...
#define SFRBU_PSWBUCTRL_SCTRL(value)          (SFRBU_PSWBUCTRL_SCTRL_Msk & (_UINT32_(value) << SFRBU_PSWBUCTRL_SCTRL_Pos)) /* Assignment of value for SCTRL in the SFRBU_PSWBUCTRL register */
...
#define SFRBU_PSWBUCTRL_SSWCTRL(value)        (SFRBU_PSWBUCTRL_SSWCTRL_Msk & (_UINT32_(value) << SFRBU_PSWBUCTRL_SSWCTRL_Pos)) /* Assignment of value for SSWCTRL in the SFRBU_PSWBUCTRL register */
...
#define SFRBU_PSWBUCTRL_SMCTRL(value)         (SFRBU_PSWBUCTRL_SMCTRL_Msk & (_UINT32_(value) << SFRBU_PSWBUCTRL_SMCTRL_Pos)) /* Assignment of value for SMCTRL in the SFRBU_PSWBUCTRL register */
...
#define SFRBU_PSWBUCTRL_STATE(value)          (SFRBU_PSWBUCTRL_STATE_Msk & (_UINT32_(value) << SFRBU_PSWBUCTRL_STATE_Pos)) /* Assignment of value for STATE in the SFRBU_PSWBUCTRL register */
...
#define SFRBU_PSWBUCTRL_KEYPSWMODE(value)     (SFRBU_PSWBUCTRL_KEYPSWMODE_Msk & (_UINT32_(value) << SFRBU_PSWBUCTRL_KEYPSWMODE_Pos)) /* Assignment of value for KEYPSWMODE in the SFRBU_PSWBUCTRL register */
...
#define SFRBU_TSRANGECFG_TSHRSEL(value)       (SFRBU_TSRANGECFG_TSHRSEL_Msk & (_UINT32_(value) << SFRBU_TSRANGECFG_TSHRSEL_Pos)) /* Assignment of value for TSHRSEL in the SFRBU_TSRANGECFG register */
...
#define SFRBU_DDRBUMCR_BUMEN(value)           (SFRBU_DDRBUMCR_BUMEN_Msk & (_UINT32_(value) << SFRBU_DDRBUMCR_BUMEN_Pos)) /* Assignment of value for BUMEN in the SFRBU_DDRBUMCR register */
...
#define SFRBU_RXLPPUCR_RXDPUCTRL(value)       (SFRBU_RXLPPUCR_RXDPUCTRL_Msk & (_UINT32_(value) << SFRBU_RXLPPUCR_RXDPUCTRL_Pos)) /* Assignment of value for RXDPUCTRL in the SFRBU_RXLPPUCR register */
