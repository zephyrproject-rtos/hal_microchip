...
#define GMAC_SAT_FILTSORD(value)              (GMAC_SAT_FILTSORD_Msk & (_UINT32_(value) << GMAC_SAT_FILTSORD_Pos)) /* Assignment of value for FILTSORD in the GMAC_SAT register */
...
#define GMAC_SAT_FILTBMASK(value)             (GMAC_SAT_FILTBMASK_Msk & (_UINT32_(value) << GMAC_SAT_FILTBMASK_Pos)) /* Assignment of value for FILTBMASK in the GMAC_SAT register */
...
#define GMAC_ST2CW1_DISMASK(value)            (GMAC_ST2CW1_DISMASK_Msk & (_UINT32_(value) << GMAC_ST2CW1_DISMASK_Pos)) /* Assignment of value for DISMASK in the GMAC_ST2CW1 register */
