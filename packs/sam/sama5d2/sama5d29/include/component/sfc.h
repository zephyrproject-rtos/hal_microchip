...
#define SFC_KR_KEY(value)                     (SFC_KR_KEY_Msk & (_UINT32_(value) << SFC_KR_KEY_Pos)) /* Assignment of value for KEY in the SFC_KR register */
...
#define SFC_MR_MSK(value)                     (SFC_MR_MSK_Msk & (_UINT32_(value) << SFC_MR_MSK_Pos)) /* Assignment of value for MSK in the SFC_MR register */
...
#define SFC_MR_SASEL(value)                   (SFC_MR_SASEL_Msk & (_UINT32_(value) << SFC_MR_SASEL_Pos)) /* Assignment of value for SASEL in the SFC_MR register */
...
#define SFC_IER_PGMC(value)                   (SFC_IER_PGMC_Msk & (_UINT32_(value) << SFC_IER_PGMC_Pos)) /* Assignment of value for PGMC in the SFC_IER register */
...
#define SFC_IER_PGMF(value)                   (SFC_IER_PGMF_Msk & (_UINT32_(value) << SFC_IER_PGMF_Pos)) /* Assignment of value for PGMF in the SFC_IER register */
...
#define SFC_IER_LCHECK(value)                 (SFC_IER_LCHECK_Msk & (_UINT32_(value) << SFC_IER_LCHECK_Pos)) /* Assignment of value for LCHECK in the SFC_IER register */
...
#define SFC_IER_ACE(value)                    (SFC_IER_ACE_Msk & (_UINT32_(value) << SFC_IER_ACE_Pos)) /* Assignment of value for ACE in the SFC_IER register */
...
#define SFC_IDR_PGMC(value)                   (SFC_IDR_PGMC_Msk & (_UINT32_(value) << SFC_IDR_PGMC_Pos)) /* Assignment of value for PGMC in the SFC_IDR register */
...
#define SFC_IDR_PGMF(value)                   (SFC_IDR_PGMF_Msk & (_UINT32_(value) << SFC_IDR_PGMF_Pos)) /* Assignment of value for PGMF in the SFC_IDR register */
...
#define SFC_IDR_LCHECK(value)                 (SFC_IDR_LCHECK_Msk & (_UINT32_(value) << SFC_IDR_LCHECK_Pos)) /* Assignment of value for LCHECK in the SFC_IDR register */
...
#define SFC_IDR_ACE(value)                    (SFC_IDR_ACE_Msk & (_UINT32_(value) << SFC_IDR_ACE_Pos)) /* Assignment of value for ACE in the SFC_IDR register */
...
#define SFC_IMR_PGMC(value)                   (SFC_IMR_PGMC_Msk & (_UINT32_(value) << SFC_IMR_PGMC_Pos)) /* Assignment of value for PGMC in the SFC_IMR register */
...
#define SFC_IMR_PGMF(value)                   (SFC_IMR_PGMF_Msk & (_UINT32_(value) << SFC_IMR_PGMF_Pos)) /* Assignment of value for PGMF in the SFC_IMR register */
...
#define SFC_IMR_LCHECK(value)                 (SFC_IMR_LCHECK_Msk & (_UINT32_(value) << SFC_IMR_LCHECK_Pos)) /* Assignment of value for LCHECK in the SFC_IMR register */
...
#define SFC_IMR_ACE(value)                    (SFC_IMR_ACE_Msk & (_UINT32_(value) << SFC_IMR_ACE_Pos)) /* Assignment of value for ACE in the SFC_IMR register */
...
#define SFC_SR_PGMC(value)                    (SFC_SR_PGMC_Msk & (_UINT32_(value) << SFC_SR_PGMC_Pos)) /* Assignment of value for PGMC in the SFC_SR register */
...
#define SFC_SR_PGMF(value)                    (SFC_SR_PGMF_Msk & (_UINT32_(value) << SFC_SR_PGMF_Pos)) /* Assignment of value for PGMF in the SFC_SR register */
...
#define SFC_SR_LCHECK(value)                  (SFC_SR_LCHECK_Msk & (_UINT32_(value) << SFC_SR_LCHECK_Pos)) /* Assignment of value for LCHECK in the SFC_SR register */
...
#define SFC_SR_ACE(value)                     (SFC_SR_ACE_Msk & (_UINT32_(value) << SFC_SR_ACE_Pos)) /* Assignment of value for ACE in the SFC_SR register */
#define SFC_SR_Msk                            _UINT32_(0x00020013)                                 /* (SFC_SR) Register Mask  */
...
#define SFC_DR_DATA(value)                    (SFC_DR_DATA_Msk & (_UINT32_(value) << SFC_DR_DATA_Pos)) /* Assignment of value for DATA in the SFC_DR register */
#define SFC_DR_Msk                            _UINT32_(0xFFFFFFFF)                                 /* (SFC_DR) Register Mask  */


/* SFC register offsets definitions */
