...
#define PTC_CMD_CMD(value)                    (PTC_CMD_CMD_Msk & (_UINT8_(value) << PTC_CMD_CMD_Pos)) /* Assignment of value for CMD in the PTC_CMD register */
...
#define PTC_ISR_NOTIFY0(value)                (PTC_ISR_NOTIFY0_Msk & (_UINT8_(value) << PTC_ISR_NOTIFY0_Pos)) /* Assignment of value for NOTIFY0 in the PTC_ISR register */
...
#define PTC_ISR_IRQ0(value)                   (PTC_ISR_IRQ0_Msk & (_UINT8_(value) << PTC_ISR_IRQ0_Pos)) /* Assignment of value for IRQ0 in the PTC_ISR register */
...
#define PTC_ISR_IRQ1(value)                   (PTC_ISR_IRQ1_Msk & (_UINT8_(value) << PTC_ISR_IRQ1_Pos)) /* Assignment of value for IRQ1 in the PTC_ISR register */
...
#define PTC_ISR_IRQ2(value)                   (PTC_ISR_IRQ2_Msk & (_UINT8_(value) << PTC_ISR_IRQ2_Pos)) /* Assignment of value for IRQ2 in the PTC_ISR register */
...
#define PTC_ISR_IRQ3(value)                   (PTC_ISR_IRQ3_Msk & (_UINT8_(value) << PTC_ISR_IRQ3_Pos)) /* Assignment of value for IRQ3 in the PTC_ISR register */
...
#define PTC_IED_IER0(value)                   (PTC_IED_IER0_Msk & (_UINT8_(value) << PTC_IED_IER0_Pos)) /* Assignment of value for IER0 in the PTC_IED register */
...
#define PTC_IED_IER1(value)                   (PTC_IED_IER1_Msk & (_UINT8_(value) << PTC_IED_IER1_Pos)) /* Assignment of value for IER1 in the PTC_IED register */
...
#define PTC_IED_IER2(value)                   (PTC_IED_IER2_Msk & (_UINT8_(value) << PTC_IED_IER2_Pos)) /* Assignment of value for IER2 in the PTC_IED register */
...
#define PTC_IED_IER3(value)                   (PTC_IED_IER3_Msk & (_UINT8_(value) << PTC_IED_IER3_Pos)) /* Assignment of value for IER3 in the PTC_IED register */
