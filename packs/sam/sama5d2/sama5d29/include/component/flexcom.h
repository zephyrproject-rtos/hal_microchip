...
/* SPI mode */
#define FLEX_US_CR_SPI_RSTRX_Pos              _UINT32_(2)                                          /* (FLEX_US_CR) Reset Receiver Position */
#define FLEX_US_CR_SPI_RSTRX_Msk              (_UINT32_(0x1) << FLEX_US_CR_SPI_RSTRX_Pos)          /* (FLEX_US_CR) Reset Receiver Mask */
#define FLEX_US_CR_SPI_RSTRX(value)           (FLEX_US_CR_SPI_RSTRX_Msk & (_UINT32_(value) << FLEX_US_CR_SPI_RSTRX_Pos))
#define FLEX_US_CR_SPI_RSTTX_Pos              _UINT32_(3)                                          /* (FLEX_US_CR) Reset Transmitter Position */
#define FLEX_US_CR_SPI_RSTTX_Msk              (_UINT32_(0x1) << FLEX_US_CR_SPI_RSTTX_Pos)          /* (FLEX_US_CR) Reset Transmitter Mask */
#define FLEX_US_CR_SPI_RSTTX(value)           (FLEX_US_CR_SPI_RSTTX_Msk & (_UINT32_(value) << FLEX_US_CR_SPI_RSTTX_Pos))
#define FLEX_US_CR_SPI_RXEN_Pos               _UINT32_(4)                                          /* (FLEX_US_CR) Receiver Enable Position */
#define FLEX_US_CR_SPI_RXEN_Msk               (_UINT32_(0x1) << FLEX_US_CR_SPI_RXEN_Pos)           /* (FLEX_US_CR) Receiver Enable Mask */
#define FLEX_US_CR_SPI_RXEN(value)            (FLEX_US_CR_SPI_RXEN_Msk & (_UINT32_(value) << FLEX_US_CR_SPI_RXEN_Pos))
#define FLEX_US_CR_SPI_RXDIS_Pos              _UINT32_(5)                                          /* (FLEX_US_CR) Receiver Disable Position */
#define FLEX_US_CR_SPI_RXDIS_Msk              (_UINT32_(0x1) << FLEX_US_CR_SPI_RXDIS_Pos)          /* (FLEX_US_CR) Receiver Disable Mask */
#define FLEX_US_CR_SPI_RXDIS(value)           (FLEX_US_CR_SPI_RXDIS_Msk & (_UINT32_(value) << FLEX_US_CR_SPI_RXDIS_Pos))
#define FLEX_US_CR_SPI_TXEN_Pos               _UINT32_(6)                                          /* (FLEX_US_CR) Transmitter Enable Position */
#define FLEX_US_CR_SPI_TXEN_Msk               (_UINT32_(0x1) << FLEX_US_CR_SPI_TXEN_Pos)           /* (FLEX_US_CR) Transmitter Enable Mask */
#define FLEX_US_CR_SPI_TXEN(value)            (FLEX_US_CR_SPI_TXEN_Msk & (_UINT32_(value) << FLEX_US_CR_SPI_TXEN_Pos))
#define FLEX_US_CR_SPI_TXDIS_Pos              _UINT32_(7)                                          /* (FLEX_US_CR) Transmitter Disable Position */
#define FLEX_US_CR_SPI_TXDIS_Msk              (_UINT32_(0x1) << FLEX_US_CR_SPI_TXDIS_Pos)          /* (FLEX_US_CR) Transmitter Disable Mask */
#define FLEX_US_CR_SPI_TXDIS(value)           (FLEX_US_CR_SPI_TXDIS_Msk & (_UINT32_(value) << FLEX_US_CR_SPI_TXDIS_Pos))
#define FLEX_US_CR_SPI_RSTSTA_Pos             _UINT32_(8)                                          /* (FLEX_US_CR) Reset Status Bits Position */
#define FLEX_US_CR_SPI_RSTSTA_Msk             (_UINT32_(0x1) << FLEX_US_CR_SPI_RSTSTA_Pos)         /* (FLEX_US_CR) Reset Status Bits Mask */
#define FLEX_US_CR_SPI_RSTSTA(value)          (FLEX_US_CR_SPI_RSTSTA_Msk & (_UINT32_(value) << FLEX_US_CR_SPI_RSTSTA_Pos))
#define FLEX_US_CR_SPI_FCS_Pos                _UINT32_(18)                                         /* (FLEX_US_CR) Force SPI Chip Select Position */
#define FLEX_US_CR_SPI_FCS_Msk                (_UINT32_(0x1) << FLEX_US_CR_SPI_FCS_Pos)            /* (FLEX_US_CR) Force SPI Chip Select Mask */
#define FLEX_US_CR_SPI_FCS(value)             (FLEX_US_CR_SPI_FCS_Msk & (_UINT32_(value) << FLEX_US_CR_SPI_FCS_Pos))
#define FLEX_US_CR_SPI_RCS_Pos                _UINT32_(19)                                         /* (FLEX_US_CR) Release SPI Chip Select Position */
#define FLEX_US_CR_SPI_RCS_Msk                (_UINT32_(0x1) << FLEX_US_CR_SPI_RCS_Pos)            /* (FLEX_US_CR) Release SPI Chip Select Mask */
#define FLEX_US_CR_SPI_RCS(value)             (FLEX_US_CR_SPI_RCS_Msk & (_UINT32_(value) << FLEX_US_CR_SPI_RCS_Pos))
#define FLEX_US_CR_SPI_Msk                    _UINT32_(0x000C01FC)                                 /* (FLEX_US_CR_SPI) Register Mask  */
...
/* SPI mode */
#define FLEX_US_MR_SPI_USART_MODE_Pos         _UINT32_(0)                                          /* (FLEX_US_MR) USART Mode of Operation Position */
#define FLEX_US_MR_SPI_USART_MODE_Msk         (_UINT32_(0xF) << FLEX_US_MR_SPI_USART_MODE_Pos)     /* (FLEX_US_MR) USART Mode of Operation Mask */
#define FLEX_US_MR_SPI_USART_MODE(value)      (FLEX_US_MR_SPI_USART_MODE_Msk & (_UINT32_(value) << FLEX_US_MR_SPI_USART_MODE_Pos))
#define   FLEX_US_MR_SPI_USART_MODE_SPI_MASTER_Val _UINT32_(0xE)                                        /* (FLEX_US_MR) SPI master  */
#define   FLEX_US_MR_SPI_USART_MODE_SPI_SLAVE_Val _UINT32_(0xF)                                        /* (FLEX_US_MR) SPI slave  */
#define FLEX_US_MR_SPI_USART_MODE_SPI_MASTER  (FLEX_US_MR_SPI_USART_MODE_SPI_MASTER_Val << FLEX_US_MR_SPI_USART_MODE_Pos) /* (FLEX_US_MR) SPI master Position */
#define FLEX_US_MR_SPI_USART_MODE_SPI_SLAVE   (FLEX_US_MR_SPI_USART_MODE_SPI_SLAVE_Val << FLEX_US_MR_SPI_USART_MODE_Pos) /* (FLEX_US_MR) SPI slave Position */
#define FLEX_US_MR_SPI_USCLKS_Pos             _UINT32_(4)                                          /* (FLEX_US_MR) Clock Selection Position */
#define FLEX_US_MR_SPI_USCLKS_Msk             (_UINT32_(0x3) << FLEX_US_MR_SPI_USCLKS_Pos)         /* (FLEX_US_MR) Clock Selection Mask */
#define FLEX_US_MR_SPI_USCLKS(value)          (FLEX_US_MR_SPI_USCLKS_Msk & (_UINT32_(value) << FLEX_US_MR_SPI_USCLKS_Pos))
#define   FLEX_US_MR_SPI_USCLKS_MCK_Val       _UINT32_(0x0)                                        /* (FLEX_US_MR) Peripheral clock is selected  */
#define   FLEX_US_MR_SPI_USCLKS_DIV_Val       _UINT32_(0x1)                                        /* (FLEX_US_MR) Peripheral clock Divided (DIV= 8) is selected  */
#define   FLEX_US_MR_SPI_USCLKS_GCLK_Val      _UINT32_(0x2)                                        /* (FLEX_US_MR) A PMC generic clock is selected  */
#define   FLEX_US_MR_SPI_USCLKS_SCK_Val       _UINT32_(0x3)                                        /* (FLEX_US_MR) External pin SCK is selected  */
#define FLEX_US_MR_SPI_USCLKS_MCK             (FLEX_US_MR_SPI_USCLKS_MCK_Val << FLEX_US_MR_SPI_USCLKS_Pos) /* (FLEX_US_MR) Peripheral clock is selected Position */
#define FLEX_US_MR_SPI_USCLKS_DIV             (FLEX_US_MR_SPI_USCLKS_DIV_Val << FLEX_US_MR_SPI_USCLKS_Pos) /* (FLEX_US_MR) Peripheral clock Divided (DIV= 8) is selected Position */
#define FLEX_US_MR_SPI_USCLKS_GCLK            (FLEX_US_MR_SPI_USCLKS_GCLK_Val << FLEX_US_MR_SPI_USCLKS_Pos) /* (FLEX_US_MR) A PMC generic clock is selected Position */
#define FLEX_US_MR_SPI_USCLKS_SCK             (FLEX_US_MR_SPI_USCLKS_SCK_Val << FLEX_US_MR_SPI_USCLKS_Pos) /* (FLEX_US_MR) External pin SCK is selected Position */
#define FLEX_US_MR_SPI_CHRL_Pos               _UINT32_(6)                                          /* (FLEX_US_MR) Character Length Position */
#define FLEX_US_MR_SPI_CHRL_Msk               (_UINT32_(0x3) << FLEX_US_MR_SPI_CHRL_Pos)           /* (FLEX_US_MR) Character Length Mask */
#define FLEX_US_MR_SPI_CHRL(value)            (FLEX_US_MR_SPI_CHRL_Msk & (_UINT32_(value) << FLEX_US_MR_SPI_CHRL_Pos))
#define   FLEX_US_MR_SPI_CHRL_8_BIT_Val       _UINT32_(0x3)                                        /* (FLEX_US_MR) Character length is 8 bits  */
#define FLEX_US_MR_SPI_CHRL_8_BIT             (FLEX_US_MR_SPI_CHRL_8_BIT_Val << FLEX_US_MR_SPI_CHRL_Pos) /* (FLEX_US_MR) Character length is 8 bits Position */
#define FLEX_US_MR_SPI_CPHA_Pos               _UINT32_(8)                                          /* (FLEX_US_MR) SPI Clock Phase Position */
#define FLEX_US_MR_SPI_CPHA_Msk               (_UINT32_(0x1) << FLEX_US_MR_SPI_CPHA_Pos)           /* (FLEX_US_MR) SPI Clock Phase Mask */
#define FLEX_US_MR_SPI_CPHA(value)            (FLEX_US_MR_SPI_CPHA_Msk & (_UINT32_(value) << FLEX_US_MR_SPI_CPHA_Pos))
#define FLEX_US_MR_SPI_CPOL_Pos               _UINT32_(16)                                         /* (FLEX_US_MR) SPI Clock Polarity Position */
#define FLEX_US_MR_SPI_CPOL_Msk               (_UINT32_(0x1) << FLEX_US_MR_SPI_CPOL_Pos)           /* (FLEX_US_MR) SPI Clock Polarity Mask */
#define FLEX_US_MR_SPI_CPOL(value)            (FLEX_US_MR_SPI_CPOL_Msk & (_UINT32_(value) << FLEX_US_MR_SPI_CPOL_Pos))
#define FLEX_US_MR_SPI_WRDBT_Pos              _UINT32_(20)                                         /* (FLEX_US_MR) Wait Read Data Before Transfer Position */
#define FLEX_US_MR_SPI_WRDBT_Msk              (_UINT32_(0x1) << FLEX_US_MR_SPI_WRDBT_Pos)          /* (FLEX_US_MR) Wait Read Data Before Transfer Mask */
#define FLEX_US_MR_SPI_WRDBT(value)           (FLEX_US_MR_SPI_WRDBT_Msk & (_UINT32_(value) << FLEX_US_MR_SPI_WRDBT_Pos))
#define FLEX_US_MR_SPI_Msk                    _UINT32_(0x001101FF)                                 /* (FLEX_US_MR_SPI) Register Mask  */
...
/* SPI mode */
#define FLEX_US_IER_SPI_RXRDY_Pos             _UINT32_(0)                                          /* (FLEX_US_IER) RXRDY Interrupt Enable Position */
#define FLEX_US_IER_SPI_RXRDY_Msk             (_UINT32_(0x1) << FLEX_US_IER_SPI_RXRDY_Pos)         /* (FLEX_US_IER) RXRDY Interrupt Enable Mask */
#define FLEX_US_IER_SPI_RXRDY(value)          (FLEX_US_IER_SPI_RXRDY_Msk & (_UINT32_(value) << FLEX_US_IER_SPI_RXRDY_Pos))
#define FLEX_US_IER_SPI_TXRDY_Pos             _UINT32_(1)                                          /* (FLEX_US_IER) TXRDY Interrupt Enable Position */
#define FLEX_US_IER_SPI_TXRDY_Msk             (_UINT32_(0x1) << FLEX_US_IER_SPI_TXRDY_Pos)         /* (FLEX_US_IER) TXRDY Interrupt Enable Mask */
#define FLEX_US_IER_SPI_TXRDY(value)          (FLEX_US_IER_SPI_TXRDY_Msk & (_UINT32_(value) << FLEX_US_IER_SPI_TXRDY_Pos))
#define FLEX_US_IER_SPI_OVRE_Pos              _UINT32_(5)                                          /* (FLEX_US_IER) Overrun Error Interrupt Enable Position */
#define FLEX_US_IER_SPI_OVRE_Msk              (_UINT32_(0x1) << FLEX_US_IER_SPI_OVRE_Pos)          /* (FLEX_US_IER) Overrun Error Interrupt Enable Mask */
#define FLEX_US_IER_SPI_OVRE(value)           (FLEX_US_IER_SPI_OVRE_Msk & (_UINT32_(value) << FLEX_US_IER_SPI_OVRE_Pos))
#define FLEX_US_IER_SPI_TXEMPTY_Pos           _UINT32_(9)                                          /* (FLEX_US_IER) TXEMPTY Interrupt Enable Position */
#define FLEX_US_IER_SPI_TXEMPTY_Msk           (_UINT32_(0x1) << FLEX_US_IER_SPI_TXEMPTY_Pos)       /* (FLEX_US_IER) TXEMPTY Interrupt Enable Mask */
#define FLEX_US_IER_SPI_TXEMPTY(value)        (FLEX_US_IER_SPI_TXEMPTY_Msk & (_UINT32_(value) << FLEX_US_IER_SPI_TXEMPTY_Pos))
#define FLEX_US_IER_SPI_UNRE_Pos              _UINT32_(10)                                         /* (FLEX_US_IER) SPI Underrun Error Interrupt Enable Position */
#define FLEX_US_IER_SPI_UNRE_Msk              (_UINT32_(0x1) << FLEX_US_IER_SPI_UNRE_Pos)          /* (FLEX_US_IER) SPI Underrun Error Interrupt Enable Mask */
#define FLEX_US_IER_SPI_UNRE(value)           (FLEX_US_IER_SPI_UNRE_Msk & (_UINT32_(value) << FLEX_US_IER_SPI_UNRE_Pos))
#define FLEX_US_IER_SPI_NSSE_Pos              _UINT32_(19)                                         /* (FLEX_US_IER) NSS Line (Driving CTS Pin) Rising or Falling Edge Event Position */
#define FLEX_US_IER_SPI_NSSE_Msk              (_UINT32_(0x1) << FLEX_US_IER_SPI_NSSE_Pos)          /* (FLEX_US_IER) NSS Line (Driving CTS Pin) Rising or Falling Edge Event Mask */
#define FLEX_US_IER_SPI_NSSE(value)           (FLEX_US_IER_SPI_NSSE_Msk & (_UINT32_(value) << FLEX_US_IER_SPI_NSSE_Pos))
#define FLEX_US_IER_SPI_CMP_Pos               _UINT32_(22)                                         /* (FLEX_US_IER) Comparison Interrupt Enable Position */
#define FLEX_US_IER_SPI_CMP_Msk               (_UINT32_(0x1) << FLEX_US_IER_SPI_CMP_Pos)           /* (FLEX_US_IER) Comparison Interrupt Enable Mask */
#define FLEX_US_IER_SPI_CMP(value)            (FLEX_US_IER_SPI_CMP_Msk & (_UINT32_(value) << FLEX_US_IER_SPI_CMP_Pos))
#define FLEX_US_IER_SPI_Msk                   _UINT32_(0x00480623)                                 /* (FLEX_US_IER_SPI) Register Mask  */
...
#define FLEX_US_IER_LIN_LINSNRE_Pos           _UINT32_(29)                                         /* (FLEX_US_IER) LIN Slave Not Responding Error Interrupt Enable Position */
#define FLEX_US_IER_LIN_LINSNRE_Msk           (_UINT32_(0x1) << FLEX_US_IER_LIN_LINSNRE_Pos)       /* (FLEX_US_IER) LIN Slave Not Responding Error Interrupt Enable Mask */
...
#define FLEX_US_IER_LIN_Msk                   _UINT32_(0xFE00E3E3)                                 /* (FLEX_US_IER_LIN) Register Mask  */
...
/* SPI mode */
#define FLEX_US_IDR_SPI_RXRDY_Pos             _UINT32_(0)                                          /* (FLEX_US_IDR) RXRDY Interrupt Disable Position */
#define FLEX_US_IDR_SPI_RXRDY_Msk             (_UINT32_(0x1) << FLEX_US_IDR_SPI_RXRDY_Pos)         /* (FLEX_US_IDR) RXRDY Interrupt Disable Mask */
#define FLEX_US_IDR_SPI_RXRDY(value)          (FLEX_US_IDR_SPI_RXRDY_Msk & (_UINT32_(value) << FLEX_US_IDR_SPI_RXRDY_Pos))
#define FLEX_US_IDR_SPI_TXRDY_Pos             _UINT32_(1)                                          /* (FLEX_US_IDR) TXRDY Interrupt Disable Position */
#define FLEX_US_IDR_SPI_TXRDY_Msk             (_UINT32_(0x1) << FLEX_US_IDR_SPI_TXRDY_Pos)         /* (FLEX_US_IDR) TXRDY Interrupt Disable Mask */
#define FLEX_US_IDR_SPI_TXRDY(value)          (FLEX_US_IDR_SPI_TXRDY_Msk & (_UINT32_(value) << FLEX_US_IDR_SPI_TXRDY_Pos))
#define FLEX_US_IDR_SPI_OVRE_Pos              _UINT32_(5)                                          /* (FLEX_US_IDR) Overrun Error Interrupt Disable Position */
#define FLEX_US_IDR_SPI_OVRE_Msk              (_UINT32_(0x1) << FLEX_US_IDR_SPI_OVRE_Pos)          /* (FLEX_US_IDR) Overrun Error Interrupt Disable Mask */
#define FLEX_US_IDR_SPI_OVRE(value)           (FLEX_US_IDR_SPI_OVRE_Msk & (_UINT32_(value) << FLEX_US_IDR_SPI_OVRE_Pos))
#define FLEX_US_IDR_SPI_TXEMPTY_Pos           _UINT32_(9)                                          /* (FLEX_US_IDR) TXEMPTY Interrupt Disable Position */
#define FLEX_US_IDR_SPI_TXEMPTY_Msk           (_UINT32_(0x1) << FLEX_US_IDR_SPI_TXEMPTY_Pos)       /* (FLEX_US_IDR) TXEMPTY Interrupt Disable Mask */
#define FLEX_US_IDR_SPI_TXEMPTY(value)        (FLEX_US_IDR_SPI_TXEMPTY_Msk & (_UINT32_(value) << FLEX_US_IDR_SPI_TXEMPTY_Pos))
#define FLEX_US_IDR_SPI_UNRE_Pos              _UINT32_(10)                                         /* (FLEX_US_IDR) SPI Underrun Error Interrupt Disable Position */
#define FLEX_US_IDR_SPI_UNRE_Msk              (_UINT32_(0x1) << FLEX_US_IDR_SPI_UNRE_Pos)          /* (FLEX_US_IDR) SPI Underrun Error Interrupt Disable Mask */
#define FLEX_US_IDR_SPI_UNRE(value)           (FLEX_US_IDR_SPI_UNRE_Msk & (_UINT32_(value) << FLEX_US_IDR_SPI_UNRE_Pos))
#define FLEX_US_IDR_SPI_NSSE_Pos              _UINT32_(19)                                         /* (FLEX_US_IDR) NSS Line (Driving CTS Pin) Rising or Falling Edge Event Position */
#define FLEX_US_IDR_SPI_NSSE_Msk              (_UINT32_(0x1) << FLEX_US_IDR_SPI_NSSE_Pos)          /* (FLEX_US_IDR) NSS Line (Driving CTS Pin) Rising or Falling Edge Event Mask */
#define FLEX_US_IDR_SPI_NSSE(value)           (FLEX_US_IDR_SPI_NSSE_Msk & (_UINT32_(value) << FLEX_US_IDR_SPI_NSSE_Pos))
#define FLEX_US_IDR_SPI_CMP_Pos               _UINT32_(22)                                         /* (FLEX_US_IDR) Comparison Interrupt Disable Position */
#define FLEX_US_IDR_SPI_CMP_Msk               (_UINT32_(0x1) << FLEX_US_IDR_SPI_CMP_Pos)           /* (FLEX_US_IDR) Comparison Interrupt Disable Mask */
#define FLEX_US_IDR_SPI_CMP(value)            (FLEX_US_IDR_SPI_CMP_Msk & (_UINT32_(value) << FLEX_US_IDR_SPI_CMP_Pos))
#define FLEX_US_IDR_SPI_Msk                   _UINT32_(0x00480623)                                 /* (FLEX_US_IDR_SPI) Register Mask  */
...
#define FLEX_US_IDR_LIN_LINSNRE_Pos           _UINT32_(29)                                         /* (FLEX_US_IDR) LIN Slave Not Responding Error Interrupt Disable Position */
#define FLEX_US_IDR_LIN_LINSNRE_Msk           (_UINT32_(0x1) << FLEX_US_IDR_LIN_LINSNRE_Pos)       /* (FLEX_US_IDR) LIN Slave Not Responding Error Interrupt Disable Mask */
...
#define FLEX_US_IDR_LIN_Msk                   _UINT32_(0xFE00E3E3)                                 /* (FLEX_US_IDR_LIN) Register Mask  */
...
/* SPI mode */
#define FLEX_US_IMR_SPI_RXRDY_Pos             _UINT32_(0)                                          /* (FLEX_US_IMR) RXRDY Interrupt Mask Position */
#define FLEX_US_IMR_SPI_RXRDY_Msk             (_UINT32_(0x1) << FLEX_US_IMR_SPI_RXRDY_Pos)         /* (FLEX_US_IMR) RXRDY Interrupt Mask Mask */
#define FLEX_US_IMR_SPI_RXRDY(value)          (FLEX_US_IMR_SPI_RXRDY_Msk & (_UINT32_(value) << FLEX_US_IMR_SPI_RXRDY_Pos))
#define FLEX_US_IMR_SPI_TXRDY_Pos             _UINT32_(1)                                          /* (FLEX_US_IMR) TXRDY Interrupt Mask Position */
#define FLEX_US_IMR_SPI_TXRDY_Msk             (_UINT32_(0x1) << FLEX_US_IMR_SPI_TXRDY_Pos)         /* (FLEX_US_IMR) TXRDY Interrupt Mask Mask */
#define FLEX_US_IMR_SPI_TXRDY(value)          (FLEX_US_IMR_SPI_TXRDY_Msk & (_UINT32_(value) << FLEX_US_IMR_SPI_TXRDY_Pos))
#define FLEX_US_IMR_SPI_OVRE_Pos              _UINT32_(5)                                          /* (FLEX_US_IMR) Overrun Error Interrupt Mask Position */
#define FLEX_US_IMR_SPI_OVRE_Msk              (_UINT32_(0x1) << FLEX_US_IMR_SPI_OVRE_Pos)          /* (FLEX_US_IMR) Overrun Error Interrupt Mask Mask */
#define FLEX_US_IMR_SPI_OVRE(value)           (FLEX_US_IMR_SPI_OVRE_Msk & (_UINT32_(value) << FLEX_US_IMR_SPI_OVRE_Pos))
#define FLEX_US_IMR_SPI_TXEMPTY_Pos           _UINT32_(9)                                          /* (FLEX_US_IMR) TXEMPTY Interrupt Mask Position */
#define FLEX_US_IMR_SPI_TXEMPTY_Msk           (_UINT32_(0x1) << FLEX_US_IMR_SPI_TXEMPTY_Pos)       /* (FLEX_US_IMR) TXEMPTY Interrupt Mask Mask */
#define FLEX_US_IMR_SPI_TXEMPTY(value)        (FLEX_US_IMR_SPI_TXEMPTY_Msk & (_UINT32_(value) << FLEX_US_IMR_SPI_TXEMPTY_Pos))
#define FLEX_US_IMR_SPI_UNRE_Pos              _UINT32_(10)                                         /* (FLEX_US_IMR) SPI Underrun Error Interrupt Mask Position */
#define FLEX_US_IMR_SPI_UNRE_Msk              (_UINT32_(0x1) << FLEX_US_IMR_SPI_UNRE_Pos)          /* (FLEX_US_IMR) SPI Underrun Error Interrupt Mask Mask */
#define FLEX_US_IMR_SPI_UNRE(value)           (FLEX_US_IMR_SPI_UNRE_Msk & (_UINT32_(value) << FLEX_US_IMR_SPI_UNRE_Pos))
#define FLEX_US_IMR_SPI_NSSE_Pos              _UINT32_(19)                                         /* (FLEX_US_IMR) NSS Line (Driving CTS Pin) Rising or Falling Edge Event Position */
#define FLEX_US_IMR_SPI_NSSE_Msk              (_UINT32_(0x1) << FLEX_US_IMR_SPI_NSSE_Pos)          /* (FLEX_US_IMR) NSS Line (Driving CTS Pin) Rising or Falling Edge Event Mask */
#define FLEX_US_IMR_SPI_NSSE(value)           (FLEX_US_IMR_SPI_NSSE_Msk & (_UINT32_(value) << FLEX_US_IMR_SPI_NSSE_Pos))
#define FLEX_US_IMR_SPI_CMP_Pos               _UINT32_(22)                                         /* (FLEX_US_IMR) Comparison Interrupt Mask Position */
#define FLEX_US_IMR_SPI_CMP_Msk               (_UINT32_(0x1) << FLEX_US_IMR_SPI_CMP_Pos)           /* (FLEX_US_IMR) Comparison Interrupt Mask Mask */
#define FLEX_US_IMR_SPI_CMP(value)            (FLEX_US_IMR_SPI_CMP_Msk & (_UINT32_(value) << FLEX_US_IMR_SPI_CMP_Pos))
#define FLEX_US_IMR_SPI_Msk                   _UINT32_(0x00480623)                                 /* (FLEX_US_IMR_SPI) Register Mask  */
...
#define FLEX_US_IMR_LIN_LINSNRE_Pos           _UINT32_(29)                                         /* (FLEX_US_IMR) LIN Slave Not Responding Error Interrupt Mask Position */
#define FLEX_US_IMR_LIN_LINSNRE_Msk           (_UINT32_(0x1) << FLEX_US_IMR_LIN_LINSNRE_Pos)       /* (FLEX_US_IMR) LIN Slave Not Responding Error Interrupt Mask Mask */
...
#define FLEX_US_IMR_LIN_Msk                   _UINT32_(0xFE00E3E3)                                 /* (FLEX_US_IMR_LIN) Register Mask  */
...
/* SPI mode */
#define FLEX_US_CSR_SPI_RXRDY_Pos             _UINT32_(0)                                          /* (FLEX_US_CSR) Receiver Ready (cleared by reading FLEX_US_RHR) Position */
#define FLEX_US_CSR_SPI_RXRDY_Msk             (_UINT32_(0x1) << FLEX_US_CSR_SPI_RXRDY_Pos)         /* (FLEX_US_CSR) Receiver Ready (cleared by reading FLEX_US_RHR) Mask */
#define FLEX_US_CSR_SPI_RXRDY(value)          (FLEX_US_CSR_SPI_RXRDY_Msk & (_UINT32_(value) << FLEX_US_CSR_SPI_RXRDY_Pos))
#define FLEX_US_CSR_SPI_TXRDY_Pos             _UINT32_(1)                                          /* (FLEX_US_CSR) Transmitter Ready (cleared by writing FLEX_US_THR) Position */
#define FLEX_US_CSR_SPI_TXRDY_Msk             (_UINT32_(0x1) << FLEX_US_CSR_SPI_TXRDY_Pos)         /* (FLEX_US_CSR) Transmitter Ready (cleared by writing FLEX_US_THR) Mask */
#define FLEX_US_CSR_SPI_TXRDY(value)          (FLEX_US_CSR_SPI_TXRDY_Msk & (_UINT32_(value) << FLEX_US_CSR_SPI_TXRDY_Pos))
#define FLEX_US_CSR_SPI_OVRE_Pos              _UINT32_(5)                                          /* (FLEX_US_CSR) Overrun Error Position */
#define FLEX_US_CSR_SPI_OVRE_Msk              (_UINT32_(0x1) << FLEX_US_CSR_SPI_OVRE_Pos)          /* (FLEX_US_CSR) Overrun Error Mask */
#define FLEX_US_CSR_SPI_OVRE(value)           (FLEX_US_CSR_SPI_OVRE_Msk & (_UINT32_(value) << FLEX_US_CSR_SPI_OVRE_Pos))
#define FLEX_US_CSR_SPI_TXEMPTY_Pos           _UINT32_(9)                                          /* (FLEX_US_CSR) Transmitter Empty (cleared by writing FLEX_US_THR) Position */
#define FLEX_US_CSR_SPI_TXEMPTY_Msk           (_UINT32_(0x1) << FLEX_US_CSR_SPI_TXEMPTY_Pos)       /* (FLEX_US_CSR) Transmitter Empty (cleared by writing FLEX_US_THR) Mask */
#define FLEX_US_CSR_SPI_TXEMPTY(value)        (FLEX_US_CSR_SPI_TXEMPTY_Msk & (_UINT32_(value) << FLEX_US_CSR_SPI_TXEMPTY_Pos))
#define FLEX_US_CSR_SPI_UNRE_Pos              _UINT32_(10)                                         /* (FLEX_US_CSR) Underrun Error Position */
#define FLEX_US_CSR_SPI_UNRE_Msk              (_UINT32_(0x1) << FLEX_US_CSR_SPI_UNRE_Pos)          /* (FLEX_US_CSR) Underrun Error Mask */
#define FLEX_US_CSR_SPI_UNRE(value)           (FLEX_US_CSR_SPI_UNRE_Msk & (_UINT32_(value) << FLEX_US_CSR_SPI_UNRE_Pos))
#define FLEX_US_CSR_SPI_NSSE_Pos              _UINT32_(19)                                         /* (FLEX_US_CSR) NSS Line (Driving CTS Pin) Rising or Falling Edge Event (cleared on read) Position */
#define FLEX_US_CSR_SPI_NSSE_Msk              (_UINT32_(0x1) << FLEX_US_CSR_SPI_NSSE_Pos)          /* (FLEX_US_CSR) NSS Line (Driving CTS Pin) Rising or Falling Edge Event (cleared on read) Mask */
#define FLEX_US_CSR_SPI_NSSE(value)           (FLEX_US_CSR_SPI_NSSE_Msk & (_UINT32_(value) << FLEX_US_CSR_SPI_NSSE_Pos))
#define FLEX_US_CSR_SPI_CMP_Pos               _UINT32_(22)                                         /* (FLEX_US_CSR) Comparison Match Position */
#define FLEX_US_CSR_SPI_CMP_Msk               (_UINT32_(0x1) << FLEX_US_CSR_SPI_CMP_Pos)           /* (FLEX_US_CSR) Comparison Match Mask */
#define FLEX_US_CSR_SPI_CMP(value)            (FLEX_US_CSR_SPI_CMP_Msk & (_UINT32_(value) << FLEX_US_CSR_SPI_CMP_Pos))
#define FLEX_US_CSR_SPI_NSS_Pos               _UINT32_(23)                                         /* (FLEX_US_CSR) NSS Line (Driving CTS Pin) Rising or Falling Edge Event (cleared on read) Position */
#define FLEX_US_CSR_SPI_NSS_Msk               (_UINT32_(0x1) << FLEX_US_CSR_SPI_NSS_Pos)           /* (FLEX_US_CSR) NSS Line (Driving CTS Pin) Rising or Falling Edge Event (cleared on read) Mask */
#define FLEX_US_CSR_SPI_NSS(value)            (FLEX_US_CSR_SPI_NSS_Msk & (_UINT32_(value) << FLEX_US_CSR_SPI_NSS_Pos))
#define FLEX_US_CSR_SPI_Msk                   _UINT32_(0x00C80623)                                 /* (FLEX_US_CSR_SPI) Register Mask  */
...
#define FLEX_US_CSR_LIN_LINSNRE_Pos           _UINT32_(29)                                         /* (FLEX_US_CSR) LIN Slave Not Responding Error Position */
#define FLEX_US_CSR_LIN_LINSNRE_Msk           (_UINT32_(0x1) << FLEX_US_CSR_LIN_LINSNRE_Pos)       /* (FLEX_US_CSR) LIN Slave Not Responding Error Mask */
...
#define FLEX_US_CSR_LIN_Msk                   _UINT32_(0xFE80E3E3)                                 /* (FLEX_US_CSR_LIN) Register Mask  */
...
#define FLEX_TWI_SMR_Msk                      _UINT32_(0xF07F7F5D)                                 /* (FLEX_TWI_SMR) Register Mask  */
