...
#define SDMMC_CALCR_CALPBP_Pos                _UINT32_(28)                                         /* (SDMMC_CALCR) Calibration P Bypass Value Position */
#define SDMMC_CALCR_CALPBP_Msk                (_UINT32_(0xF) << SDMMC_CALCR_CALPBP_Pos)            /* (SDMMC_CALCR) Calibration P Bypass Value Mask */
