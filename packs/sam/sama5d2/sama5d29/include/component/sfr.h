...
#define SFR_DDRCFG_FDQIEN(value)              (SFR_DDRCFG_FDQIEN_Msk & (_UINT32_(value) << SFR_DDRCFG_FDQIEN_Pos)) /* Assignment of value for FDQIEN in the SFR_DDRCFG register */
...
#define SFR_DDRCFG_FDQSIEN(value)             (SFR_DDRCFG_FDQSIEN_Msk & (_UINT32_(value) << SFR_DDRCFG_FDQSIEN_Pos)) /* Assignment of value for FDQSIEN in the SFR_DDRCFG register */
...
#define SFR_OHCIICR_SUSPEND_A(value)          (SFR_OHCIICR_SUSPEND_A_Msk & (_UINT32_(value) << SFR_OHCIICR_SUSPEND_A_Pos)) /* Assignment of value for SUSPEND_A in the SFR_OHCIICR register */
...
#define SFR_OHCIICR_SUSPEND_B(value)          (SFR_OHCIICR_SUSPEND_B_Msk & (_UINT32_(value) << SFR_OHCIICR_SUSPEND_B_Pos)) /* Assignment of value for SUSPEND_B in the SFR_OHCIICR register */
...
#define SFR_OHCIICR_SUSPEND_C(value)          (SFR_OHCIICR_SUSPEND_C_Msk & (_UINT32_(value) << SFR_OHCIICR_SUSPEND_C_Pos)) /* Assignment of value for SUSPEND_C in the SFR_OHCIICR register */
...
#define SFR_OHCIICR_HSIC_SEL(value)           (SFR_OHCIICR_HSIC_SEL_Msk & (_UINT32_(value) << SFR_OHCIICR_HSIC_SEL_Pos)) /* Assignment of value for HSIC_SEL in the SFR_OHCIICR register */
...
#define SFR_SECURE_ROM(value)                 (SFR_SECURE_ROM_Msk & (_UINT32_(value) << SFR_SECURE_ROM_Pos)) /* Assignment of value for ROM in the SFR_SECURE register */
...
#define SFR_SECURE_FUSE(value)                (SFR_SECURE_FUSE_Msk & (_UINT32_(value) << SFR_SECURE_FUSE_Pos)) /* Assignment of value for FUSE in the SFR_SECURE register */
...
#define SFR_UTMICKTRIM_FREQ(value)            (SFR_UTMICKTRIM_FREQ_Msk & (_UINT32_(value) << SFR_UTMICKTRIM_FREQ_Pos)) /* Assignment of value for FREQ in the SFR_UTMICKTRIM register */
...
#define SFR_UTMICKTRIM_VBG(value)             (SFR_UTMICKTRIM_VBG_Msk & (_UINT32_(value) << SFR_UTMICKTRIM_VBG_Pos)) /* Assignment of value for VBG in the SFR_UTMICKTRIM register */
...
#define SFR_UTMIHSTRIM_SQUELCH(value)         (SFR_UTMIHSTRIM_SQUELCH_Msk & (_UINT32_(value) << SFR_UTMIHSTRIM_SQUELCH_Pos)) /* Assignment of value for SQUELCH in the SFR_UTMIHSTRIM register */
...
#define SFR_UTMIHSTRIM_DISC(value)            (SFR_UTMIHSTRIM_DISC_Msk & (_UINT32_(value) << SFR_UTMIHSTRIM_DISC_Pos)) /* Assignment of value for DISC in the SFR_UTMIHSTRIM register */
...
#define SFR_UTMIFSTRIM_RISE(value)            (SFR_UTMIFSTRIM_RISE_Msk & (_UINT32_(value) << SFR_UTMIFSTRIM_RISE_Pos)) /* Assignment of value for RISE in the SFR_UTMIFSTRIM register */
...
#define SFR_UTMIFSTRIM_FALL(value)            (SFR_UTMIFSTRIM_FALL_Msk & (_UINT32_(value) << SFR_UTMIFSTRIM_FALL_Pos)) /* Assignment of value for FALL in the SFR_UTMIFSTRIM register */
...
#define SFR_UTMIFSTRIM_XCVR(value)            (SFR_UTMIFSTRIM_XCVR_Msk & (_UINT32_(value) << SFR_UTMIFSTRIM_XCVR_Pos)) /* Assignment of value for XCVR in the SFR_UTMIFSTRIM register */
...
#define SFR_CAN_EXT_MEM_CAN0_ADDR(value)      (SFR_CAN_EXT_MEM_CAN0_ADDR_Msk & (_UINT32_(value) << SFR_CAN_EXT_MEM_CAN0_ADDR_Pos)) /* Assignment of value for EXT_MEM_CAN0_ADDR in the SFR_CAN register */
...
#define SFR_CAN_EXT_MEM_CAN1_ADDR(value)      (SFR_CAN_EXT_MEM_CAN1_ADDR_Msk & (_UINT32_(value) << SFR_CAN_EXT_MEM_CAN1_ADDR_Pos)) /* Assignment of value for EXT_MEM_CAN1_ADDR in the SFR_CAN register */
...
#define SFR_SN0_SN0(value)                    (SFR_SN0_SN0_Msk & (_UINT32_(value) << SFR_SN0_SN0_Pos)) /* Assignment of value for SN0 in the SFR_SN0 register */
...
#define SFR_SN1_SN1(value)                    (SFR_SN1_SN1_Msk & (_UINT32_(value) << SFR_SN1_SN1_Pos)) /* Assignment of value for SN1 in the SFR_SN1 register */
...
#define SFR_AICREDIR_NSAIC(value)             (SFR_AICREDIR_NSAIC_Msk & (_UINT32_(value) << SFR_AICREDIR_NSAIC_Pos)) /* Assignment of value for NSAIC in the SFR_AICREDIR register */
...
#define SFR_AICREDIR_AICREDIRKEY(value)       (SFR_AICREDIR_AICREDIRKEY_Msk & (_UINT32_(value) << SFR_AICREDIR_AICREDIRKEY_Pos)) /* Assignment of value for AICREDIRKEY in the SFR_AICREDIR register */
...
#define SFR_L2CC_HRAMC_SRAM_SEL(value)        (SFR_L2CC_HRAMC_SRAM_SEL_Msk & (_UINT32_(value) << SFR_L2CC_HRAMC_SRAM_SEL_Pos)) /* Assignment of value for SRAM_SEL in the SFR_L2CC_HRAMC register */
...
#define SFR_I2SCLKSEL_CLKSEL0(value)          (SFR_I2SCLKSEL_CLKSEL0_Msk & (_UINT32_(value) << SFR_I2SCLKSEL_CLKSEL0_Pos)) /* Assignment of value for CLKSEL0 in the SFR_I2SCLKSEL register */
...
#define SFR_I2SCLKSEL_CLKSEL1(value)          (SFR_I2SCLKSEL_CLKSEL1_Msk & (_UINT32_(value) << SFR_I2SCLKSEL_CLKSEL1_Pos)) /* Assignment of value for CLKSEL1 in the SFR_I2SCLKSEL register */
...
#define SFR_QSPICLK_REG_SUP_SEL(value)        (SFR_QSPICLK_REG_SUP_SEL_Msk & (_UINT32_(value) << SFR_QSPICLK_REG_SUP_SEL_Pos)) /* Assignment of value for SUP_SEL in the SFR_QSPICLK_REG register */
