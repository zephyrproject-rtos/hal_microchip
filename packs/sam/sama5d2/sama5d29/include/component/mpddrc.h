...
#define MPDDRC_MR_DAI(value)                  (MPDDRC_MR_DAI_Msk & (_UINT32_(value) << MPDDRC_MR_DAI_Pos)) /* Assignment of value for DAI in the MPDDRC_MR register */
...
#define MPDDRC_MR_MRS(value)                  (MPDDRC_MR_MRS_Msk & (_UINT32_(value) << MPDDRC_MR_MRS_Pos)) /* Assignment of value for MRS in the MPDDRC_MR register */
...
#define MPDDRC_RTR_ADJ_REF(value)             (MPDDRC_RTR_ADJ_REF_Msk & (_UINT32_(value) << MPDDRC_RTR_ADJ_REF_Pos)) /* Assignment of value for ADJ_REF in the MPDDRC_RTR register */
...
#define MPDDRC_RTR_REF_PB(value)              (MPDDRC_RTR_REF_PB_Msk & (_UINT32_(value) << MPDDRC_RTR_REF_PB_Pos)) /* Assignment of value for REF_PB in the MPDDRC_RTR register */
...
#define MPDDRC_RTR_MR4_VALUE(value)           (MPDDRC_RTR_MR4_VALUE_Msk & (_UINT32_(value) << MPDDRC_RTR_MR4_VALUE_Pos)) /* Assignment of value for MR4_VALUE in the MPDDRC_RTR register */
...
#define MPDDRC_CR_ZQ(value)                   (MPDDRC_CR_ZQ_Msk & (_UINT32_(value) << MPDDRC_CR_ZQ_Pos)) /* Assignment of value for ZQ in the MPDDRC_CR register */
...
#define MPDDRC_CR_ENRDM(value)                (MPDDRC_CR_ENRDM_Msk & (_UINT32_(value) << MPDDRC_CR_ENRDM_Pos)) /* Assignment of value for ENRDM in the MPDDRC_CR register */
...
#define MPDDRC_CR_LC_LPDDR1(value)            (MPDDRC_CR_LC_LPDDR1_Msk & (_UINT32_(value) << MPDDRC_CR_LC_LPDDR1_Pos)) /* Assignment of value for LC_LPDDR1 in the MPDDRC_CR register */
...
#define MPDDRC_LPR_LPDDR2_LPDDR3_PWOFF(value) (MPDDRC_LPR_LPDDR2_LPDDR3_PWOFF_Msk & (_UINT32_(value) << MPDDRC_LPR_LPDDR2_LPDDR3_PWOFF_Pos)) /* Assignment of value for LPDDR2_LPDDR3_PWOFF in the MPDDRC_LPR register */
...
#define MPDDRC_LPR_PASR(value)                (MPDDRC_LPR_PASR_Msk & (_UINT32_(value) << MPDDRC_LPR_PASR_Pos)) /* Assignment of value for PASR in the MPDDRC_LPR register */
...
#define MPDDRC_LPR_DS(value)                  (MPDDRC_LPR_DS_Msk & (_UINT32_(value) << MPDDRC_LPR_DS_Pos)) /* Assignment of value for DS in the MPDDRC_LPR register */
...
#define MPDDRC_MD_WL(value)                   (MPDDRC_MD_WL_Msk & (_UINT32_(value) << MPDDRC_MD_WL_Pos)) /* Assignment of value for WL in the MPDDRC_MD register */
...
#define MPDDRC_MD_RL3(value)                  (MPDDRC_MD_RL3_Msk & (_UINT32_(value) << MPDDRC_MD_RL3_Pos)) /* Assignment of value for RL3 in the MPDDRC_MD register */
...
#define MPDDRC_MD_MANU_ID(value)              (MPDDRC_MD_MANU_ID_Msk & (_UINT32_(value) << MPDDRC_MD_MANU_ID_Pos)) /* Assignment of value for MANU_ID in the MPDDRC_MD register */
...
#define MPDDRC_MD_REV_ID(value)               (MPDDRC_MD_REV_ID_Msk & (_UINT32_(value) << MPDDRC_MD_REV_ID_Pos)) /* Assignment of value for REV_ID in the MPDDRC_MD register */
...
#define MPDDRC_MD_TYPE(value)                 (MPDDRC_MD_TYPE_Msk & (_UINT32_(value) << MPDDRC_MD_TYPE_Pos)) /* Assignment of value for TYPE in the MPDDRC_MD register */
...
#define MPDDRC_MD_DENSITY(value)              (MPDDRC_MD_DENSITY_Msk & (_UINT32_(value) << MPDDRC_MD_DENSITY_Pos)) /* Assignment of value for DENSITY in the MPDDRC_MD register */
...
#define MPDDRC_MD_IO_WIDTH(value)             (MPDDRC_MD_IO_WIDTH_Msk & (_UINT32_(value) << MPDDRC_MD_IO_WIDTH_Pos)) /* Assignment of value for IO_WIDTH in the MPDDRC_MD register */
...
#define MPDDRC_LPDDR23_LPR_BK_MASK_PASR(value) (MPDDRC_LPDDR23_LPR_BK_MASK_PASR_Msk & (_UINT32_(value) << MPDDRC_LPDDR23_LPR_BK_MASK_PASR_Pos)) /* Assignment of value for BK_MASK_PASR in the MPDDRC_LPDDR23_LPR register */
...
#define MPDDRC_LPDDR23_LPR_SEG_MASK(value)    (MPDDRC_LPDDR23_LPR_SEG_MASK_Msk & (_UINT32_(value) << MPDDRC_LPDDR23_LPR_SEG_MASK_Pos)) /* Assignment of value for SEG_MASK in the MPDDRC_LPDDR23_LPR register */
...
#define MPDDRC_LPDDR23_LPR_DS(value)          (MPDDRC_LPDDR23_LPR_DS_Msk & (_UINT32_(value) << MPDDRC_LPDDR23_LPR_DS_Pos)) /* Assignment of value for DS in the MPDDRC_LPDDR23_LPR register */
...
#define MPDDRC_LPDDR2_LPDDR3_DDR3_CAL_MR4_COUNT_CAL(value) (MPDDRC_LPDDR2_LPDDR3_DDR3_CAL_MR4_COUNT_CAL_Msk & (_UINT32_(value) << MPDDRC_LPDDR2_LPDDR3_DDR3_CAL_MR4_COUNT_CAL_Pos)) /* Assignment of value for COUNT_CAL in the MPDDRC_LPDDR2_LPDDR3_DDR3_CAL_MR4 register */
...
#define MPDDRC_LPDDR2_LPDDR3_DDR3_CAL_MR4_MR4_READ(value) (MPDDRC_LPDDR2_LPDDR3_DDR3_CAL_MR4_MR4_READ_Msk & (_UINT32_(value) << MPDDRC_LPDDR2_LPDDR3_DDR3_CAL_MR4_MR4_READ_Pos)) /* Assignment of value for MR4_READ in the MPDDRC_LPDDR2_LPDDR3_DDR3_CAL_MR4 register */
...
#define MPDDRC_LPDDR2_LPDDR3_DDR3_TIM_CAL_ZQCS(value) (MPDDRC_LPDDR2_LPDDR3_DDR3_TIM_CAL_ZQCS_Msk & (_UINT32_(value) << MPDDRC_LPDDR2_LPDDR3_DDR3_TIM_CAL_ZQCS_Pos)) /* Assignment of value for ZQCS in the MPDDRC_LPDDR2_LPDDR3_DDR3_TIM_CAL register */
...
#define MPDDRC_LPDDR2_LPDDR3_DDR3_TIM_CAL_RZQI(value) (MPDDRC_LPDDR2_LPDDR3_DDR3_TIM_CAL_RZQI_Msk & (_UINT32_(value) << MPDDRC_LPDDR2_LPDDR3_DDR3_TIM_CAL_RZQI_Pos)) /* Assignment of value for RZQI in the MPDDRC_LPDDR2_LPDDR3_DDR3_TIM_CAL register */
...
#define MPDDRC_IO_CALIBR_RDIV(value)          (MPDDRC_IO_CALIBR_RDIV_Msk & (_UINT32_(value) << MPDDRC_IO_CALIBR_RDIV_Pos)) /* Assignment of value for RDIV in the MPDDRC_IO_CALIBR register */
...
#define MPDDRC_CONF_ARBITER_RQ_WD_P7(value)   (MPDDRC_CONF_ARBITER_RQ_WD_P7_Msk & (_UINT32_(value) << MPDDRC_CONF_ARBITER_RQ_WD_P7_Pos)) /* Assignment of value for RQ_WD_P7 in the MPDDRC_CONF_ARBITER register */
...
#define MPDDRC_CONF_ARBITER_MA_PR_P7(value)   (MPDDRC_CONF_ARBITER_MA_PR_P7_Msk & (_UINT32_(value) << MPDDRC_CONF_ARBITER_MA_PR_P7_Pos)) /* Assignment of value for MA_PR_P7 in the MPDDRC_CONF_ARBITER register */
...
#define MPDDRC_CONF_ARBITER_BDW_BURST_P7(value) (MPDDRC_CONF_ARBITER_BDW_BURST_P7_Msk & (_UINT32_(value) << MPDDRC_CONF_ARBITER_BDW_BURST_P7_Pos)) /* Assignment of value for BDW_BURST_P7 in the MPDDRC_CONF_ARBITER register */
...
#define MPDDRC_TIMEOUT_TIMEOUT_P7(value)      (MPDDRC_TIMEOUT_TIMEOUT_P7_Msk & (_UINT32_(value) << MPDDRC_TIMEOUT_TIMEOUT_P7_Pos)) /* Assignment of value for TIMEOUT_P7 in the MPDDRC_TIMEOUT register */
...
#define MPDDRC_REQ_PORT_4567_NRQ_NWD_BDW_P4(value) (MPDDRC_REQ_PORT_4567_NRQ_NWD_BDW_P4_Msk & (_UINT32_(value) << MPDDRC_REQ_PORT_4567_NRQ_NWD_BDW_P4_Pos)) /* Assignment of value for NRQ_NWD_BDW_P4 in the MPDDRC_REQ_PORT_4567 register */
...
#define MPDDRC_REQ_PORT_4567_NRQ_NWD_BDW_P5(value) (MPDDRC_REQ_PORT_4567_NRQ_NWD_BDW_P5_Msk & (_UINT32_(value) << MPDDRC_REQ_PORT_4567_NRQ_NWD_BDW_P5_Pos)) /* Assignment of value for NRQ_NWD_BDW_P5 in the MPDDRC_REQ_PORT_4567 register */
...
#define MPDDRC_REQ_PORT_4567_NRQ_NWD_BDW_P6(value) (MPDDRC_REQ_PORT_4567_NRQ_NWD_BDW_P6_Msk & (_UINT32_(value) << MPDDRC_REQ_PORT_4567_NRQ_NWD_BDW_P6_Pos)) /* Assignment of value for NRQ_NWD_BDW_P6 in the MPDDRC_REQ_PORT_4567 register */
...
#define MPDDRC_REQ_PORT_4567_NRQ_NWD_BDW_P7(value) (MPDDRC_REQ_PORT_4567_NRQ_NWD_BDW_P7_Msk & (_UINT32_(value) << MPDDRC_REQ_PORT_4567_NRQ_NWD_BDW_P7_Pos)) /* Assignment of value for NRQ_NWD_BDW_P7 in the MPDDRC_REQ_PORT_4567 register */
...
#define MPDDRC_BDW_PORT_4567_BDW_P4_Msk       (_UINT32_(0xFF) << MPDDRC_BDW_PORT_4567_BDW_P4_Pos)  /* (MPDDRC_BDW_PORT_4567) Current/Maximum Bandwidth from Port 4-5-6-7 Mask */
#define MPDDRC_BDW_PORT_4567_BDW_P4(value)    (MPDDRC_BDW_PORT_4567_BDW_P4_Msk & (_UINT32_(value) << MPDDRC_BDW_PORT_4567_BDW_P4_Pos)) /* Assignment of value for BDW_P4 in the MPDDRC_BDW_PORT_4567 register */
...
#define MPDDRC_BDW_PORT_4567_BDW_P5_Msk       (_UINT32_(0xFF) << MPDDRC_BDW_PORT_4567_BDW_P5_Pos)  /* (MPDDRC_BDW_PORT_4567) Current/Maximum Bandwidth from Port 4-5-6-7 Mask */
#define MPDDRC_BDW_PORT_4567_BDW_P5(value)    (MPDDRC_BDW_PORT_4567_BDW_P5_Msk & (_UINT32_(value) << MPDDRC_BDW_PORT_4567_BDW_P5_Pos)) /* Assignment of value for BDW_P5 in the MPDDRC_BDW_PORT_4567 register */
...
#define MPDDRC_BDW_PORT_4567_BDW_P6_Msk       (_UINT32_(0xFF) << MPDDRC_BDW_PORT_4567_BDW_P6_Pos)  /* (MPDDRC_BDW_PORT_4567) Current/Maximum Bandwidth from Port 4-5-6-7 Mask */
#define MPDDRC_BDW_PORT_4567_BDW_P6(value)    (MPDDRC_BDW_PORT_4567_BDW_P6_Msk & (_UINT32_(value) << MPDDRC_BDW_PORT_4567_BDW_P6_Pos)) /* Assignment of value for BDW_P6 in the MPDDRC_BDW_PORT_4567 register */
...
#define MPDDRC_BDW_PORT_4567_BDW_P7_Msk       (_UINT32_(0xFF) << MPDDRC_BDW_PORT_4567_BDW_P7_Pos)  /* (MPDDRC_BDW_PORT_4567) Current/Maximum Bandwidth from Port 4-5-6-7 Mask */
#define MPDDRC_BDW_PORT_4567_BDW_P7(value)    (MPDDRC_BDW_PORT_4567_BDW_P7_Msk & (_UINT32_(value) << MPDDRC_BDW_PORT_4567_BDW_P7_Pos)) /* Assignment of value for BDW_P7 in the MPDDRC_BDW_PORT_4567 register */
#define MPDDRC_BDW_PORT_4567_Msk              _UINT32_(0xFFFFFFFF)                                 /* (MPDDRC_BDW_PORT_4567) Register Mask  */
...
#define MPDDRC_MADDR7_ADDR_LOW_PORT7(value)   (MPDDRC_MADDR7_ADDR_LOW_PORT7_Msk & (_UINT32_(value) << MPDDRC_MADDR7_ADDR_LOW_PORT7_Pos)) /* Assignment of value for ADDR_LOW_PORT7 in the MPDDRC_MADDR7 register */
...
#define MPDDRC_MADDR7_ADDR_HIGH_PORT7(value)  (MPDDRC_MADDR7_ADDR_HIGH_PORT7_Msk & (_UINT32_(value) << MPDDRC_MADDR7_ADDR_HIGH_PORT7_Pos)) /* Assignment of value for ADDR_HIGH_PORT7 in the MPDDRC_MADDR7 register */
