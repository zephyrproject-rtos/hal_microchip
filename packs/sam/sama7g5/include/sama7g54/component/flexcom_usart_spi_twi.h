...
#ifndef _SAMA7G5_FLEXCOM_COMPONENT_US_SPI_TWI_H_
#define _SAMA7G5_FLEXCOM_COMPONENT_US_SPI_TWI_H_
...
#define   US_CR_REQCLR_1_Val             _UINT32_(0x1)                                        /* (US_CR) Restarts the comparison trigger to enable US_RHR loading.  */
...
#define US_CR_REQCLR_1                   (US_CR_REQCLR_1_Val << US_CR_REQCLR_Pos)   /* (US_CR) Restarts the comparison trigger to enable US_RHR loading. Position */
...
#define   US_MR_USART_MODE_ISO7816_T_0_Val _UINT32_(0x4)                                        /* (US_MR) IS07816 Protocol: T = 0  */
#define   US_MR_USART_MODE_ISO7816_T_1_Val _UINT32_(0x6)                                        /* (US_MR) IS07816 Protocol: T = 1  */
...
#define US_MR_USART_MODE_ISO7816_T_0     (US_MR_USART_MODE_ISO7816_T_0_Val << US_MR_USART_MODE_Pos) /* (US_MR) IS07816 Protocol: T = 0 Position */
#define US_MR_USART_MODE_ISO7816_T_1     (US_MR_USART_MODE_ISO7816_T_1_Val << US_MR_USART_MODE_Pos) /* (US_MR) IS07816 Protocol: T = 1 Position */
...
#define US_IER_LIN_Msk                   _UINT32_(0xFE00E000)                                 /* (US_IER_LIN) Register Mask  */
...
#define US_IDR_Msk                       _UINT32_(0x014827E7)                                 /* (US_IDR) Register Mask  */
...
#define US_IDR_LIN_Msk                   _UINT32_(0xFE00E000)                                 /* (US_IDR_LIN) Register Mask  */
...
#define US_IMR_Msk                       _UINT32_(0x014827E7)                                 /* (US_IMR) Register Mask  */
...
#define US_IMR_LIN_Msk                   _UINT32_(0xFE00E000)                                 /* (US_IMR_LIN) Register Mask  */
...
#define US_CSR_Msk                       _UINT32_(0x01C827E7)                                 /* (US_CSR) Register Mask  */
...
#define US_CSR_LIN_Msk                   _UINT32_(0xFE80E103)                                 /* (US_CSR_LIN) Register Mask  */
...
#define SPI_SR_Msk                       _UINT32_(0xFF011F0F)                                 /* (SPI_SR) Register Mask  */
...
#define SPI_IER_Msk                      _UINT32_(0xFF001F0F)                                 /* (SPI_IER) Register Mask  */
...
#define SPI_IDR_Msk                      _UINT32_(0xFF001F0F)                                 /* (SPI_IDR) Register Mask  */
...
#define SPI_IMR_Msk                      _UINT32_(0xFF001F0F)                                 /* (SPI_IMR) Register Mask  */
...
#define   SPI_FMR_TXRDYM_TWO_DATA_Val    _UINT32_(0x1)                                        /* (SPI_FMR) TDRE will be at level '1' when at least two data can be written in the transmit FIFO. FIFO. To minimize system bus load, when DMA is enabled to transfer data, the chunk of 1 word (1 word carries 2 data) must be configured in the DMA.  If the transfer is performed by software, the access type must be defined as word (2 data per access, 1 access).  */
...
#define SPI_FMR_TXRDYM_TWO_DATA          (SPI_FMR_TXRDYM_TWO_DATA_Val << SPI_FMR_TXRDYM_Pos) /* (SPI_FMR) TDRE will be at level '1' when at least two data can be written in the transmit FIFO. FIFO. To minimize system bus load, when DMA is enabled to transfer data, the chunk of 1 word (1 word carries 2 data) must be configured in the DMA.  If the transfer is performed by software, the access type must be defined as word (2 data per access, 1 access). Position */
...
#define   SPI_FMR_RXRDYM_ONE_DATA_Val    _UINT32_(0x0)                                        /* (SPI_FMR) RDRF will be at level '1' when at least one unread data is in the receive FIFO. When DMA is enabled to transfer data and SPI_CSR0.BITS=0 (8 bits transfered on SPI line), the chunk of 1 byte must be configured in the DMA. When SPI_CSR0.BITS>0 (9 to 16 bits transfered on SPI line), the chunk of 1 halfword must be configured in the DMA. If the transfer is performed by software, the access type can be defined as byte or halfword depending on SPI_CSR0.BITS.  */
#define   SPI_FMR_RXRDYM_TWO_DATA_Val    _UINT32_(0x1)                                        /* (SPI_FMR) RDRF will be at level '1' when at least two unread data are in the receive FIFO. To minimize system bus load, when DMA is enabled to transfer data and SPI_CSR0.BITS=0 (8 bits transfered on SPI line), the chunk of 1 halfword (1 halfword carries 2 bytes) must be configured in the DMA. When SPI_CSR0.BITS>0 (9 to 16 bits transfered on SPI line), the chunk of 1 word (1 word carries 2 halfwords) must be configured in the DMA. If the transfer is performed by software, the access type can be defined as halfword (2 bytes per access, 1 access when SPI_CSR0.BITS=0), or word (2 halfwords per access, 2 accesses when SPI_CSR0.BITS>0).  */
#define   SPI_FMR_RXRDYM_FOUR_DATA_Val   _UINT32_(0x2)                                        /* (SPI_FMR) RDRF will be at level '1' when at least four unread data are in the receive FIFO. To minimize system bus load, when DMA is enabled to transfer data and SPI_CSR0.BITS=0 (8 bits transfered on SPI line), the chunk of 1 word (1 halfword carries 4 bytes) must be configured in the DMA. When SPI_CSR0.BITS>0 (9 to 16 bits transfered on SPI line), the chunk of 2 words (1 word carries 4 bytes) must be configured in the DMA. If the transfer is performed by software, the access type can be defined as word (4 bytes per access, 1 access when SPI_CSR0.BITS=0 or 2 halfwords per access, 2 accesses when SPI_CSR0.BITS>0).  */
#define SPI_FMR_RXRDYM_ONE_DATA          (SPI_FMR_RXRDYM_ONE_DATA_Val << SPI_FMR_RXRDYM_Pos) /* (SPI_FMR) RDRF will be at level '1' when at least one unread data is in the receive FIFO. When DMA is enabled to transfer data and SPI_CSR0.BITS=0 (8 bits transfered on SPI line), the chunk of 1 byte must be configured in the DMA. When SPI_CSR0.BITS>0 (9 to 16 bits transfered on SPI line), the chunk of 1 halfword must be configured in the DMA. If the transfer is performed by software, the access type can be defined as byte or halfword depending on SPI_CSR0.BITS. Position */
#define SPI_FMR_RXRDYM_TWO_DATA          (SPI_FMR_RXRDYM_TWO_DATA_Val << SPI_FMR_RXRDYM_Pos) /* (SPI_FMR) RDRF will be at level '1' when at least two unread data are in the receive FIFO. To minimize system bus load, when DMA is enabled to transfer data and SPI_CSR0.BITS=0 (8 bits transfered on SPI line), the chunk of 1 halfword (1 halfword carries 2 bytes) must be configured in the DMA. When SPI_CSR0.BITS>0 (9 to 16 bits transfered on SPI line), the chunk of 1 word (1 word carries 2 halfwords) must be configured in the DMA. If the transfer is performed by software, the access type can be defined as halfword (2 bytes per access, 1 access when SPI_CSR0.BITS=0), or word (2 halfwords per access, 2 accesses when SPI_CSR0.BITS>0). Position */
#define SPI_FMR_RXRDYM_FOUR_DATA         (SPI_FMR_RXRDYM_FOUR_DATA_Val << SPI_FMR_RXRDYM_Pos) /* (SPI_FMR) RDRF will be at level '1' when at least four unread data are in the receive FIFO. To minimize system bus load, when DMA is enabled to transfer data and SPI_CSR0.BITS=0 (8 bits transfered on SPI line), the chunk of 1 word (1 halfword carries 4 bytes) must be configured in the DMA. When SPI_CSR0.BITS>0 (9 to 16 bits transfered on SPI line), the chunk of 2 words (1 word carries 4 bytes) must be configured in the DMA. If the transfer is performed by software, the access type can be defined as word (4 bytes per access, 1 access when SPI_CSR0.BITS=0 or 2 halfwords per access, 2 accesses when SPI_CSR0.BITS>0). Position */
...
#define TWI_CR_FIFO_ENABLED_Msk          _UINT32_(0x37008000)                                 /* (TWI_CR_FIFO_ENABLED) Register Mask  */
...
#define TWI_SR_Msk                       _UINT32_(0x07BD0FFF)                                 /* (TWI_SR) Register Mask  */
...
#define TWI_SR_FIFO_ENABLED_Msk          _UINT32_(0x00800107)                                 /* (TWI_SR_FIFO_ENABLED) Register Mask  */
...
#endif /* _SAMA7G5_FLEXCOM_COMPONENT_US_SPI_TWI_H_ */
