/*
 * Peripheral I/O description for sama7d65d2gn8
 *
...
#ifndef _sama7d65d2gn8_GPIO_H_
#define _sama7d65d2gn8_GPIO_H_
...
#define PIN_PC22A_ARM_NTRST                        _UINT32_(86)         /* ARM signal: ARM_NTRST on PC22 mux A */
#define MUX_PC22A_ARM_NTRST                        _UINT32_(0)          /* ARM signal line function value: ARM_NTRST */
#define PIO_PC22A_ARM_NTRST                        (_UINT32_(1) << 22)  /* ARM signal: ARM_NTRST */

#define PIN_PC23A_ARM_TCK_SWCLK                    _UINT32_(87)         /* ARM signal: ARM_TCK_SWCLK on PC23 mux A */
#define MUX_PC23A_ARM_TCK_SWCLK                    _UINT32_(0)          /* ARM signal line function value: ARM_TCK_SWCLK */
#define PIO_PC23A_ARM_TCK_SWCLK                    (_UINT32_(1) << 23)  /* ARM signal: ARM_TCK_SWCLK */

#define PIN_PC25A_ARM_TDI                          _UINT32_(89)         /* ARM signal: ARM_TDI on PC25 mux A */
#define MUX_PC25A_ARM_TDI                          _UINT32_(0)          /* ARM signal line function value: ARM_TDI */
#define PIO_PC25A_ARM_TDI                          (_UINT32_(1) << 25)  /* ARM signal: ARM_TDI */

#define PIN_PC26A_ARM_TDO                          _UINT32_(90)         /* ARM signal: ARM_TDO on PC26 mux A */
#define MUX_PC26A_ARM_TDO                          _UINT32_(0)          /* ARM signal line function value: ARM_TDO */
#define PIO_PC26A_ARM_TDO                          (_UINT32_(1) << 26)  /* ARM signal: ARM_TDO */

#define PIN_PC24A_ARM_TMS_SWDIO                    _UINT32_(88)         /* ARM signal: ARM_TMS_SWDIO on PC24 mux A */
#define MUX_PC24A_ARM_TMS_SWDIO                    _UINT32_(0)          /* ARM signal line function value: ARM_TMS_SWDIO */
#define PIO_PC24A_ARM_TMS_SWDIO                    (_UINT32_(1) << 24)  /* ARM signal: ARM_TMS_SWDIO */
