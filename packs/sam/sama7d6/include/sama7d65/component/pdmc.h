...
#ifndef _SAMA7D_PDMC_COMPONENT_H_
#define _SAMA7D_PDMC_COMPONENT_H_
...
#define PDMC_MR_RHRJUSTIF(value)              (PDMC_MR_RHRJUSTIF_Msk & (_UINT32_(value) << PDMC_MR_RHRJUSTIF_Pos)) /* Assignment of value for RHRJUSTIF in the PDMC_MR register */
...
#define PDMC_IER_SAT0(value)                  (PDMC_IER_SAT0_Msk & (_UINT32_(value) << PDMC_IER_SAT0_Pos)) /* Assignment of value for SAT0 in the PDMC_IER register */
...
#define PDMC_IER_SAT1(value)                  (PDMC_IER_SAT1_Msk & (_UINT32_(value) << PDMC_IER_SAT1_Pos)) /* Assignment of value for SAT1 in the PDMC_IER register */
...
#define PDMC_IER_SAT2(value)                  (PDMC_IER_SAT2_Msk & (_UINT32_(value) << PDMC_IER_SAT2_Pos)) /* Assignment of value for SAT2 in the PDMC_IER register */
...
#define PDMC_IER_SAT3(value)                  (PDMC_IER_SAT3_Msk & (_UINT32_(value) << PDMC_IER_SAT3_Pos)) /* Assignment of value for SAT3 in the PDMC_IER register */
...
#define PDMC_IDR_SAT0(value)                  (PDMC_IDR_SAT0_Msk & (_UINT32_(value) << PDMC_IDR_SAT0_Pos)) /* Assignment of value for SAT0 in the PDMC_IDR register */
...
#define PDMC_IDR_SAT1(value)                  (PDMC_IDR_SAT1_Msk & (_UINT32_(value) << PDMC_IDR_SAT1_Pos)) /* Assignment of value for SAT1 in the PDMC_IDR register */
...
#define PDMC_IDR_SAT2(value)                  (PDMC_IDR_SAT2_Msk & (_UINT32_(value) << PDMC_IDR_SAT2_Pos)) /* Assignment of value for SAT2 in the PDMC_IDR register */
...
#define PDMC_IDR_SAT3(value)                  (PDMC_IDR_SAT3_Msk & (_UINT32_(value) << PDMC_IDR_SAT3_Pos)) /* Assignment of value for SAT3 in the PDMC_IDR register */
...
#define PDMC_IMR_SAT0(value)                  (PDMC_IMR_SAT0_Msk & (_UINT32_(value) << PDMC_IMR_SAT0_Pos)) /* Assignment of value for SAT0 in the PDMC_IMR register */
...
#define PDMC_IMR_SAT1(value)                  (PDMC_IMR_SAT1_Msk & (_UINT32_(value) << PDMC_IMR_SAT1_Pos)) /* Assignment of value for SAT1 in the PDMC_IMR register */
...
#define PDMC_IMR_SAT2(value)                  (PDMC_IMR_SAT2_Msk & (_UINT32_(value) << PDMC_IMR_SAT2_Pos)) /* Assignment of value for SAT2 in the PDMC_IMR register */
...
#define PDMC_IMR_SAT3(value)                  (PDMC_IMR_SAT3_Msk & (_UINT32_(value) << PDMC_IMR_SAT3_Pos)) /* Assignment of value for SAT3 in the PDMC_IMR register */
...
#define PDMC_WPMR_FIRSTE(value)               (PDMC_WPMR_FIRSTE_Msk & (_UINT32_(value) << PDMC_WPMR_FIRSTE_Pos)) /* Assignment of value for FIRSTE in the PDMC_WPMR register */
...
#define PDMC_GAIN_GAIN0(value)                (PDMC_GAIN_GAIN0_Msk & (_UINT32_(value) << PDMC_GAIN_GAIN0_Pos)) /* Assignment of value for GAIN0 in the PDMC_GAIN register */
...
#define PDMC_GAIN_GAIN1(value)                (PDMC_GAIN_GAIN1_Msk & (_UINT32_(value) << PDMC_GAIN_GAIN1_Pos)) /* Assignment of value for GAIN1 in the PDMC_GAIN register */
...
#define PDMC_GAIN_GAIN2(value)                (PDMC_GAIN_GAIN2_Msk & (_UINT32_(value) << PDMC_GAIN_GAIN2_Pos)) /* Assignment of value for GAIN2 in the PDMC_GAIN register */
...
#define PDMC_GAIN_GAIN3(value)                (PDMC_GAIN_GAIN3_Msk & (_UINT32_(value) << PDMC_GAIN_GAIN3_Pos)) /* Assignment of value for GAIN3 in the PDMC_GAIN register */
...
#define PDMC_CHM_CHM0(value)                  (PDMC_CHM_CHM0_Msk & (_UINT32_(value) << PDMC_CHM_CHM0_Pos)) /* Assignment of value for CHM0 in the PDMC_CHM register */
...
#define PDMC_CHM_CHM1(value)                  (PDMC_CHM_CHM1_Msk & (_UINT32_(value) << PDMC_CHM_CHM1_Pos)) /* Assignment of value for CHM1 in the PDMC_CHM register */
...
#define PDMC_CHM_CHM2(value)                  (PDMC_CHM_CHM2_Msk & (_UINT32_(value) << PDMC_CHM_CHM2_Pos)) /* Assignment of value for CHM2 in the PDMC_CHM register */
...
#define PDMC_CHM_CHM3(value)                  (PDMC_CHM_CHM3_Msk & (_UINT32_(value) << PDMC_CHM_CHM3_Pos)) /* Assignment of value for CHM3 in the PDMC_CHM register */
...
#endif /* _SAMA7D_PDMC_COMPONENT_H_ */
