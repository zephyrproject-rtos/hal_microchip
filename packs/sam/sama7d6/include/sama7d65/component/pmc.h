...
#ifndef _SAMA7D_PMC_COMPONENT_H_
#define _SAMA7D_PMC_COMPONENT_H_
...
#define CKGR_MOR_BMCKRST(value)               (CKGR_MOR_BMCKRST_Msk & (_UINT32_(value) << CKGR_MOR_BMCKRST_Pos)) /* Assignment of value for BMCKRST in the CKGR_MOR register */
...
#define CKGR_MOR_Msk                          _UINT32_(0x6FFFFF0D)                                 /* (CKGR_MOR) Register Mask  */
...
#define PMC_FSMR_WLAN1(value)                 (PMC_FSMR_WLAN1_Msk & (_UINT32_(value) << PMC_FSMR_WLAN1_Pos)) /* Assignment of value for WLAN1 in the PMC_FSMR register */
...
#define PMC_MCKLIM_MCK_LOW_RES(value)         (PMC_MCKLIM_MCK_LOW_RES_Msk & (_UINT32_(value) << PMC_MCKLIM_MCK_LOW_RES_Pos)) /* Assignment of value for MCK_LOW_RES in the PMC_MCKLIM register */
...
#define PMC_MCKLIM_MCK_HIGH_RES(value)        (PMC_MCKLIM_MCK_HIGH_RES_Msk & (_UINT32_(value) << PMC_MCKLIM_MCK_HIGH_RES_Pos)) /* Assignment of value for MCK_HIGH_RES in the PMC_MCKLIM register */
...
#define PMC_CSR2_PID67(value)                 (PMC_CSR2_PID67_Msk & (_UINT32_(value) << PMC_CSR2_PID67_Pos)) /* Assignment of value for PID67 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID76(value)                 (PMC_CSR2_PID76_Msk & (_UINT32_(value) << PMC_CSR2_PID76_Pos)) /* Assignment of value for PID76 in the PMC_CSR2 register */
...
#define PMC_CSR3_PID99(value)                 (PMC_CSR3_PID99_Msk & (_UINT32_(value) << PMC_CSR3_PID99_Pos)) /* Assignment of value for PID99 in the PMC_CSR3 register */
...
#define PMC_CSR3_PID100(value)                (PMC_CSR3_PID100_Msk & (_UINT32_(value) << PMC_CSR3_PID100_Pos)) /* Assignment of value for PID100 in the PMC_CSR3 register */
...
#define PMC_CSR3_PID101(value)                (PMC_CSR3_PID101_Msk & (_UINT32_(value) << PMC_CSR3_PID101_Pos)) /* Assignment of value for PID101 in the PMC_CSR3 register */
...
#define PMC_CSR3_PID102(value)                (PMC_CSR3_PID102_Msk & (_UINT32_(value) << PMC_CSR3_PID102_Pos)) /* Assignment of value for PID102 in the PMC_CSR3 register */
...
#define PMC_CSR3_PID103(value)                (PMC_CSR3_PID103_Msk & (_UINT32_(value) << PMC_CSR3_PID103_Pos)) /* Assignment of value for PID103 in the PMC_CSR3 register */
...
#define PMC_GCSR0_GPID28(value)               (PMC_GCSR0_GPID28_Msk & (_UINT32_(value) << PMC_GCSR0_GPID28_Pos)) /* Assignment of value for GPID28 in the PMC_GCSR0 register */
...
#define PMC_GCSR1_GPID36(value)               (PMC_GCSR1_GPID36_Msk & (_UINT32_(value) << PMC_GCSR1_GPID36_Pos)) /* Assignment of value for GPID36 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID50(value)               (PMC_GCSR1_GPID50_Msk & (_UINT32_(value) << PMC_GCSR1_GPID50_Pos)) /* Assignment of value for GPID50 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID56(value)               (PMC_GCSR1_GPID56_Msk & (_UINT32_(value) << PMC_GCSR1_GPID56_Pos)) /* Assignment of value for GPID56 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID59(value)               (PMC_GCSR1_GPID59_Msk & (_UINT32_(value) << PMC_GCSR1_GPID59_Pos)) /* Assignment of value for GPID59 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID60(value)               (PMC_GCSR1_GPID60_Msk & (_UINT32_(value) << PMC_GCSR1_GPID60_Pos)) /* Assignment of value for GPID60 in the PMC_GCSR1 register */
...
#define PMC_GCSR2_GPID67(value)               (PMC_GCSR2_GPID67_Msk & (_UINT32_(value) << PMC_GCSR2_GPID67_Pos)) /* Assignment of value for GPID67 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID76(value)               (PMC_GCSR2_GPID76_Msk & (_UINT32_(value) << PMC_GCSR2_GPID76_Pos)) /* Assignment of value for GPID76 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID77(value)               (PMC_GCSR2_GPID77_Msk & (_UINT32_(value) << PMC_GCSR2_GPID77_Pos)) /* Assignment of value for GPID77 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID83(value)               (PMC_GCSR2_GPID83_Msk & (_UINT32_(value) << PMC_GCSR2_GPID83_Pos)) /* Assignment of value for GPID83 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID86(value)               (PMC_GCSR2_GPID86_Msk & (_UINT32_(value) << PMC_GCSR2_GPID86_Pos)) /* Assignment of value for GPID86 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID89(value)               (PMC_GCSR2_GPID89_Msk & (_UINT32_(value) << PMC_GCSR2_GPID89_Pos)) /* Assignment of value for GPID89 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID90(value)               (PMC_GCSR2_GPID90_Msk & (_UINT32_(value) << PMC_GCSR2_GPID90_Pos)) /* Assignment of value for GPID90 in the PMC_GCSR2 register */
...
#define PMC_GCSR3_GPID103(value)              (PMC_GCSR3_GPID103_Msk & (_UINT32_(value) << PMC_GCSR3_GPID103_Pos)) /* Assignment of value for GPID103 in the PMC_GCSR3 register */
...
#define PMC_GCSR3_GPID105(value)              (PMC_GCSR3_GPID105_Msk & (_UINT32_(value) << PMC_GCSR3_GPID105_Pos)) /* Assignment of value for GPID105 in the PMC_GCSR3 register */
...
#define PMC_PLL_IER_LOCK7(value)              (PMC_PLL_IER_LOCK7_Msk & (_UINT32_(value) << PMC_PLL_IER_LOCK7_Pos)) /* Assignment of value for LOCK7 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_LOCK8(value)              (PMC_PLL_IER_LOCK8_Msk & (_UINT32_(value) << PMC_PLL_IER_LOCK8_Pos)) /* Assignment of value for LOCK8 in the PMC_PLL_IER register */
...
#define PMC_PLL_IDR_LOCK7(value)              (PMC_PLL_IDR_LOCK7_Msk & (_UINT32_(value) << PMC_PLL_IDR_LOCK7_Pos)) /* Assignment of value for LOCK7 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_LOCK8(value)              (PMC_PLL_IDR_LOCK8_Msk & (_UINT32_(value) << PMC_PLL_IDR_LOCK8_Pos)) /* Assignment of value for LOCK8 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IMR_LOCK7(value)              (PMC_PLL_IMR_LOCK7_Msk & (_UINT32_(value) << PMC_PLL_IMR_LOCK7_Pos)) /* Assignment of value for LOCK7 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_LOCK8(value)              (PMC_PLL_IMR_LOCK8_Msk & (_UINT32_(value) << PMC_PLL_IMR_LOCK8_Pos)) /* Assignment of value for LOCK8 in the PMC_PLL_IMR register */
...
#define PMC_PLL_ISR0_LOCK7(value)             (PMC_PLL_ISR0_LOCK7_Msk & (_UINT32_(value) << PMC_PLL_ISR0_LOCK7_Pos)) /* Assignment of value for LOCK7 in the PMC_PLL_ISR0 register */
...
#define PMC_PLL_ISR0_LOCK8(value)             (PMC_PLL_ISR0_LOCK8_Msk & (_UINT32_(value) << PMC_PLL_ISR0_LOCK8_Pos)) /* Assignment of value for LOCK8 in the PMC_PLL_ISR0 register */
...
#endif /* _SAMA7D_PMC_COMPONENT_H_ */
