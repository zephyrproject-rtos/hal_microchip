...
#ifndef _SAMA7D_AES_COMPONENT_H_
#define _SAMA7D_AES_COMPONENT_H_
...
#define AES_CR_KSWP(value)                    (AES_CR_KSWP_Msk & (_UINT32_(value) << AES_CR_KSWP_Pos)) /* Assignment of value for KSWP in the AES_CR register */
...
#define AES_EMR_KSEL(value)                   (AES_EMR_KSEL_Msk & (_UINT32_(value) << AES_EMR_KSEL_Pos)) /* Assignment of value for KSEL in the AES_EMR register */
...
#endif /* _SAMA7D_AES_COMPONENT_H_ */
