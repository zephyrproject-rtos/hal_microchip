...
#define PAC_INTFLAGAHB_Msk                    _UINT32_(0x00005FFF)                                 /* (PAC_INTFLAGAHB) Register Mask  */
...
#define PAC_INTFLAGAHB_SDHC_Msk               (_UINT32_(0x1) << PAC_INTFLAGAHB_SDHC_Pos)           /* (PAC_INTFLAGAHB Mask) SDHC */
...
#define PAC_INTFLAGC_Msk                      _UINT32_(0x00007FFB)                                 /* (PAC_INTFLAGC) Register Mask  */
...
#define PAC_STATUSC_Msk                       _UINT32_(0x00007FFB)                                 /* (PAC_STATUSC) Register Mask  */
