/*
 * Header file for PIC32CK1012GC00100
 *
...
/* File generated from device description file (ATDF) version 2024-04-02T09:15:50Z */
#ifndef _PIC32CK1012GC00100_H_
#define _PIC32CK1012GC00100_H_
...
/* PIC32CK1012GC00100 definitions
  This file defines all structures and symbols for PIC32CK1012GC00100:
...
/* ************************************************************************** */
/*                  CMSIS DEFINITIONS FOR PIC32CK1012GC00100                  */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
/* ************* PIC32CK1012GC00100 specific Interrupt Numbers ************** */
  ...
  CAN0_IRQn                 = 143, /* 143 CAN0 (CAN0)                         */
  ETH_IRQn                  = 145, /* 145 ETH (ETH)                           */
...
#include "system_pic32ckgc00.h"
#endif /* USE_CMSIS_INIT */

/* ************************************************************************** */
/*         SOFTWARE PERIPHERAL API DEFINITIONS FOR PIC32CK1012GC00100         */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                INSTANCE DEFINITIONS FOR PIC32CK1012GC00100                 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*              PERIPHERAL ID DEFINITIONS FOR PIC32CK1012GC00100              */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*       REGISTER STRUCTURE ADDRESS DEFINITIONS FOR PIC32CK1012GC00100        */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
/* ************************************************************************** */
/*              BASE ADDRESS DEFINITIONS FOR PIC32CK1012GC00100               */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                   PIO DEFINITIONS FOR PIC32CK1012GC00100                   */
/* ************************************************************************** */
#include "pio/pic32ck1012gc00100.h"

/* ************************************************************************** */
/*             MEMORY MAPPING DEFINITIONS FOR PIC32CK1012GC00100              */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                  DEVICE SIGNATURES FOR PIC32CK1012GC00100                  */
/* ************************************************************************** */
#define CHIP_DSU_DID                   _UINT32_(0X19588053)

/* ************************************************************************** */
/*               ELECTRICAL DEFINITIONS FOR PIC32CK1012GC00100                */
/* ************************************************************************** */

/* ************************************************************************** */
/*                  Event Generator IDs for C32CK1012GC00100                  */
/* ************************************************************************** */
...
#define EVENT_ID_GEN_FAKE_TCC6_OVF                       96 /* ID for FAKE event generator TCC6_OVF */
#define EVENT_ID_GEN_FAKE_TCC6_TRG                       97 /* ID for FAKE event generator TCC6_TRG */
#define EVENT_ID_GEN_FAKE_TCC6_CNT                       98 /* ID for FAKE event generator TCC6_CNT */
#define EVENT_ID_GEN_FAKE_TCC6_MC_0                      99 /* ID for FAKE event generator TCC6_MC_0 */
#define EVENT_ID_GEN_FAKE_TCC6_MC_1                     100 /* ID for FAKE event generator TCC6_MC_1 */
#define EVENT_ID_GEN_FAKE_TCC7_OVF                      101 /* ID for FAKE event generator TCC7_OVF */
#define EVENT_ID_GEN_FAKE_TCC7_TRG                      102 /* ID for FAKE event generator TCC7_TRG */
#define EVENT_ID_GEN_FAKE_TCC7_CNT                      103 /* ID for FAKE event generator TCC7_CNT */
#define EVENT_ID_GEN_FAKE_TCC7_MC_0                     104 /* ID for FAKE event generator TCC7_MC_0 */
#define EVENT_ID_GEN_FAKE_TCC7_MC_1                     105 /* ID for FAKE event generator TCC7_MC_1 */
...
/* ************************************************************************** */
/*                    Event User IDs for C32CK1012GC00100                     */
/* ************************************************************************** */
...
#define EVENT_ID_USER_FAKE_TCC6_EV_0                     70 /* ID for FAKE event user TCC6_EV_0 */
#define EVENT_ID_USER_FAKE_TCC6_EV_1                     71 /* ID for FAKE event user TCC6_EV_1 */
#define EVENT_ID_USER_FAKE_TCC6_MC_0                     72 /* ID for FAKE event user TCC6_MC_0 */
#define EVENT_ID_USER_FAKE_TCC6_MC_1                     73 /* ID for FAKE event user TCC6_MC_1 */
#define EVENT_ID_USER_FAKE_TCC7_EV_0                     74 /* ID for FAKE event user TCC7_EV_0 */
#define EVENT_ID_USER_FAKE_TCC7_EV_1                     75 /* ID for FAKE event user TCC7_EV_1 */
#define EVENT_ID_USER_FAKE_TCC7_MC_0                     76 /* ID for FAKE event user TCC7_MC_0 */
#define EVENT_ID_USER_FAKE_TCC7_MC_1                     77 /* ID for FAKE event user TCC7_MC_1 */
