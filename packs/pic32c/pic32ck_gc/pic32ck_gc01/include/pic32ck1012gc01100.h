/*
 * Header file for PIC32CK1012GC01100
 *
...
/* File generated from device description file (ATDF) version 2025-04-07T17:07:34Z */
#ifndef _PIC32CK1012GC01100_H_
#define _PIC32CK1012GC01100_H_
...
/* PIC32CK1012GC01100 definitions
  This file defines all structures and symbols for PIC32CK1012GC01100:
...
/* ************************************************************************** */
/*                  CMSIS DEFINITIONS FOR PIC32CK1012GC01100                  */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
/* ************* PIC32CK1012GC01100 specific Interrupt Numbers ************** */
  ...
  FLEXRAM_IRQn              = 158, /* 158 Multi-Channel RAM Controller (FLEXRAM) */

  PERIPH_MAX_IRQn           = 158  /* Max peripheral ID */
} IRQn_Type;
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
...
typedef struct _DeviceVectors
{
  ...
  void* pvReserved156;
  void* pvReserved157;
  void* pfnFLEXRAM_Handler;                      /* 158 Multi-Channel RAM Controller (FLEXRAM) */
} DeviceVectors;
...
/* ************************************************************************** */
/*         SOFTWARE PERIPHERAL API DEFINITIONS FOR PIC32CK1012GC01100         */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                INSTANCE DEFINITIONS FOR PIC32CK1012GC01100                 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*              PERIPHERAL ID DEFINITIONS FOR PIC32CK1012GC01100              */
/* ************************************************************************** */
...
#define ID_FLEXRAM       ( 20) /* Instance index for FLEXRAM (FLEXRAM) */
...
#define ID_PERIPH_MAX    ( 96) /* Number of peripheral IDs */

/* ************************************************************************** */
/*       REGISTER STRUCTURE ADDRESS DEFINITIONS FOR PIC32CK1012GC01100        */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
#define FLEXRAM_REGS                     ((mcramc_registers_t*)0x44028000)             /* FLEXRAM Registers Address    */
...
/* ************************************************************************** */
/*              BASE ADDRESS DEFINITIONS FOR PIC32CK1012GC01100               */
/* ************************************************************************** */
...
#define FLEXRAM_BASE_ADDRESS             _UINT32_(0x44028000)                          /* FLEXRAM Base Address */
...
/* ************************************************************************** */
/*                   PIO DEFINITIONS FOR PIC32CK1012GC01100                   */
/* ************************************************************************** */
#include "pio/pic32ck1012gc01100.h"

/* ************************************************************************** */
/*             MEMORY MAPPING DEFINITIONS FOR PIC32CK1012GC01100              */
/* ************************************************************************** */
...
#define FLASH_PFM_SIZE                 _UINT32_(0x00100000)    /* 1024kB Memory segment type: flash */
#define FLASH_PFM_PAGE_SIZE            _UINT32_(      4096)
#define FLASH_PFM_NB_OF_PAGES          _UINT32_(       256)
...
#define HSRAM_RET_SIZE                 _UINT32_(0x00020000)    /*  128kB Memory segment type: ram */
...
/* ************************************************************************** */
/*                  DEVICE SIGNATURES FOR PIC32CK1012GC01100                  */
/* ************************************************************************** */
#define CHIP_DSU_DID                   _UINT32_(0X19582053)

/* ************************************************************************** */
/*               ELECTRICAL DEFINITIONS FOR PIC32CK1012GC01100                */
/* ************************************************************************** */

/* ************************************************************************** */
/*                  Event Generator IDs for C32CK1012GC01100                  */
/* ************************************************************************** */
...
#define EVENT_ID_GEN_EVSYS_RESERVED1                     96 /* ID for RESERVED event generator EVSYS_RESERVED1 */
#define EVENT_ID_GEN_EVSYS_RESERVED2                     97 /* ID for RESERVED event generator EVSYS_RESERVED2 */
#define EVENT_ID_GEN_EVSYS_RESERVED3                     98 /* ID for RESERVED event generator EVSYS_RESERVED3 */
#define EVENT_ID_GEN_EVSYS_RESERVED4                     99 /* ID for RESERVED event generator EVSYS_RESERVED4 */
#define EVENT_ID_GEN_EVSYS_RESERVED5                    100 /* ID for RESERVED event generator EVSYS_RESERVED5 */
#define EVENT_ID_GEN_EVSYS_RESERVED6                    101 /* ID for RESERVED event generator EVSYS_RESERVED6 */
#define EVENT_ID_GEN_EVSYS_RESERVED7                    102 /* ID for RESERVED event generator EVSYS_RESERVED7 */
#define EVENT_ID_GEN_EVSYS_RESERVED8                    103 /* ID for RESERVED event generator EVSYS_RESERVED8 */
#define EVENT_ID_GEN_EVSYS_RESERVED9                    104 /* ID for RESERVED event generator EVSYS_RESERVED9 */
#define EVENT_ID_GEN_EVSYS_RESERVED10                   105 /* ID for RESERVED event generator EVSYS_RESERVED10 */
...
/* ************************************************************************** */
/*                    Event User IDs for C32CK1012GC01100                     */
/* ************************************************************************** */
...
#define EVENT_ID_USER_EVSYS_RESERVED11                   70 /* ID for RESERVED event user EVSYS_RESERVED11 */
#define EVENT_ID_USER_EVSYS_RESERVED12                   71 /* ID for RESERVED event user EVSYS_RESERVED12 */
#define EVENT_ID_USER_EVSYS_RESERVED13                   72 /* ID for RESERVED event user EVSYS_RESERVED13 */
#define EVENT_ID_USER_EVSYS_RESERVED14                   73 /* ID for RESERVED event user EVSYS_RESERVED14 */
#define EVENT_ID_USER_EVSYS_RESERVED15                   74 /* ID for RESERVED event user EVSYS_RESERVED15 */
#define EVENT_ID_USER_EVSYS_RESERVED16                   75 /* ID for RESERVED event user EVSYS_RESERVED16 */
#define EVENT_ID_USER_EVSYS_RESERVED17                   76 /* ID for RESERVED event user EVSYS_RESERVED17 */
#define EVENT_ID_USER_EVSYS_RESERVED18                   77 /* ID for RESERVED event user EVSYS_RESERVED18 */
