...
#ifndef _PIC32CMPL10_DMAC_INSTANCE_
#define _PIC32CMPL10_DMAC_INSTANCE_


/* ========== Instance Parameter definitions for DMAC peripheral ========== */
#define DMAC_CH_BITS                             (1)        /* Number of bits to select channel */
#define DMAC_CH_NUM                              (2)        /* Number of channels */
#define DMAC_EVIN_NUM                            (2)        /* Number of input events */
#define DMAC_EVOUT_NUM                           (2)        /* Number of output events */
...
#define DMAC_TRIG_NUM                            (23)       /* Number of peripheral triggers */

#endif /* _PIC32CMPL10_DMAC_INSTANCE_ */
