...
#ifndef _PIC32CXBZ66_SERCOM_COMPONENT_H_
#define _PIC32CXBZ66_SERCOM_COMPONENT_H_
...
#define SERCOM_USART_CTRLA_RXINV_Pos      _UINT32_(9)                                          /* (SERCOM_USART_CTRLA) Receive Data Invert Position */
...
#define SERCOM_USART_CTRLA_TXINV_Pos      _UINT32_(10)                                         /* (SERCOM_USART_CTRLA) Transmit Data Invert Position */
...
#define   SERCOM_USART_CTRLA_FORM_USART_FRAME_LIN_MASTER_MODE_Val _UINT32_(0x2)                                        /* (SERCOM_USART_CTRLA) LIN Master - Break and sync generation  */
#define   SERCOM_USART_CTRLA_FORM_USART_FRAME_AUTO_BAUD_NO_PARITY_Val _UINT32_(0x4)                                        /* (SERCOM_USART_CTRLA) Auto-baud (LIN Slave) - break detection and auto-baud  */
...
#define   SERCOM_USART_CTRLA_FORM_USART_FRAME_ISO_7816_Val _UINT32_(0x7)                                        /* (SERCOM_USART_CTRLA) ISO 7816  */
...
#define SERCOM_USART_CTRLA_FORM_USART_FRAME_LIN_MASTER_MODE (SERCOM_USART_CTRLA_FORM_USART_FRAME_LIN_MASTER_MODE_Val << SERCOM_USART_CTRLA_FORM_Pos) /* (SERCOM_USART_CTRLA) LIN Master - Break and sync generation Position */
#define SERCOM_USART_CTRLA_FORM_USART_FRAME_AUTO_BAUD_NO_PARITY (SERCOM_USART_CTRLA_FORM_USART_FRAME_AUTO_BAUD_NO_PARITY_Val << SERCOM_USART_CTRLA_FORM_Pos) /* (SERCOM_USART_CTRLA) Auto-baud (LIN Slave) - break detection and auto-baud Position */
...
#define SERCOM_USART_CTRLA_FORM_USART_FRAME_ISO_7816 (SERCOM_USART_CTRLA_FORM_USART_FRAME_ISO_7816_Val << SERCOM_USART_CTRLA_FORM_Pos) /* (SERCOM_USART_CTRLA) ISO 7816 Position */
...
#define   SERCOM_SPI_CTRLC_DATA32B_DATA_TRANS_8BIT_Val _UINT32_(0x0)                                        /* (SERCOM_SPI_CTRLC) Transaction from and to DATA register are 8-bit  */
#define   SERCOM_SPI_CTRLC_DATA32B_DATA_TRANS_32BIT_Val _UINT32_(0x1)                                        /* (SERCOM_SPI_CTRLC) Transaction from and to DATA register are 32-bit  */
#define SERCOM_SPI_CTRLC_DATA32B_DATA_TRANS_8BIT (SERCOM_SPI_CTRLC_DATA32B_DATA_TRANS_8BIT_Val << SERCOM_SPI_CTRLC_DATA32B_Pos) /* (SERCOM_SPI_CTRLC) Transaction from and to DATA register are 8-bit Position */
#define SERCOM_SPI_CTRLC_DATA32B_DATA_TRANS_32BIT (SERCOM_SPI_CTRLC_DATA32B_DATA_TRANS_32BIT_Val << SERCOM_SPI_CTRLC_DATA32B_Pos) /* (SERCOM_SPI_CTRLC) Transaction from and to DATA register are 32-bit Position */
#define SERCOM_SPI_CTRLC_Msk                 _UINT32_(0x0100003F)                                 /* (SERCOM_SPI_CTRLC) Register Mask  */
...
#define   SERCOM_USART_CTRLC_BRKLEN_13_BIT_Val _UINT32_(0x0)                                        /* (SERCOM_USART_CTRLC) Break field transmission is 13 bit times  */
#define   SERCOM_USART_CTRLC_BRKLEN_17_BIT_Val _UINT32_(0x1)                                        /* (SERCOM_USART_CTRLC) Break field transmission is 17 bit times  */
#define   SERCOM_USART_CTRLC_BRKLEN_21_BIT_Val _UINT32_(0x2)                                        /* (SERCOM_USART_CTRLC) Break field transmission is 21 bit times  */
#define   SERCOM_USART_CTRLC_BRKLEN_26_BIT_Val _UINT32_(0x3)                                        /* (SERCOM_USART_CTRLC) Break field transmission is 26 bit times  */
#define SERCOM_USART_CTRLC_BRKLEN_13_BIT  (SERCOM_USART_CTRLC_BRKLEN_13_BIT_Val << SERCOM_USART_CTRLC_BRKLEN_Pos) /* (SERCOM_USART_CTRLC) Break field transmission is 13 bit times Position */
#define SERCOM_USART_CTRLC_BRKLEN_17_BIT  (SERCOM_USART_CTRLC_BRKLEN_17_BIT_Val << SERCOM_USART_CTRLC_BRKLEN_Pos) /* (SERCOM_USART_CTRLC) Break field transmission is 17 bit times Position */
#define SERCOM_USART_CTRLC_BRKLEN_21_BIT  (SERCOM_USART_CTRLC_BRKLEN_21_BIT_Val << SERCOM_USART_CTRLC_BRKLEN_Pos) /* (SERCOM_USART_CTRLC) Break field transmission is 21 bit times Position */
#define SERCOM_USART_CTRLC_BRKLEN_26_BIT  (SERCOM_USART_CTRLC_BRKLEN_26_BIT_Val << SERCOM_USART_CTRLC_BRKLEN_Pos) /* (SERCOM_USART_CTRLC) Break field transmission is 26 bit times Position */
...
#define   SERCOM_USART_CTRLC_HDRDLY_DELAY0_Val _UINT32_(0x0)                                        /* (SERCOM_USART_CTRLC) Delay between break and sync transmission is 1 bit time; Delay between sync and ID transmission is 1 bit time  */
#define   SERCOM_USART_CTRLC_HDRDLY_DELAY1_Val _UINT32_(0x1)                                        /* (SERCOM_USART_CTRLC) Delay between break and sync transmission is 4 bit time; Delay between sync and ID transmission is 4 bit time  */
#define   SERCOM_USART_CTRLC_HDRDLY_DELAY2_Val _UINT32_(0x2)                                        /* (SERCOM_USART_CTRLC) Delay between break and sync transmission is 8 bit time; Delay between sync and ID transmission is 4 bit time  */
#define   SERCOM_USART_CTRLC_HDRDLY_DELAY3_Val _UINT32_(0x3)                                        /* (SERCOM_USART_CTRLC) Delay between break and sync transmission is 14 bit time; Delay between sync and ID transmission is 4 bit time  */
#define SERCOM_USART_CTRLC_HDRDLY_DELAY0  (SERCOM_USART_CTRLC_HDRDLY_DELAY0_Val << SERCOM_USART_CTRLC_HDRDLY_Pos) /* (SERCOM_USART_CTRLC) Delay between break and sync transmission is 1 bit time; Delay between sync and ID transmission is 1 bit time Position */
#define SERCOM_USART_CTRLC_HDRDLY_DELAY1  (SERCOM_USART_CTRLC_HDRDLY_DELAY1_Val << SERCOM_USART_CTRLC_HDRDLY_Pos) /* (SERCOM_USART_CTRLC) Delay between break and sync transmission is 4 bit time; Delay between sync and ID transmission is 4 bit time Position */
#define SERCOM_USART_CTRLC_HDRDLY_DELAY2  (SERCOM_USART_CTRLC_HDRDLY_DELAY2_Val << SERCOM_USART_CTRLC_HDRDLY_Pos) /* (SERCOM_USART_CTRLC) Delay between break and sync transmission is 8 bit time; Delay between sync and ID transmission is 4 bit time Position */
#define SERCOM_USART_CTRLC_HDRDLY_DELAY3  (SERCOM_USART_CTRLC_HDRDLY_DELAY3_Val << SERCOM_USART_CTRLC_HDRDLY_Pos) /* (SERCOM_USART_CTRLC) Delay between break and sync transmission is 14 bit time; Delay between sync and ID transmission is 4 bit time Position */
...
#define   SERCOM_USART_CTRLC_DATA32B_DATA_READ_WRITE_CHSIZE_Val _UINT32_(0x0)                                        /* (SERCOM_USART_CTRLC) Data reads and writes according CTRLB.CHSIZE  */
#define   SERCOM_USART_CTRLC_DATA32B_DATA_READ_CHSIZE_WRITE_32BIT_Val _UINT32_(0x1)                                        /* (SERCOM_USART_CTRLC) Data reads according CTRLB.CHSIZE and writes according 32-bit extension  */
#define   SERCOM_USART_CTRLC_DATA32B_DATA_READ_32BIT_WRITE_CHSIZE_Val _UINT32_(0x2)                                        /* (SERCOM_USART_CTRLC) Data reads according 32-bit extension and writes according CTRLB.CHSIZE  */
#define   SERCOM_USART_CTRLC_DATA32B_DATA_READ_WRITE_32BIT_Val _UINT32_(0x3)                                        /* (SERCOM_USART_CTRLC) Data reads and writes according 32-bit extension  */
#define SERCOM_USART_CTRLC_DATA32B_DATA_READ_WRITE_CHSIZE (SERCOM_USART_CTRLC_DATA32B_DATA_READ_WRITE_CHSIZE_Val << SERCOM_USART_CTRLC_DATA32B_Pos) /* (SERCOM_USART_CTRLC) Data reads and writes according CTRLB.CHSIZE Position */
#define SERCOM_USART_CTRLC_DATA32B_DATA_READ_CHSIZE_WRITE_32BIT (SERCOM_USART_CTRLC_DATA32B_DATA_READ_CHSIZE_WRITE_32BIT_Val << SERCOM_USART_CTRLC_DATA32B_Pos) /* (SERCOM_USART_CTRLC) Data reads according CTRLB.CHSIZE and writes according 32-bit extension Position */
#define SERCOM_USART_CTRLC_DATA32B_DATA_READ_32BIT_WRITE_CHSIZE (SERCOM_USART_CTRLC_DATA32B_DATA_READ_32BIT_WRITE_CHSIZE_Val << SERCOM_USART_CTRLC_DATA32B_Pos) /* (SERCOM_USART_CTRLC) Data reads according 32-bit extension and writes according CTRLB.CHSIZE Position */
#define SERCOM_USART_CTRLC_DATA32B_DATA_READ_WRITE_32BIT (SERCOM_USART_CTRLC_DATA32B_DATA_READ_WRITE_32BIT_Val << SERCOM_USART_CTRLC_DATA32B_Pos) /* (SERCOM_USART_CTRLC) Data reads and writes according 32-bit extension Position */
#define SERCOM_USART_CTRLC_Msk            _UINT32_(0x03730F07)                                 /* (SERCOM_USART_CTRLC) Register Mask  */
...
#define SERCOM_SPI_STATUS_Msk                _UINT16_(0x0804)                                     /* (SERCOM_SPI_STATUS) Register Mask  */
...
#define SERCOM_USART_RXERRCNT_RXERRCNT_Pos _UINT8_(0)                                           /* (SERCOM_USART_RXERRCNT) Receive Error Count Position */
#define SERCOM_USART_RXERRCNT_RXERRCNT_Msk (_UINT8_(0xFF) << SERCOM_USART_RXERRCNT_RXERRCNT_Pos) /* (SERCOM_USART_RXERRCNT) Receive Error Count Mask */
#define SERCOM_USART_RXERRCNT_RXERRCNT(value) (SERCOM_USART_RXERRCNT_RXERRCNT_Msk & (_UINT8_(value) << SERCOM_USART_RXERRCNT_RXERRCNT_Pos)) /* Assignment of value for RXERRCNT in the SERCOM_USART_RXERRCNT register */
#define SERCOM_USART_RXERRCNT_Msk         _UINT8_(0xFF)                                        /* (SERCOM_USART_RXERRCNT) Register Mask  */
...
#endif /* _PIC32CXBZ66_SERCOM_COMPONENT_H_ */
