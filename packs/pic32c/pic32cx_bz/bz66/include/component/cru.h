...
#ifndef _PIC32CXBZ66_CRU_COMPONENT_H_
#define _PIC32CXBZ66_CRU_COMPONENT_H_
...
#define   CRU_OSCCON_CLKLOCK_LOCKED_Val       _UINT32_(0x1)                                        /* (CRU_OSCCON) All clock and PLL configuration registers are locked.  These include OSCCON, OSCTRIM, SPLLCON, PBxDIV  */
...
#define CRU_OSCCON_CLKLOCK_LOCKED             (CRU_OSCCON_CLKLOCK_LOCKED_Val << CRU_OSCCON_CLKLOCK_Pos) /* (CRU_OSCCON) All clock and PLL configuration registers are locked.  These include OSCCON, OSCTRIM, SPLLCON, PBxDIV Position */
...
#define CRU_APLLCON_Msk                       _UINT32_(0x00000000)                                 /* (CRU_APLLCON) Register Mask  */
...
#define CRU_CLKSTAT_Msk                       _UINT32_(0x0000069F)                                 /* (CRU_CLKSTAT) Register Mask  */
...
#define CRU_CLKDIAG_Msk                       _UINT32_(0xFFFF001F)                                 /* (CRU_CLKDIAG) Register Mask  */
...
#endif /* _PIC32CXBZ66_CRU_COMPONENT_H_ */
