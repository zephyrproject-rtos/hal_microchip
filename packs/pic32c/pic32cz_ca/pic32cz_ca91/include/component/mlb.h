...
#ifndef _PIC32CZCA91_MLB_COMPONENT_H_
#define _PIC32CZCA91_MLB_COMPONENT_H_
...
#define MLB_CTRLA_SWRST(value)                (MLB_CTRLA_SWRST_Msk & (_UINT32_(value) << MLB_CTRLA_SWRST_Pos)) /* Assignment of value for SWRST in the MLB_CTRLA register */
...
#define MLB_CTRLA_ENABLE(value)               (MLB_CTRLA_ENABLE_Msk & (_UINT32_(value) << MLB_CTRLA_ENABLE_Pos)) /* Assignment of value for ENABLE in the MLB_CTRLA register */
...
#define MLB_CTRLA_RUNSTDBY(value)             (MLB_CTRLA_RUNSTDBY_Msk & (_UINT32_(value) << MLB_CTRLA_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the MLB_CTRLA register */
...
#define MLB_INTENCLR_INTMLB(value)            (MLB_INTENCLR_INTMLB_Msk & (_UINT32_(value) << MLB_INTENCLR_INTMLB_Pos)) /* Assignment of value for INTMLB in the MLB_INTENCLR register */
...
#define MLB_INTENCLR_INT0AHB(value)           (MLB_INTENCLR_INT0AHB_Msk & (_UINT32_(value) << MLB_INTENCLR_INT0AHB_Pos)) /* Assignment of value for INT0AHB in the MLB_INTENCLR register */
...
#define MLB_INTENCLR_INT1AHB(value)           (MLB_INTENCLR_INT1AHB_Msk & (_UINT32_(value) << MLB_INTENCLR_INT1AHB_Pos)) /* Assignment of value for INT1AHB in the MLB_INTENCLR register */
...
#define MLB_INTENSET_INTMLB(value)            (MLB_INTENSET_INTMLB_Msk & (_UINT32_(value) << MLB_INTENSET_INTMLB_Pos)) /* Assignment of value for INTMLB in the MLB_INTENSET register */
...
#define MLB_INTENSET_INT0AHB(value)           (MLB_INTENSET_INT0AHB_Msk & (_UINT32_(value) << MLB_INTENSET_INT0AHB_Pos)) /* Assignment of value for INT0AHB in the MLB_INTENSET register */
...
#define MLB_INTENSET_INT1AHB(value)           (MLB_INTENSET_INT1AHB_Msk & (_UINT32_(value) << MLB_INTENSET_INT1AHB_Pos)) /* Assignment of value for INT1AHB in the MLB_INTENSET register */
...
#define MLB_INTFLAG_INTMLB(value)             (MLB_INTFLAG_INTMLB_Msk & (_UINT32_(value) << MLB_INTFLAG_INTMLB_Pos)) /* Assignment of value for INTMLB in the MLB_INTFLAG register */
...
#define MLB_INTFLAG_INT0AHB(value)            (MLB_INTFLAG_INT0AHB_Msk & (_UINT32_(value) << MLB_INTFLAG_INT0AHB_Pos)) /* Assignment of value for INT0AHB in the MLB_INTFLAG register */
...
#define MLB_INTFLAG_INT1AHB(value)            (MLB_INTFLAG_INT1AHB_Msk & (_UINT32_(value) << MLB_INTFLAG_INT1AHB_Pos)) /* Assignment of value for INT1AHB in the MLB_INTFLAG register */
...
#define MLB_DBGCTRL_DBGRUN(value)             (MLB_DBGCTRL_DBGRUN_Msk & (_UINT32_(value) << MLB_DBGCTRL_DBGRUN_Pos)) /* Assignment of value for DBGRUN in the MLB_DBGCTRL register */
...
#define MLB_SYNCBUSY_SWRST(value)             (MLB_SYNCBUSY_SWRST_Msk & (_UINT32_(value) << MLB_SYNCBUSY_SWRST_Pos)) /* Assignment of value for SWRST in the MLB_SYNCBUSY register */
...
#define MLB_SYNCBUSY_ENABLE(value)            (MLB_SYNCBUSY_ENABLE_Msk & (_UINT32_(value) << MLB_SYNCBUSY_ENABLE_Pos)) /* Assignment of value for ENABLE in the MLB_SYNCBUSY register */
...
#define MLB_MLBC0_MLBPEN(value)               (MLB_MLBC0_MLBPEN_Msk & (_UINT32_(value) << MLB_MLBC0_MLBPEN_Pos)) /* Assignment of value for MLBPEN in the MLB_MLBC0 register */
...
#define MLB_HCMR0_CHM(value)                  (MLB_HCMR0_CHM_Msk & (_UINT32_(value) << MLB_HCMR0_CHM_Pos)) /* Assignment of value for CHM in the MLB_HCMR0 register */
...
#define MLB_HCMR1_CHM(value)                  (MLB_HCMR1_CHM_Msk & (_UINT32_(value) << MLB_HCMR1_CHM_Pos)) /* Assignment of value for CHM in the MLB_HCMR1 register */
...
#define MLB_HCER0_CERR(value)                 (MLB_HCER0_CERR_Msk & (_UINT32_(value) << MLB_HCER0_CERR_Pos)) /* Assignment of value for CERR in the MLB_HCER0 register */
...
#define MLB_HCER1_CERR(value)                 (MLB_HCER1_CERR_Msk & (_UINT32_(value) << MLB_HCER1_CERR_Pos)) /* Assignment of value for CERR in the MLB_HCER1 register */
...
#define MLB_HCBR0_CHB(value)                  (MLB_HCBR0_CHB_Msk & (_UINT32_(value) << MLB_HCBR0_CHB_Pos)) /* Assignment of value for CHB in the MLB_HCBR0 register */
...
#define MLB_HCBR1_CHB(value)                  (MLB_HCBR1_CHB_Msk & (_UINT32_(value) << MLB_HCBR1_CHB_Pos)) /* Assignment of value for CHB in the MLB_HCBR1 register */
...
#define MLB_MDAT0_DATA(value)                 (MLB_MDAT0_DATA_Msk & (_UINT32_(value) << MLB_MDAT0_DATA_Pos)) /* Assignment of value for DATA in the MLB_MDAT0 register */
...
#define MLB_MDAT1_DATA(value)                 (MLB_MDAT1_DATA_Msk & (_UINT32_(value) << MLB_MDAT1_DATA_Pos)) /* Assignment of value for DATA in the MLB_MDAT1 register */
...
#define MLB_MDAT2_DATA(value)                 (MLB_MDAT2_DATA_Msk & (_UINT32_(value) << MLB_MDAT2_DATA_Pos)) /* Assignment of value for DATA in the MLB_MDAT2 register */
...
#define MLB_MDAT3_DATA(value)                 (MLB_MDAT3_DATA_Msk & (_UINT32_(value) << MLB_MDAT3_DATA_Pos)) /* Assignment of value for DATA in the MLB_MDAT3 register */
...
#define MLB_MDWE0_MASK(value)                 (MLB_MDWE0_MASK_Msk & (_UINT32_(value) << MLB_MDWE0_MASK_Pos)) /* Assignment of value for MASK in the MLB_MDWE0 register */
...
#define MLB_MDWE1_MASK(value)                 (MLB_MDWE1_MASK_Msk & (_UINT32_(value) << MLB_MDWE1_MASK_Pos)) /* Assignment of value for MASK in the MLB_MDWE1 register */
...
#define MLB_MDWE2_MASK(value)                 (MLB_MDWE2_MASK_Msk & (_UINT32_(value) << MLB_MDWE2_MASK_Pos)) /* Assignment of value for MASK in the MLB_MDWE2 register */
...
#define MLB_MDWE3_MASK(value)                 (MLB_MDWE3_MASK_Msk & (_UINT32_(value) << MLB_MDWE3_MASK_Pos)) /* Assignment of value for MASK in the MLB_MDWE3 register */
...
#define MLB_ACTL_DMAMODE(value)               (MLB_ACTL_DMAMODE_Msk & (_UINT32_(value) << MLB_ACTL_DMAMODE_Pos)) /* Assignment of value for DMAMODE in the MLB_ACTL register */
...
#define MLB_ACSR0_CHS(value)                  (MLB_ACSR0_CHS_Msk & (_UINT32_(value) << MLB_ACSR0_CHS_Pos)) /* Assignment of value for CHS in the MLB_ACSR0 register */
...
#define MLB_ACSR1_CHS(value)                  (MLB_ACSR1_CHS_Msk & (_UINT32_(value) << MLB_ACSR1_CHS_Pos)) /* Assignment of value for CHS in the MLB_ACSR1 register */
...
#define MLB_ACMR0_CHM(value)                  (MLB_ACMR0_CHM_Msk & (_UINT32_(value) << MLB_ACMR0_CHM_Pos)) /* Assignment of value for CHM in the MLB_ACMR0 register */
...
#define MLB_ACMR1_CHM(value)                  (MLB_ACMR1_CHM_Msk & (_UINT32_(value) << MLB_ACMR1_CHM_Pos)) /* Assignment of value for CHM in the MLB_ACMR1 register */
...
#endif /* _PIC32CZCA91_MLB_COMPONENT_H_ */
