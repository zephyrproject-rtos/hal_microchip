...
#ifndef _PIC32CZCA91_OSCCTRL_COMPONENT_H_
#define _PIC32CZCA91_OSCCTRL_COMPONENT_H_
...
#define OSCCTRL_INTENCLR_PLL1LOCKR(value)     (OSCCTRL_INTENCLR_PLL1LOCKR_Msk & (_UINT32_(value) << OSCCTRL_INTENCLR_PLL1LOCKR_Pos)) /* Assignment of value for PLL1LOCKR in the OSCCTRL_INTENCLR register */
...
#define OSCCTRL_INTENSET_PLL1LOCKR(value)     (OSCCTRL_INTENSET_PLL1LOCKR_Msk & (_UINT32_(value) << OSCCTRL_INTENSET_PLL1LOCKR_Pos)) /* Assignment of value for PLL1LOCKR in the OSCCTRL_INTENSET register */
...
#define OSCCTRL_INTFLAG_PLL1LOCKR(value)      (OSCCTRL_INTFLAG_PLL1LOCKR_Msk & (_UINT32_(value) << OSCCTRL_INTFLAG_PLL1LOCKR_Pos)) /* Assignment of value for PLL1LOCKR in the OSCCTRL_INTFLAG register */
...
#define OSCCTRL_STATUS_PLL1LOCK(value)        (OSCCTRL_STATUS_PLL1LOCK_Msk & (_UINT32_(value) << OSCCTRL_STATUS_PLL1LOCK_Pos)) /* Assignment of value for PLL1LOCK in the OSCCTRL_STATUS register */
...
#define OSCCTRL_PLL1CTRL_ENABLE(value)        (OSCCTRL_PLL1CTRL_ENABLE_Msk & (_UINT32_(value) << OSCCTRL_PLL1CTRL_ENABLE_Pos)) /* Assignment of value for ENABLE in the OSCCTRL_PLL1CTRL register */
...
#define OSCCTRL_PLL1CTRL_WRTLOCK(value)       (OSCCTRL_PLL1CTRL_WRTLOCK_Msk & (_UINT32_(value) << OSCCTRL_PLL1CTRL_WRTLOCK_Pos)) /* Assignment of value for WRTLOCK in the OSCCTRL_PLL1CTRL register */
...
#define OSCCTRL_PLL1CTRL_ONDEMAND(value)      (OSCCTRL_PLL1CTRL_ONDEMAND_Msk & (_UINT32_(value) << OSCCTRL_PLL1CTRL_ONDEMAND_Pos)) /* Assignment of value for ONDEMAND in the OSCCTRL_PLL1CTRL register */
...
#define OSCCTRL_PLL1CTRL_REFSEL(value)        (OSCCTRL_PLL1CTRL_REFSEL_Msk & (_UINT32_(value) << OSCCTRL_PLL1CTRL_REFSEL_Pos)) /* Assignment of value for REFSEL in the OSCCTRL_PLL1CTRL register */
...
#define OSCCTRL_PLL1CTRL_BWSEL(value)         (OSCCTRL_PLL1CTRL_BWSEL_Msk & (_UINT32_(value) << OSCCTRL_PLL1CTRL_BWSEL_Pos)) /* Assignment of value for BWSEL in the OSCCTRL_PLL1CTRL register */
...
#define OSCCTRL_PLL1FBDIV_FBDIV(value)        (OSCCTRL_PLL1FBDIV_FBDIV_Msk & (_UINT32_(value) << OSCCTRL_PLL1FBDIV_FBDIV_Pos)) /* Assignment of value for FBDIV in the OSCCTRL_PLL1FBDIV register */
...
#define OSCCTRL_PLL1REFDIV_REFDIV(value)      (OSCCTRL_PLL1REFDIV_REFDIV_Msk & (_UINT32_(value) << OSCCTRL_PLL1REFDIV_REFDIV_Pos)) /* Assignment of value for REFDIV in the OSCCTRL_PLL1REFDIV register */
...
#define OSCCTRL_PLL1POSTDIVA_POSTDIV0(value)  (OSCCTRL_PLL1POSTDIVA_POSTDIV0_Msk & (_UINT32_(value) << OSCCTRL_PLL1POSTDIVA_POSTDIV0_Pos)) /* Assignment of value for POSTDIV0 in the OSCCTRL_PLL1POSTDIVA register */
...
#define OSCCTRL_PLL1POSTDIVA_OUTEN0(value)    (OSCCTRL_PLL1POSTDIVA_OUTEN0_Msk & (_UINT32_(value) << OSCCTRL_PLL1POSTDIVA_OUTEN0_Pos)) /* Assignment of value for OUTEN0 in the OSCCTRL_PLL1POSTDIVA register */
...
#define OSCCTRL_PLL1POSTDIVA_POSTDIV1(value)  (OSCCTRL_PLL1POSTDIVA_POSTDIV1_Msk & (_UINT32_(value) << OSCCTRL_PLL1POSTDIVA_POSTDIV1_Pos)) /* Assignment of value for POSTDIV1 in the OSCCTRL_PLL1POSTDIVA register */
...
#define OSCCTRL_PLL1POSTDIVA_OUTEN1(value)    (OSCCTRL_PLL1POSTDIVA_OUTEN1_Msk & (_UINT32_(value) << OSCCTRL_PLL1POSTDIVA_OUTEN1_Pos)) /* Assignment of value for OUTEN1 in the OSCCTRL_PLL1POSTDIVA register */
...
#define OSCCTRL_PLL1POSTDIVA_POSTDIV2(value)  (OSCCTRL_PLL1POSTDIVA_POSTDIV2_Msk & (_UINT32_(value) << OSCCTRL_PLL1POSTDIVA_POSTDIV2_Pos)) /* Assignment of value for POSTDIV2 in the OSCCTRL_PLL1POSTDIVA register */
...
#define OSCCTRL_PLL1POSTDIVA_OUTEN2(value)    (OSCCTRL_PLL1POSTDIVA_OUTEN2_Msk & (_UINT32_(value) << OSCCTRL_PLL1POSTDIVA_OUTEN2_Pos)) /* Assignment of value for OUTEN2 in the OSCCTRL_PLL1POSTDIVA register */
...
#define OSCCTRL_PLL1POSTDIVA_POSTDIV3(value)  (OSCCTRL_PLL1POSTDIVA_POSTDIV3_Msk & (_UINT32_(value) << OSCCTRL_PLL1POSTDIVA_POSTDIV3_Pos)) /* Assignment of value for POSTDIV3 in the OSCCTRL_PLL1POSTDIVA register */
...
#define OSCCTRL_PLL1POSTDIVA_OUTEN3(value)    (OSCCTRL_PLL1POSTDIVA_OUTEN3_Msk & (_UINT32_(value) << OSCCTRL_PLL1POSTDIVA_OUTEN3_Pos)) /* Assignment of value for OUTEN3 in the OSCCTRL_PLL1POSTDIVA register */
...
#define OSCCTRL_FRACDIV1_REMDIV(value)        (OSCCTRL_FRACDIV1_REMDIV_Msk & (_UINT32_(value) << OSCCTRL_FRACDIV1_REMDIV_Pos)) /* Assignment of value for REMDIV in the OSCCTRL_FRACDIV1 register */
...
#define OSCCTRL_FRACDIV1_INTDIV(value)        (OSCCTRL_FRACDIV1_INTDIV_Msk & (_UINT32_(value) << OSCCTRL_FRACDIV1_INTDIV_Pos)) /* Assignment of value for INTDIV in the OSCCTRL_FRACDIV1 register */
...
#endif /* _PIC32CZCA91_OSCCTRL_COMPONENT_H_ */
