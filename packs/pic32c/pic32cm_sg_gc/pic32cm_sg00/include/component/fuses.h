...
/* -------- FUSES_DATA1 : (FUSES Offset: 0x00) (R/W 32)  -------- */
#define FUSES_DATA1_Msk                       _UINT32_(0x00000000)                                 /* (FUSES_DATA1) Register Mask  */
...
#define FUSES_DATA1_REG_OFST           _UINT32_(0x00)      /* (FUSES_DATA1)  Offset */
...
typedef struct
{  /* Defines FUSES module data */
  __IO  uint32_t                       FUSES_DATA1;        /* Offset: 0x00 (R/W  32) None */
