...
#define NVMCTRL_PARAM_DFP(value)              (NVMCTRL_PARAM_DFP_Msk & (_UINT32_(value) << NVMCTRL_PARAM_DFP_Pos)) /* Assignment of value for DFP in the NVMCTRL_PARAM register */
...
#define NVMCTRL_INTENCLR_SERR(value)          (NVMCTRL_INTENCLR_SERR_Msk & (_UINT32_(value) << NVMCTRL_INTENCLR_SERR_Pos)) /* Assignment of value for SERR in the NVMCTRL_INTENCLR register */
...
#define NVMCTRL_INTENCLR_DERR(value)          (NVMCTRL_INTENCLR_DERR_Msk & (_UINT32_(value) << NVMCTRL_INTENCLR_DERR_Pos)) /* Assignment of value for DERR in the NVMCTRL_INTENCLR register */
...
#define NVMCTRL_INTENCLR_FLTCAP(value)        (NVMCTRL_INTENCLR_FLTCAP_Msk & (_UINT32_(value) << NVMCTRL_INTENCLR_FLTCAP_Pos)) /* Assignment of value for FLTCAP in the NVMCTRL_INTENCLR register */
...
#define NVMCTRL_INTENSET_SERR(value)          (NVMCTRL_INTENSET_SERR_Msk & (_UINT32_(value) << NVMCTRL_INTENSET_SERR_Pos)) /* Assignment of value for SERR in the NVMCTRL_INTENSET register */
...
#define NVMCTRL_INTENSET_DERR(value)          (NVMCTRL_INTENSET_DERR_Msk & (_UINT32_(value) << NVMCTRL_INTENSET_DERR_Pos)) /* Assignment of value for DERR in the NVMCTRL_INTENSET register */
...
#define NVMCTRL_INTENSET_FLTCAP(value)        (NVMCTRL_INTENSET_FLTCAP_Msk & (_UINT32_(value) << NVMCTRL_INTENSET_FLTCAP_Pos)) /* Assignment of value for FLTCAP in the NVMCTRL_INTENSET register */
...
#define NVMCTRL_INTFLAG_SERR(value)           (NVMCTRL_INTFLAG_SERR_Msk & (_UINT32_(value) << NVMCTRL_INTFLAG_SERR_Pos)) /* Assignment of value for SERR in the NVMCTRL_INTFLAG register */
...
#define NVMCTRL_INTFLAG_DERR(value)           (NVMCTRL_INTFLAG_DERR_Msk & (_UINT32_(value) << NVMCTRL_INTFLAG_DERR_Pos)) /* Assignment of value for DERR in the NVMCTRL_INTFLAG register */
...
#define NVMCTRL_INTFLAG_FLASHERR(value)       (NVMCTRL_INTFLAG_FLASHERR_Msk & (_UINT32_(value) << NVMCTRL_INTFLAG_FLASHERR_Pos)) /* Assignment of value for FLASHERR in the NVMCTRL_INTFLAG register */
...
#define NVMCTRL_INTFLAG_FLTCAP(value)         (NVMCTRL_INTFLAG_FLTCAP_Msk & (_UINT32_(value) << NVMCTRL_INTFLAG_FLTCAP_Pos)) /* Assignment of value for FLTCAP in the NVMCTRL_INTFLAG register */
...
#define NVMCTRL_PBLDATA0_PBLDATA(value)       (NVMCTRL_PBLDATA0_PBLDATA_Msk & (_UINT32_(value) << NVMCTRL_PBLDATA0_PBLDATA_Pos)) /* Assignment of value for PBLDATA in the NVMCTRL_PBLDATA0 register */
...
#define NVMCTRL_PBLDATA1_PBLDATA(value)       (NVMCTRL_PBLDATA1_PBLDATA_Msk & (_UINT32_(value) << NVMCTRL_PBLDATA1_PBLDATA_Pos)) /* Assignment of value for PBLDATA in the NVMCTRL_PBLDATA1 register */
...
#define NVMCTRL_ECCCTRL_ECCDIS(value)         (NVMCTRL_ECCCTRL_ECCDIS_Msk & (_UINT16_(value) << NVMCTRL_ECCCTRL_ECCDIS_Pos)) /* Assignment of value for ECCDIS in the NVMCTRL_ECCCTRL register */
...
#define NVMCTRL_ECCCTRL_ECCDFDIS(value)       (NVMCTRL_ECCCTRL_ECCDFDIS_Msk & (_UINT16_(value) << NVMCTRL_ECCCTRL_ECCDFDIS_Pos)) /* Assignment of value for ECCDFDIS in the NVMCTRL_ECCCTRL register */
...
#define NVMCTRL_ECCCTRL_SECCNT(value)         (NVMCTRL_ECCCTRL_SECCNT_Msk & (_UINT16_(value) << NVMCTRL_ECCCTRL_SECCNT_Pos)) /* Assignment of value for SECCNT in the NVMCTRL_ECCCTRL register */
...
#define NVMCTRL_FLTCTRL_FLTRST(value)         (NVMCTRL_FLTCTRL_FLTRST_Msk & (_UINT16_(value) << NVMCTRL_FLTCTRL_FLTRST_Pos)) /* Assignment of value for FLTRST in the NVMCTRL_FLTCTRL register */
...
#define NVMCTRL_FLTCTRL_FLTEN(value)          (NVMCTRL_FLTCTRL_FLTEN_Msk & (_UINT16_(value) << NVMCTRL_FLTCTRL_FLTEN_Pos)) /* Assignment of value for FLTEN in the NVMCTRL_FLTCTRL register */
...
#define NVMCTRL_FLTCTRL_FLTMD(value)          (NVMCTRL_FLTCTRL_FLTMD_Msk & (_UINT16_(value) << NVMCTRL_FLTCTRL_FLTMD_Pos)) /* Assignment of value for FLTMD in the NVMCTRL_FLTCTRL register */
...
#define NVMCTRL_FFLTPTR_FLT1PTR(value)        (NVMCTRL_FFLTPTR_FLT1PTR_Msk & (_UINT32_(value) << NVMCTRL_FFLTPTR_FLT1PTR_Pos)) /* Assignment of value for FLT1PTR in the NVMCTRL_FFLTPTR register */
...
#define NVMCTRL_FFLTPTR_FLT2PTR(value)        (NVMCTRL_FFLTPTR_FLT2PTR_Msk & (_UINT32_(value) << NVMCTRL_FFLTPTR_FLT2PTR_Pos)) /* Assignment of value for FLT2PTR in the NVMCTRL_FFLTPTR register */
...
#define NVMCTRL_FFLTADR_FLTADR(value)         (NVMCTRL_FFLTADR_FLTADR_Msk & (_UINT32_(value) << NVMCTRL_FFLTADR_FLTADR_Pos)) /* Assignment of value for FLTADR in the NVMCTRL_FFLTADR register */
...
#define NVMCTRL_FFLTCAP_FLTADR(value)         (NVMCTRL_FFLTCAP_FLTADR_Msk & (_UINT32_(value) << NVMCTRL_FFLTCAP_FLTADR_Pos)) /* Assignment of value for FLTADR in the NVMCTRL_FFLTCAP register */
...
#define NVMCTRL_FFLTPAR_SECIN(value)          (NVMCTRL_FFLTPAR_SECIN_Msk & (_UINT32_(value) << NVMCTRL_FFLTPAR_SECIN_Pos)) /* Assignment of value for SECIN in the NVMCTRL_FFLTPAR register */
...
#define NVMCTRL_FFLTPAR_SECOUT(value)         (NVMCTRL_FFLTPAR_SECOUT_Msk & (_UINT32_(value) << NVMCTRL_FFLTPAR_SECOUT_Pos)) /* Assignment of value for SECOUT in the NVMCTRL_FFLTPAR register */
...
#define NVMCTRL_FFLTSYN_SECSYN(value)         (NVMCTRL_FFLTSYN_SECSYN_Msk & (_UINT32_(value) << NVMCTRL_FFLTSYN_SECSYN_Pos)) /* Assignment of value for SECSYN in the NVMCTRL_FFLTSYN register */
...
#define NVMCTRL_FFLTSYN_DERRSERR(value)       (NVMCTRL_FFLTSYN_DERRSERR_Msk & (_UINT32_(value) << NVMCTRL_FFLTSYN_DERRSERR_Pos)) /* Assignment of value for DERRSERR in the NVMCTRL_FFLTSYN register */
...
#define NVMCTRL_DBGCTRL_DBGECC(value)         (NVMCTRL_DBGCTRL_DBGECC_Msk & (_UINT8_(value) << NVMCTRL_DBGCTRL_DBGECC_Pos)) /* Assignment of value for DBGECC in the NVMCTRL_DBGCTRL register */
