...
#define AC_CTRLB_START2(value)                (AC_CTRLB_START2_Msk & (_UINT8_(value) << AC_CTRLB_START2_Pos)) /* Assignment of value for START2 in the AC_CTRLB register */
...
#define AC_CTRLB_START3(value)                (AC_CTRLB_START3_Msk & (_UINT8_(value) << AC_CTRLB_START3_Pos)) /* Assignment of value for START3 in the AC_CTRLB register */
...
#define AC_EVCTRL_COMPEO2(value)              (AC_EVCTRL_COMPEO2_Msk & (_UINT16_(value) << AC_EVCTRL_COMPEO2_Pos)) /* Assignment of value for COMPEO2 in the AC_EVCTRL register */
...
#define AC_EVCTRL_COMPEO3(value)              (AC_EVCTRL_COMPEO3_Msk & (_UINT16_(value) << AC_EVCTRL_COMPEO3_Pos)) /* Assignment of value for COMPEO3 in the AC_EVCTRL register */
...
#define AC_EVCTRL_WINEO1(value)               (AC_EVCTRL_WINEO1_Msk & (_UINT16_(value) << AC_EVCTRL_WINEO1_Pos)) /* Assignment of value for WINEO1 in the AC_EVCTRL register */
...
#define AC_EVCTRL_COMPEI2(value)              (AC_EVCTRL_COMPEI2_Msk & (_UINT16_(value) << AC_EVCTRL_COMPEI2_Pos)) /* Assignment of value for COMPEI2 in the AC_EVCTRL register */
...
#define AC_EVCTRL_COMPEI3(value)              (AC_EVCTRL_COMPEI3_Msk & (_UINT16_(value) << AC_EVCTRL_COMPEI3_Pos)) /* Assignment of value for COMPEI3 in the AC_EVCTRL register */
...
#define AC_EVCTRL_INVEI2(value)               (AC_EVCTRL_INVEI2_Msk & (_UINT16_(value) << AC_EVCTRL_INVEI2_Pos)) /* Assignment of value for INVEI2 in the AC_EVCTRL register */
...
#define AC_EVCTRL_INVEI3(value)               (AC_EVCTRL_INVEI3_Msk & (_UINT16_(value) << AC_EVCTRL_INVEI3_Pos)) /* Assignment of value for INVEI3 in the AC_EVCTRL register */
...
#define AC_INTENCLR_COMP2(value)              (AC_INTENCLR_COMP2_Msk & (_UINT8_(value) << AC_INTENCLR_COMP2_Pos)) /* Assignment of value for COMP2 in the AC_INTENCLR register */
...
#define AC_INTENCLR_COMP3(value)              (AC_INTENCLR_COMP3_Msk & (_UINT8_(value) << AC_INTENCLR_COMP3_Pos)) /* Assignment of value for COMP3 in the AC_INTENCLR register */
...
#define AC_INTENCLR_WIN1(value)               (AC_INTENCLR_WIN1_Msk & (_UINT8_(value) << AC_INTENCLR_WIN1_Pos)) /* Assignment of value for WIN1 in the AC_INTENCLR register */
...
#define AC_INTENSET_COMP2(value)              (AC_INTENSET_COMP2_Msk & (_UINT8_(value) << AC_INTENSET_COMP2_Pos)) /* Assignment of value for COMP2 in the AC_INTENSET register */
...
#define AC_INTENSET_COMP3(value)              (AC_INTENSET_COMP3_Msk & (_UINT8_(value) << AC_INTENSET_COMP3_Pos)) /* Assignment of value for COMP3 in the AC_INTENSET register */
...
#define AC_INTENSET_WIN1(value)               (AC_INTENSET_WIN1_Msk & (_UINT8_(value) << AC_INTENSET_WIN1_Pos)) /* Assignment of value for WIN1 in the AC_INTENSET register */
...
#define AC_INTFLAG_COMP2(value)               (AC_INTFLAG_COMP2_Msk & (_UINT8_(value) << AC_INTFLAG_COMP2_Pos)) /* Assignment of value for COMP2 in the AC_INTFLAG register */
...
#define AC_INTFLAG_COMP3(value)               (AC_INTFLAG_COMP3_Msk & (_UINT8_(value) << AC_INTFLAG_COMP3_Pos)) /* Assignment of value for COMP3 in the AC_INTFLAG register */
...
#define AC_INTFLAG_WIN1(value)                (AC_INTFLAG_WIN1_Msk & (_UINT8_(value) << AC_INTFLAG_WIN1_Pos)) /* Assignment of value for WIN1 in the AC_INTFLAG register */
...
#define AC_STATUSA_STATE2(value)              (AC_STATUSA_STATE2_Msk & (_UINT8_(value) << AC_STATUSA_STATE2_Pos)) /* Assignment of value for STATE2 in the AC_STATUSA register */
...
#define AC_STATUSA_STATE3(value)              (AC_STATUSA_STATE3_Msk & (_UINT8_(value) << AC_STATUSA_STATE3_Pos)) /* Assignment of value for STATE3 in the AC_STATUSA register */
...
#define AC_STATUSA_WSTATE1(value)             (AC_STATUSA_WSTATE1_Msk & (_UINT8_(value) << AC_STATUSA_WSTATE1_Pos)) /* Assignment of value for WSTATE1 in the AC_STATUSA register */
...
#define AC_STATUSB_READY2(value)              (AC_STATUSB_READY2_Msk & (_UINT8_(value) << AC_STATUSB_READY2_Pos)) /* Assignment of value for READY2 in the AC_STATUSB register */
...
#define AC_STATUSB_READY3(value)              (AC_STATUSB_READY3_Msk & (_UINT8_(value) << AC_STATUSB_READY3_Pos)) /* Assignment of value for READY3 in the AC_STATUSB register */
...
#define AC_WINCTRL_WEN1(value)                (AC_WINCTRL_WEN1_Msk & (_UINT8_(value) << AC_WINCTRL_WEN1_Pos)) /* Assignment of value for WEN1 in the AC_WINCTRL register */
...
#define AC_WINCTRL_WINTSEL1(value)            (AC_WINCTRL_WINTSEL1_Msk & (_UINT8_(value) << AC_WINCTRL_WINTSEL1_Pos)) /* Assignment of value for WINTSEL1 in the AC_WINCTRL register */
...
#define AC_SYNCBUSY_COMPCTRL2(value)          (AC_SYNCBUSY_COMPCTRL2_Msk & (_UINT32_(value) << AC_SYNCBUSY_COMPCTRL2_Pos)) /* Assignment of value for COMPCTRL2 in the AC_SYNCBUSY register */
...
#define AC_SYNCBUSY_COMPCTRL3(value)          (AC_SYNCBUSY_COMPCTRL3_Msk & (_UINT32_(value) << AC_SYNCBUSY_COMPCTRL3_Pos)) /* Assignment of value for COMPCTRL3 in the AC_SYNCBUSY register */
