...
#define FUSES_LOCKBIT_WORD_0_NVMCTRL_CEHL(value) (FUSES_LOCKBIT_WORD_0_NVMCTRL_CEHL_Msk & (_UINT32_(value) << FUSES_LOCKBIT_WORD_0_NVMCTRL_CEHL_Pos)) /* Assignment of value for NVMCTRL_CEHL in the FUSES_LOCKBIT_WORD_0 register */
...
#define FUSES_OTP1_WORD_0_NVMCTRL_NVM_LOCK(value) (FUSES_OTP1_WORD_0_NVMCTRL_NVM_LOCK_Msk & (_UINT32_(value) << FUSES_OTP1_WORD_0_NVMCTRL_NVM_LOCK_Pos)) /* Assignment of value for NVMCTRL_NVM_LOCK in the FUSES_OTP1_WORD_0 register */
...
#define FUSES_OTP1_WORD_0_NVMCTRL_PSZ(value)  (FUSES_OTP1_WORD_0_NVMCTRL_PSZ_Msk & (_UINT32_(value) << FUSES_OTP1_WORD_0_NVMCTRL_PSZ_Pos)) /* Assignment of value for NVMCTRL_PSZ in the FUSES_OTP1_WORD_0 register */
...
#define FUSES_OTP1_WORD_0_NVMCTRL_NVMP(value) (FUSES_OTP1_WORD_0_NVMCTRL_NVMP_Msk & (_UINT32_(value) << FUSES_OTP1_WORD_0_NVMCTRL_NVMP_Pos)) /* Assignment of value for NVMCTRL_NVMP in the FUSES_OTP1_WORD_0 register */
...
#define FUSES_OTP1_WORD_1_NVMCTRL_DATAFLASHP(value) (FUSES_OTP1_WORD_1_NVMCTRL_DATAFLASHP_Msk & (_UINT32_(value) << FUSES_OTP1_WORD_1_NVMCTRL_DATAFLASHP_Pos)) /* Assignment of value for NVMCTRL_DATAFLASHP in the FUSES_OTP1_WORD_1 register */
...
#define FUSES_OTP2_WORD_1_NVMCTRL_ECCDIS_NOTPRESENT(value) (FUSES_OTP2_WORD_1_NVMCTRL_ECCDIS_NOTPRESENT_Msk & (_UINT32_(value) << FUSES_OTP2_WORD_1_NVMCTRL_ECCDIS_NOTPRESENT_Pos)) /* Assignment of value for NVMCTRL_ECCDIS_NOTPRESENT in the FUSES_OTP2_WORD_1 register */
...
#define FUSES_OTP2_WORD_1_NVMCTRL_ECCDATAFLASHDIS_NOTPRESENT(value) (FUSES_OTP2_WORD_1_NVMCTRL_ECCDATAFLASHDIS_NOTPRESENT_Msk & (_UINT32_(value) << FUSES_OTP2_WORD_1_NVMCTRL_ECCDATAFLASHDIS_NOTPRESENT_Pos)) /* Assignment of value for NVMCTRL_ECCDATAFLASHDIS_NOTPRESENT in the FUSES_OTP2_WORD_1 register */
...
#define FUSES_OTP2_WORD_1_NVMCTRL_CEHL_NOTPRESENT(value) (FUSES_OTP2_WORD_1_NVMCTRL_CEHL_NOTPRESENT_Msk & (_UINT32_(value) << FUSES_OTP2_WORD_1_NVMCTRL_CEHL_NOTPRESENT_Pos)) /* Assignment of value for NVMCTRL_CEHL_NOTPRESENT in the FUSES_OTP2_WORD_1 register */
...
#define FUSES_OTP3_WORD_1_NVMCTRL_DUMMY2(value) (FUSES_OTP3_WORD_1_NVMCTRL_DUMMY2_Msk & (_UINT32_(value) << FUSES_OTP3_WORD_1_NVMCTRL_DUMMY2_Pos)) /* Assignment of value for NVMCTRL_DUMMY2 in the FUSES_OTP3_WORD_1 register */
...
#define FUSES_OTP4_WORD_1_NVMCTRL_DUMMY(value) (FUSES_OTP4_WORD_1_NVMCTRL_DUMMY_Msk & (_UINT32_(value) << FUSES_OTP4_WORD_1_NVMCTRL_DUMMY_Pos)) /* Assignment of value for NVMCTRL_DUMMY in the FUSES_OTP4_WORD_1 register */
...
#define FUSES_OTP5_WORD_0_ADC1_BIASREFBUF(value) (FUSES_OTP5_WORD_0_ADC1_BIASREFBUF_Msk & (_UINT32_(value) << FUSES_OTP5_WORD_0_ADC1_BIASREFBUF_Pos)) /* Assignment of value for ADC1_BIASREFBUF in the FUSES_OTP5_WORD_0 register */
...
#define FUSES_OTP5_WORD_0_ADC1_BIASCOMP(value) (FUSES_OTP5_WORD_0_ADC1_BIASCOMP_Msk & (_UINT32_(value) << FUSES_OTP5_WORD_0_ADC1_BIASCOMP_Pos)) /* Assignment of value for ADC1_BIASCOMP in the FUSES_OTP5_WORD_0 register */
...
/* OTP2_FUSES register API structure */
typedef struct
{
...
/* OTP3_FUSES register API structure */
typedef struct
{
  __I   uint8_t                        Reserved1[0x04];
