/*
 * Header file for PIC32CK2051GC00100
 *
...
/* File generated from device description file (ATDF) version 2025-04-07T17:07:13Z */
#ifndef _PIC32CK2051GC00100_H_
#define _PIC32CK2051GC00100_H_
...
/* PIC32CK2051GC00100 definitions
  This file defines all structures and symbols for PIC32CK2051GC00100:
...
/* ************************************************************************** */
/*                  CMSIS DEFINITIONS FOR PIC32CK2051GC00100                  */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
/* ************* PIC32CK2051GC00100 specific Interrupt Numbers ************** */
  ...
  Reserved6_IRQn            = 143, /* 143 Reserved6 (CAN0)                    */
  Reserved7_IRQn            = 144, /* 144 Reserved7 (CAN1)                    */
...
/* ************************************************************************** */
/*         SOFTWARE PERIPHERAL API DEFINITIONS FOR PIC32CK2051GC00100         */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                INSTANCE DEFINITIONS FOR PIC32CK2051GC00100                 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*              PERIPHERAL ID DEFINITIONS FOR PIC32CK2051GC00100              */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*       REGISTER STRUCTURE ADDRESS DEFINITIONS FOR PIC32CK2051GC00100        */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
/* ************************************************************************** */
/*              BASE ADDRESS DEFINITIONS FOR PIC32CK2051GC00100               */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                   PIO DEFINITIONS FOR PIC32CK2051GC00100                   */
/* ************************************************************************** */
#include "pio/pic32ck2051gc00100.h"

/* ************************************************************************** */
/*             MEMORY MAPPING DEFINITIONS FOR PIC32CK2051GC00100              */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                  DEVICE SIGNATURES FOR PIC32CK2051GC00100                  */
/* ************************************************************************** */
#define CHIP_DSU_DID                   _UINT32_(0X09508053)

/* ************************************************************************** */
/*               ELECTRICAL DEFINITIONS FOR PIC32CK2051GC00100                */
/* ************************************************************************** */

/* ************************************************************************** */
/*                  Event Generator IDs for C32CK2051GC00100                  */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                    Event User IDs for C32CK2051GC00100                     */
/* ************************************************************************** */
...
#define EVENT_ID_USER_TCC0_MC0                           32 /* ID for TCC0 event user MC0 */
#define EVENT_ID_USER_TCC0_MC1                           33 /* ID for TCC0 event user MC1 */
#define EVENT_ID_USER_TCC0_MC2                           34 /* ID for TCC0 event user MC2 */
#define EVENT_ID_USER_TCC0_MC3                           35 /* ID for TCC0 event user MC3 */
#define EVENT_ID_USER_TCC0_MC4                           36 /* ID for TCC0 event user MC4 */
#define EVENT_ID_USER_TCC0_MC5                           37 /* ID for TCC0 event user MC5 */
...
#define EVENT_ID_USER_TCC1_MC0                           40 /* ID for TCC1 event user MC0 */
#define EVENT_ID_USER_TCC1_MC1                           41 /* ID for TCC1 event user MC1 */
#define EVENT_ID_USER_TCC1_MC2                           42 /* ID for TCC1 event user MC2 */
#define EVENT_ID_USER_TCC1_MC3                           43 /* ID for TCC1 event user MC3 */
#define EVENT_ID_USER_TCC1_MC4                           44 /* ID for TCC1 event user MC4 */
#define EVENT_ID_USER_TCC1_MC5                           45 /* ID for TCC1 event user MC5 */
...
#define EVENT_ID_USER_TCC2_MC0                           48 /* ID for TCC2 event user MC0 */
#define EVENT_ID_USER_TCC2_MC1                           49 /* ID for TCC2 event user MC1 */
#define EVENT_ID_USER_TCC2_MC2                           50 /* ID for TCC2 event user MC2 */
#define EVENT_ID_USER_TCC2_MC3                           51 /* ID for TCC2 event user MC3 */
#define EVENT_ID_USER_TCC2_MC4                           52 /* ID for TCC2 event user MC4 */
#define EVENT_ID_USER_TCC2_MC5                           53 /* ID for TCC2 event user MC5 */
...
#define EVENT_ID_USER_TCC3_MC0                           56 /* ID for TCC3 event user MC0 */
#define EVENT_ID_USER_TCC3_MC1                           57 /* ID for TCC3 event user MC1 */
#define EVENT_ID_USER_TCC3_MC2                           58 /* ID for TCC3 event user MC2 */
#define EVENT_ID_USER_TCC3_MC3                           59 /* ID for TCC3 event user MC3 */
#define EVENT_ID_USER_TCC3_MC4                           60 /* ID for TCC3 event user MC4 */
#define EVENT_ID_USER_TCC3_MC5                           61 /* ID for TCC3 event user MC5 */
...
#define EVENT_ID_USER_TCC4_MC0                           64 /* ID for TCC4 event user MC0 */
#define EVENT_ID_USER_TCC4_MC1                           65 /* ID for TCC4 event user MC1 */
...
#define EVENT_ID_USER_TCC5_MC0                           68 /* ID for TCC5 event user MC0 */
#define EVENT_ID_USER_TCC5_MC1                           69 /* ID for TCC5 event user MC1 */
...
#define EVENT_ID_USER_TCC6_MC0                           72 /* ID for TCC6 event user MC0 */
#define EVENT_ID_USER_TCC6_MC1                           73 /* ID for TCC6 event user MC1 */
...
#define EVENT_ID_USER_TCC7_MC0                           76 /* ID for TCC7 event user MC0 */
#define EVENT_ID_USER_TCC7_MC1                           77 /* ID for TCC7 event user MC1 */
