...
#ifndef _PIC32CKSG00_FCR_COMPONENT_H_
#define _PIC32CKSG00_FCR_COMPONENT_H_
...
#define FCR_HSMCTRL_KEYZ_Pos                  _UINT32_(1)                                          /* (FCR_HSMCTRL) Flash Key Locations read Position */
#define FCR_HSMCTRL_KEYZ_Msk                  (_UINT32_(0x1) << FCR_HSMCTRL_KEYZ_Pos)              /* (FCR_HSMCTRL) Flash Key Locations read Mask */
...
#endif /* _PIC32CKSG00_FCR_COMPONENT_H_ */
