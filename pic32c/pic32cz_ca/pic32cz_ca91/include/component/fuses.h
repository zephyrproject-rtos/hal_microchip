...
#ifndef _PIC32CZCA91_FUSES_COMPONENT_H_
#define _PIC32CZCA91_FUSES_COMPONENT_H_
...
#define FUSES_ROM_CTRLA_SWRST(value)          (FUSES_ROM_CTRLA_SWRST_Msk & (_UINT32_(value) << FUSES_ROM_CTRLA_SWRST_Pos)) /* Assignment of value for SWRST in the FUSES_ROM_CTRLA register */
...
#define FUSES_ROM_CTRLA_ENABLE(value)         (FUSES_ROM_CTRLA_ENABLE_Msk & (_UINT32_(value) << FUSES_ROM_CTRLA_ENABLE_Pos)) /* Assignment of value for ENABLE in the FUSES_ROM_CTRLA register */
...
#define FUSES_ROM_CTRLA_PRMWS(value)          (FUSES_ROM_CTRLA_PRMWS_Msk & (_UINT32_(value) << FUSES_ROM_CTRLA_PRMWS_Pos)) /* Assignment of value for PRMWS in the FUSES_ROM_CTRLA register */
...
#define FUSES_FCR_CTRLA_ARB(value)            (FUSES_FCR_CTRLA_ARB_Msk & (_UINT32_(value) << FUSES_FCR_CTRLA_ARB_Pos)) /* Assignment of value for ARB in the FUSES_FCR_CTRLA register */
...
#define FUSES_FCR_CTRLA_FWS(value)            (FUSES_FCR_CTRLA_FWS_Msk & (_UINT32_(value) << FUSES_FCR_CTRLA_FWS_Pos)) /* Assignment of value for FWS in the FUSES_FCR_CTRLA register */
...
#define FUSES_FCR_CTRLA_ADRWS(value)          (FUSES_FCR_CTRLA_ADRWS_Msk & (_UINT32_(value) << FUSES_FCR_CTRLA_ADRWS_Pos)) /* Assignment of value for ADRWS in the FUSES_FCR_CTRLA register */
...
#define FUSES_FCR_CTRLA_AUTOWS(value)         (FUSES_FCR_CTRLA_AUTOWS_Msk & (_UINT32_(value) << FUSES_FCR_CTRLA_AUTOWS_Pos)) /* Assignment of value for AUTOWS in the FUSES_FCR_CTRLA register */
...
#define FUSES_FCR_CTRLA_RDBUFWS(value)        (FUSES_FCR_CTRLA_RDBUFWS_Msk & (_UINT32_(value) << FUSES_FCR_CTRLA_RDBUFWS_Pos)) /* Assignment of value for RDBUFWS in the FUSES_FCR_CTRLA register */
...
#define FUSES_RPMU_VREGCTRL_VREGOUT(value)    (FUSES_RPMU_VREGCTRL_VREGOUT_Msk & (_UINT32_(value) << FUSES_RPMU_VREGCTRL_VREGOUT_Pos)) /* Assignment of value for VREGOUT in the FUSES_RPMU_VREGCTRL register */
...
#define FUSES_RPMU_VREGCTRL_OFFSTDBY(value)   (FUSES_RPMU_VREGCTRL_OFFSTDBY_Msk & (_UINT32_(value) << FUSES_RPMU_VREGCTRL_OFFSTDBY_Pos)) /* Assignment of value for OFFSTDBY in the FUSES_RPMU_VREGCTRL register */
...
#define FUSES_RPMU_VREGCTRL_SRAM_VLD(value)   (FUSES_RPMU_VREGCTRL_SRAM_VLD_Msk & (_UINT32_(value) << FUSES_RPMU_VREGCTRL_SRAM_VLD_Pos)) /* Assignment of value for SRAM_VLD in the FUSES_RPMU_VREGCTRL register */
...
#define FUSES_RPMU_VREGCTRL_BKUP_VLD(value)   (FUSES_RPMU_VREGCTRL_BKUP_VLD_Msk & (_UINT32_(value) << FUSES_RPMU_VREGCTRL_BKUP_VLD_Pos)) /* Assignment of value for BKUP_VLD in the FUSES_RPMU_VREGCTRL register */
...
#define FUSES_RPMU_VREGCTRL_CPEN(value)       (FUSES_RPMU_VREGCTRL_CPEN_Msk & (_UINT32_(value) << FUSES_RPMU_VREGCTRL_CPEN_Pos)) /* Assignment of value for CPEN in the FUSES_RPMU_VREGCTRL register */
...
#define FUSES_RPMU_VREGCTRL_ULDOEN(value)     (FUSES_RPMU_VREGCTRL_ULDOEN_Msk & (_UINT32_(value) << FUSES_RPMU_VREGCTRL_ULDOEN_Pos)) /* Assignment of value for ULDOEN in the FUSES_RPMU_VREGCTRL register */
...
#define FUSES_RPMU_VREGCTRL_ULDOSTDBY(value)  (FUSES_RPMU_VREGCTRL_ULDOSTDBY_Msk & (_UINT32_(value) << FUSES_RPMU_VREGCTRL_ULDOSTDBY_Pos)) /* Assignment of value for ULDOSTDBY in the FUSES_RPMU_VREGCTRL register */
...
#define FUSES_RPMU_VREGCTRL_ULDOLEVEL(value)  (FUSES_RPMU_VREGCTRL_ULDOLEVEL_Msk & (_UINT32_(value) << FUSES_RPMU_VREGCTRL_ULDOLEVEL_Pos)) /* Assignment of value for ULDOLEVEL in the FUSES_RPMU_VREGCTRL register */
...
#define FUSES_RPMU_VREGCTRL_AVREGEN(value)    (FUSES_RPMU_VREGCTRL_AVREGEN_Msk & (_UINT32_(value) << FUSES_RPMU_VREGCTRL_AVREGEN_Pos)) /* Assignment of value for AVREGEN in the FUSES_RPMU_VREGCTRL register */
...
#define FUSES_RPMU_VREGCTRL_AVREGSTDBY(value) (FUSES_RPMU_VREGCTRL_AVREGSTDBY_Msk & (_UINT32_(value) << FUSES_RPMU_VREGCTRL_AVREGSTDBY_Pos)) /* Assignment of value for AVREGSTDBY in the FUSES_RPMU_VREGCTRL register */
...
#define FUSES_PLL0_CTRL_ENABLE(value)         (FUSES_PLL0_CTRL_ENABLE_Msk & (_UINT32_(value) << FUSES_PLL0_CTRL_ENABLE_Pos)) /* Assignment of value for ENABLE in the FUSES_PLL0_CTRL register */
...
#define FUSES_PLL0_CTRL_WRTLOCK(value)        (FUSES_PLL0_CTRL_WRTLOCK_Msk & (_UINT32_(value) << FUSES_PLL0_CTRL_WRTLOCK_Pos)) /* Assignment of value for WRTLOCK in the FUSES_PLL0_CTRL register */
...
#define FUSES_PLL0_CTRL_ONDEMAND(value)       (FUSES_PLL0_CTRL_ONDEMAND_Msk & (_UINT32_(value) << FUSES_PLL0_CTRL_ONDEMAND_Pos)) /* Assignment of value for ONDEMAND in the FUSES_PLL0_CTRL register */
...
#define FUSES_PLL0_CTRL_REFSEL(value)         (FUSES_PLL0_CTRL_REFSEL_Msk & (_UINT32_(value) << FUSES_PLL0_CTRL_REFSEL_Pos)) /* Assignment of value for REFSEL in the FUSES_PLL0_CTRL register */
...
#define FUSES_PLL0_CTRL_BWSEL(value)          (FUSES_PLL0_CTRL_BWSEL_Msk & (_UINT32_(value) << FUSES_PLL0_CTRL_BWSEL_Pos)) /* Assignment of value for BWSEL in the FUSES_PLL0_CTRL register */
...
#define FUSES_PLL0_FBDIV_FBDIV(value)         (FUSES_PLL0_FBDIV_FBDIV_Msk & (_UINT32_(value) << FUSES_PLL0_FBDIV_FBDIV_Pos)) /* Assignment of value for FBDIV in the FUSES_PLL0_FBDIV register */
...
#define FUSES_PLL0_REFDIV_REFDIV(value)       (FUSES_PLL0_REFDIV_REFDIV_Msk & (_UINT32_(value) << FUSES_PLL0_REFDIV_REFDIV_Pos)) /* Assignment of value for REFDIV in the FUSES_PLL0_REFDIV register */
...
#define FUSES_PLL0_POSTDIVA_POSTDIV(value)    (FUSES_PLL0_POSTDIVA_POSTDIV_Msk & (_UINT32_(value) << FUSES_PLL0_POSTDIVA_POSTDIV_Pos)) /* Assignment of value for POSTDIV in the FUSES_PLL0_POSTDIVA register */
...
#define FUSES_PLL0_POSTDIVA_OUTEN(value)      (FUSES_PLL0_POSTDIVA_OUTEN_Msk & (_UINT32_(value) << FUSES_PLL0_POSTDIVA_OUTEN_Pos)) /* Assignment of value for OUTEN in the FUSES_PLL0_POSTDIVA register */
...
#define FUSES_FCCFG_UNIQID_UID(value)         (FUSES_FCCFG_UNIQID_UID_Msk & (_UINT32_(value) << FUSES_FCCFG_UNIQID_UID_Pos)) /* Assignment of value for UID in the FUSES_FCCFG_UNIQID register */
...
#define FUSES_FUCFG1_SSXEXDRM(value)          (FUSES_FUCFG1_SSXEXDRM_Msk & (_UINT32_(value) << FUSES_FUCFG1_SSXEXDRM_Pos)) /* Assignment of value for SSXEXDRM in the FUSES_FUCFG1 register */
...
#define FUSES_FUCFG1_SSXEXEBI(value)          (FUSES_FUCFG1_SSXEXEBI_Msk & (_UINT32_(value) << FUSES_FUCFG1_SSXEXEBI_Pos)) /* Assignment of value for SSXEXEBI in the FUSES_FUCFG1 register */
...
#define FUSES_FUCFG1_SSXEXSQI0(value)         (FUSES_FUCFG1_SSXEXSQI0_Msk & (_UINT32_(value) << FUSES_FUCFG1_SSXEXSQI0_Pos)) /* Assignment of value for SSXEXSQI0 in the FUSES_FUCFG1 register */
...
#define FUSES_FUCFG1_SSXEXSQI1(value)         (FUSES_FUCFG1_SSXEXSQI1_Msk & (_UINT32_(value) << FUSES_FUCFG1_SSXEXSQI1_Pos)) /* Assignment of value for SSXEXSQI1 in the FUSES_FUCFG1 register */
...
#define FUSES_FUCFG2_BOR_HYST(value)          (FUSES_FUCFG2_BOR_HYST_Msk & (_UINT32_(value) << FUSES_FUCFG2_BOR_HYST_Pos)) /* Assignment of value for BOR_HYST in the FUSES_FUCFG2 register */
...
#define FUSES_FUCFG2_BOR_TRIP(value)          (FUSES_FUCFG2_BOR_TRIP_Msk & (_UINT32_(value) << FUSES_FUCFG2_BOR_TRIP_Pos)) /* Assignment of value for BOR_TRIP in the FUSES_FUCFG2 register */
...
#define FUSES_FUCFG5_UCP2(value)              (FUSES_FUCFG5_UCP2_Msk & (_UINT32_(value) << FUSES_FUCFG5_UCP2_Pos)) /* Assignment of value for UCP2 in the FUSES_FUCFG5 register */
...
#define FUSES_FUCFG5_UCP3(value)              (FUSES_FUCFG5_UCP3_Msk & (_UINT32_(value) << FUSES_FUCFG5_UCP3_Pos)) /* Assignment of value for UCP3 in the FUSES_FUCFG5 register */
...
#define FUSES_FUCFG9_RAM_INIT_ENB(value)      (FUSES_FUCFG9_RAM_INIT_ENB_Msk & (_UINT32_(value) << FUSES_FUCFG9_RAM_INIT_ENB_Pos)) /* Assignment of value for RAM_INIT_ENB in the FUSES_FUCFG9 register */
...
#define FUSES_FUCFG9_BISR_RST_EN0(value)      (FUSES_FUCFG9_BISR_RST_EN0_Msk & (_UINT32_(value) << FUSES_FUCFG9_BISR_RST_EN0_Pos)) /* Assignment of value for BISR_RST_EN0 in the FUSES_FUCFG9 register */
...
#endif /* _PIC32CZCA91_FUSES_COMPONENT_H_ */
