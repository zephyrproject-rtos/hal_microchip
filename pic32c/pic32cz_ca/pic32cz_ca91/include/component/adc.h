...
#ifndef _PIC32CZCA91_ADC_COMPONENT_H_
#define _PIC32CZCA91_ADC_COMPONENT_H_
...
#define ADC_TESTREG_TESTEN(value)             (ADC_TESTREG_TESTEN_Msk & (_UINT32_(value) << ADC_TESTREG_TESTEN_Pos)) /* Assignment of value for TESTEN in the ADC_TESTREG register */
...
#define ADC_TESTREG_EN_ATEST(value)           (ADC_TESTREG_EN_ATEST_Msk & (_UINT32_(value) << ADC_TESTREG_EN_ATEST_Pos)) /* Assignment of value for EN_ATEST in the ADC_TESTREG register */
...
#define ADC_TESTREG_ADCHSEL(value)            (ADC_TESTREG_ADCHSEL_Msk & (_UINT32_(value) << ADC_TESTREG_ADCHSEL_Pos)) /* Assignment of value for ADCHSEL in the ADC_TESTREG register */
...
#define ADC_TESTREG_ADCORSEL(value)           (ADC_TESTREG_ADCORSEL_Msk & (_UINT32_(value) << ADC_TESTREG_ADCORSEL_Pos)) /* Assignment of value for ADCORSEL in the ADC_TESTREG register */
...
#define ADC_DIGTSTOUT_ADCDIGTST(value)        (ADC_DIGTSTOUT_ADCDIGTST_Msk & (_UINT32_(value) << ADC_DIGTSTOUT_ADCDIGTST_Pos)) /* Assignment of value for ADCDIGTST in the ADC_DIGTSTOUT register */
...
#define ADC_TSTIDOUT_TSTCORID(value)          (ADC_TSTIDOUT_TSTCORID_Msk & (_UINT32_(value) << ADC_TSTIDOUT_TSTCORID_Pos)) /* Assignment of value for TSTCORID in the ADC_TSTIDOUT register */
...
#endif /* _PIC32CZCA91_ADC_COMPONENT_H_ */
