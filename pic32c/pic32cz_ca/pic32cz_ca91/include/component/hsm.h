...
#ifndef _PIC32CZCA91_HSM_COMPONENT_H_
#define _PIC32CZCA91_HSM_COMPONENT_H_
...
#define HSM_CTRLB_CANCEL(value)               (HSM_CTRLB_CANCEL_Msk & (_UINT32_(value) << HSM_CTRLB_CANCEL_Pos)) /* Assignment of value for CANCEL in the HSM_CTRLB register */
...
#define HSM_INTENCLR_ERROR(value)             (HSM_INTENCLR_ERROR_Msk & (_UINT32_(value) << HSM_INTENCLR_ERROR_Pos)) /* Assignment of value for ERROR in the HSM_INTENCLR register */
...
#define HSM_INTENCLR_TAMPER(value)            (HSM_INTENCLR_TAMPER_Msk & (_UINT32_(value) << HSM_INTENCLR_TAMPER_Pos)) /* Assignment of value for TAMPER in the HSM_INTENCLR register */
...
#define HSM_INTENSET_ERROR(value)             (HSM_INTENSET_ERROR_Msk & (_UINT32_(value) << HSM_INTENSET_ERROR_Pos)) /* Assignment of value for ERROR in the HSM_INTENSET register */
...
#define HSM_INTENSET_TAMPER(value)            (HSM_INTENSET_TAMPER_Msk & (_UINT32_(value) << HSM_INTENSET_TAMPER_Pos)) /* Assignment of value for TAMPER in the HSM_INTENSET register */
...
#define HSM_INTFLAG_ERROR(value)              (HSM_INTFLAG_ERROR_Msk & (_UINT32_(value) << HSM_INTFLAG_ERROR_Pos)) /* Assignment of value for ERROR in the HSM_INTFLAG register */
...
#define HSM_INTFLAG_TAMPER(value)             (HSM_INTFLAG_TAMPER_Msk & (_UINT32_(value) << HSM_INTFLAG_TAMPER_Pos)) /* Assignment of value for TAMPER in the HSM_INTFLAG register */
...
#define HSM_STATUS_BUSY(value)                (HSM_STATUS_BUSY_Msk & (_UINT32_(value) << HSM_STATUS_BUSY_Pos)) /* Assignment of value for BUSY in the HSM_STATUS register */
...
#define HSM_STATUS_LKUP(value)                (HSM_STATUS_LKUP_Msk & (_UINT32_(value) << HSM_STATUS_LKUP_Pos)) /* Assignment of value for LKUP in the HSM_STATUS register */
...
#define HSM_STATUS_PS(value)                  (HSM_STATUS_PS_Msk & (_UINT32_(value) << HSM_STATUS_PS_Pos)) /* Assignment of value for PS in the HSM_STATUS register */
...
#define HSM_STATUS_LCS(value)                 (HSM_STATUS_LCS_Msk & (_UINT32_(value) << HSM_STATUS_LCS_Pos)) /* Assignment of value for LCS in the HSM_STATUS register */
...
#define HSM_STATUS_SBS(value)                 (HSM_STATUS_SBS_Msk & (_UINT32_(value) << HSM_STATUS_SBS_Pos)) /* Assignment of value for SBS in the HSM_STATUS register */
...
#define HSM_STATUS_ECODE(value)               (HSM_STATUS_ECODE_Msk & (_UINT32_(value) << HSM_STATUS_ECODE_Pos)) /* Assignment of value for ECODE in the HSM_STATUS register */
...
#define HSM_MBFIFO_MBFIFO(value)              (HSM_MBFIFO_MBFIFO_Msk & (_UINT32_(value) << HSM_MBFIFO_MBFIFO_Pos)) /* Assignment of value for MBFIFO in the HSM_MBFIFO register */
...
#define HSM_MBTXSTATUS_TXREMAINING(value)     (HSM_MBTXSTATUS_TXREMAINING_Msk & (_UINT32_(value) << HSM_MBTXSTATUS_TXREMAINING_Pos)) /* Assignment of value for TXREMAINING in the HSM_MBTXSTATUS register */
...
#define HSM_MBTXSTATUS_TXTYPE(value)          (HSM_MBTXSTATUS_TXTYPE_Msk & (_UINT32_(value) << HSM_MBTXSTATUS_TXTYPE_Pos)) /* Assignment of value for TXTYPE in the HSM_MBTXSTATUS register */
...
#define HSM_MBTXSTATUS_TXINT(value)           (HSM_MBTXSTATUS_TXINT_Msk & (_UINT32_(value) << HSM_MBTXSTATUS_TXINT_Pos)) /* Assignment of value for TXINT in the HSM_MBTXSTATUS register */
...
#define HSM_MBTXSTATUS_TXFULL(value)          (HSM_MBTXSTATUS_TXFULL_Msk & (_UINT32_(value) << HSM_MBTXSTATUS_TXFULL_Pos)) /* Assignment of value for TXFULL in the HSM_MBTXSTATUS register */
...
#define HSM_MBTXSTATUS_TXERR(value)           (HSM_MBTXSTATUS_TXERR_Msk & (_UINT32_(value) << HSM_MBTXSTATUS_TXERR_Pos)) /* Assignment of value for TXERR in the HSM_MBTXSTATUS register */
...
#define HSM_MBRXSTATUS_RXREMAINING(value)     (HSM_MBRXSTATUS_RXREMAINING_Msk & (_UINT32_(value) << HSM_MBRXSTATUS_RXREMAINING_Pos)) /* Assignment of value for RXREMAINING in the HSM_MBRXSTATUS register */
...
#define HSM_MBRXSTATUS_RXTYPE(value)          (HSM_MBRXSTATUS_RXTYPE_Msk & (_UINT32_(value) << HSM_MBRXSTATUS_RXTYPE_Pos)) /* Assignment of value for RXTYPE in the HSM_MBRXSTATUS register */
...
#define HSM_MBRXSTATUS_RXINT(value)           (HSM_MBRXSTATUS_RXINT_Msk & (_UINT32_(value) << HSM_MBRXSTATUS_RXINT_Pos)) /* Assignment of value for RXINT in the HSM_MBRXSTATUS register */
...
#define HSM_MBRXSTATUS_RXEMPTY(value)         (HSM_MBRXSTATUS_RXEMPTY_Msk & (_UINT32_(value) << HSM_MBRXSTATUS_RXEMPTY_Pos)) /* Assignment of value for RXEMPTY in the HSM_MBRXSTATUS register */
...
#define HSM_MBRXSTATUS_RXHEAD(value)          (HSM_MBRXSTATUS_RXHEAD_Msk & (_UINT32_(value) << HSM_MBRXSTATUS_RXHEAD_Pos)) /* Assignment of value for RXHEAD in the HSM_MBRXSTATUS register */
...
#define HSM_MBRXSTATUS_RXERR(value)           (HSM_MBRXSTATUS_RXERR_Msk & (_UINT32_(value) << HSM_MBRXSTATUS_RXERR_Pos)) /* Assignment of value for RXERR in the HSM_MBRXSTATUS register */
...
#define HSM_MBTXPROT_UNPROT(value)            (HSM_MBTXPROT_UNPROT_Msk & (_UINT32_(value) << HSM_MBTXPROT_UNPROT_Pos)) /* Assignment of value for UNPROT in the HSM_MBTXPROT register */
...
#define HSM_MBTXPROT_PRIV(value)              (HSM_MBTXPROT_PRIV_Msk & (_UINT32_(value) << HSM_MBTXPROT_PRIV_Pos)) /* Assignment of value for PRIV in the HSM_MBTXPROT register */
...
#define HSM_MBTXPROT_NSEC(value)              (HSM_MBTXPROT_NSEC_Msk & (_UINT32_(value) << HSM_MBTXPROT_NSEC_Pos)) /* Assignment of value for NSEC in the HSM_MBTXPROT register */
...
#define HSM_MBTXPROT_USER(value)              (HSM_MBTXPROT_USER_Msk & (_UINT32_(value) << HSM_MBTXPROT_USER_Pos)) /* Assignment of value for USER in the HSM_MBTXPROT register */
...
#define HSM_MBRXPROT_UNPROT(value)            (HSM_MBRXPROT_UNPROT_Msk & (_UINT32_(value) << HSM_MBRXPROT_UNPROT_Pos)) /* Assignment of value for UNPROT in the HSM_MBRXPROT register */
...
#define HSM_MBRXPROT_PRIV(value)              (HSM_MBRXPROT_PRIV_Msk & (_UINT32_(value) << HSM_MBRXPROT_PRIV_Pos)) /* Assignment of value for PRIV in the HSM_MBRXPROT register */
...
#define HSM_MBRXPROT_NSEC(value)              (HSM_MBRXPROT_NSEC_Msk & (_UINT32_(value) << HSM_MBRXPROT_NSEC_Pos)) /* Assignment of value for NSEC in the HSM_MBRXPROT register */
...
#define HSM_MBRXPROT_USER(value)              (HSM_MBRXPROT_USER_Msk & (_UINT32_(value) << HSM_MBRXPROT_USER_Pos)) /* Assignment of value for USER in the HSM_MBRXPROT register */
...
#define HSM_MBTXHEAD_TXHEAD(value)            (HSM_MBTXHEAD_TXHEAD_Msk & (_UINT32_(value) << HSM_MBTXHEAD_TXHEAD_Pos)) /* Assignment of value for TXHEAD in the HSM_MBTXHEAD register */
...
#define HSM_MBRXHEAD_RXHEAD(value)            (HSM_MBRXHEAD_RXHEAD_Msk & (_UINT32_(value) << HSM_MBRXHEAD_RXHEAD_Pos)) /* Assignment of value for RXHEAD in the HSM_MBRXHEAD register */
...
#define HSM_MBCONFIG_TXINT(value)             (HSM_MBCONFIG_TXINT_Msk & (_UINT32_(value) << HSM_MBCONFIG_TXINT_Pos)) /* Assignment of value for TXINT in the HSM_MBCONFIG register */
...
#define HSM_MBCONFIG_RXINT(value)             (HSM_MBCONFIG_RXINT_Msk & (_UINT32_(value) << HSM_MBCONFIG_RXINT_Pos)) /* Assignment of value for RXINT in the HSM_MBCONFIG register */
...
#endif /* _PIC32CZCA91_HSM_COMPONENT_H_ */
