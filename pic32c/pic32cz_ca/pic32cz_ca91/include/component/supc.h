...
#ifndef _PIC32CZCA91_SUPC_COMPONENT_H_
#define _PIC32CZCA91_SUPC_COMPONENT_H_
...
#define SUPC_INTENCLR_ADDVREGRDY1(value)      (SUPC_INTENCLR_ADDVREGRDY1_Msk & (_UINT32_(value) << SUPC_INTENCLR_ADDVREGRDY1_Pos)) /* Assignment of value for ADDVREGRDY1 in the SUPC_INTENCLR register */
...
#define SUPC_INTENCLR_ADDVREGRDY2(value)      (SUPC_INTENCLR_ADDVREGRDY2_Msk & (_UINT32_(value) << SUPC_INTENCLR_ADDVREGRDY2_Pos)) /* Assignment of value for ADDVREGRDY2 in the SUPC_INTENCLR register */
...
#define SUPC_INTENSET_ADDVREGRDY1(value)      (SUPC_INTENSET_ADDVREGRDY1_Msk & (_UINT32_(value) << SUPC_INTENSET_ADDVREGRDY1_Pos)) /* Assignment of value for ADDVREGRDY1 in the SUPC_INTENSET register */
...
#define SUPC_INTENSET_ADDVREGRDY2(value)      (SUPC_INTENSET_ADDVREGRDY2_Msk & (_UINT32_(value) << SUPC_INTENSET_ADDVREGRDY2_Pos)) /* Assignment of value for ADDVREGRDY2 in the SUPC_INTENSET register */
...
#define SUPC_INTFLAG_ADDVREGRDY1(value)       (SUPC_INTFLAG_ADDVREGRDY1_Msk & (_UINT32_(value) << SUPC_INTFLAG_ADDVREGRDY1_Pos)) /* Assignment of value for ADDVREGRDY1 in the SUPC_INTFLAG register */
...
#define SUPC_INTFLAG_ADDVREGRDY2(value)       (SUPC_INTFLAG_ADDVREGRDY2_Msk & (_UINT32_(value) << SUPC_INTFLAG_ADDVREGRDY2_Pos)) /* Assignment of value for ADDVREGRDY2 in the SUPC_INTFLAG register */
...
#define SUPC_STATUS_ADDVREGRDY1(value)        (SUPC_STATUS_ADDVREGRDY1_Msk & (_UINT32_(value) << SUPC_STATUS_ADDVREGRDY1_Pos)) /* Assignment of value for ADDVREGRDY1 in the SUPC_STATUS register */
...
#define SUPC_STATUS_ADDVREGRDY2(value)        (SUPC_STATUS_ADDVREGRDY2_Msk & (_UINT32_(value) << SUPC_STATUS_ADDVREGRDY2_Pos)) /* Assignment of value for ADDVREGRDY2 in the SUPC_STATUS register */
...
#endif /* _PIC32CZCA91_SUPC_COMPONENT_H_ */
