/*
 * Header file for PIC32CZ4010CA91100
 *
...
#ifndef _PIC32CZ4010CA91100_H_
#define _PIC32CZ4010CA91100_H_
...
/* PIC32CZ4010CA91100 definitions
  This file defines all structures and symbols for PIC32CZ4010CA91100:
...
/* ************************************************************************** */
/*                  CMSIS DEFINITIONS FOR PIC32CZ4010CA91100                  */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
/* ************* PIC32CZ4010CA91100 specific Interrupt Numbers ************** */
  ...
  ADC_GLOBAL_IRQn           = 185, /* 185 ADC_GLOBAL (ADC)                    */
  ADC_CORE1_IRQn            = 186, /* 186 ADC_CORE1 (ADC)                     */
  ADC_CORE2_IRQn            = 187, /* 187 ADC_CORE2 (ADC)                     */
  ADC_CORE3_IRQn            = 188, /* 188 ADC_CORE3 (ADC)                     */
  ADC_CORE4_IRQn            = 189, /* 189 ADC_CORE4 (ADC)                     */
...
#include "system_pic32czca91.h"
#endif /* USE_CMSIS_INIT */

/* ************************************************************************** */
/*         SOFTWARE PERIPHERAL API DEFINITIONS FOR PIC32CZ4010CA91100         */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                INSTANCE DEFINITIONS FOR PIC32CZ4010CA91100                 */
/* ************************************************************************** */
#include "instance/ac.h"
#include "instance/adc0.h"
#include "instance/adc1.h"
#include "instance/adc2.h"
#include "instance/adc3.h"
...
/* ************************************************************************** */
/*              PERIPHERAL ID DEFINITIONS FOR PIC32CZ4010CA91100              */
/* ************************************************************************** */
...
#define ID_ADC3          ( 43) /* Instance index for ADC (ADC3) */
...
/* ************************************************************************** */
/*       REGISTER STRUCTURE ADDRESS DEFINITIONS FOR PIC32CZ4010CA91100        */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
#define AC_REGS                          ((ac_registers_t*)0x46822000)                 /* AC Registers Address         */
#define ADC0_REGS                        ((adc_registers_t*)0x46820000)                /* ADC0 Registers Address       */
#define ADC1_REGS                        ((adc_registers_t*)0x46820000)                /* ADC1 Registers Address       */
#define ADC2_REGS                        ((adc_registers_t*)0x46820000)                /* ADC2 Registers Address       */
#define ADC3_REGS                        ((adc_registers_t*)0x46820000)                /* ADC3 Registers Address       */
...
/* ************************************************************************** */
/*              BASE ADDRESS DEFINITIONS FOR PIC32CZ4010CA91100               */
/* ************************************************************************** */
#define AC_BASE_ADDRESS                  _UINT32_(0x46822000)                          /* AC Base Address */
#define ADC0_BASE_ADDRESS                _UINT32_(0x46820000)                          /* ADC0 Base Address */
#define ADC1_BASE_ADDRESS                _UINT32_(0x46820000)                          /* ADC1 Base Address */
#define ADC2_BASE_ADDRESS                _UINT32_(0x46820000)                          /* ADC2 Base Address */
#define ADC3_BASE_ADDRESS                _UINT32_(0x46820000)                          /* ADC3 Base Address */
...
/* ************************************************************************** */
/*                   PIO DEFINITIONS FOR PIC32CZ4010CA91100                   */
/* ************************************************************************** */
#include "pio/pic32cz4010ca91100.h"

/* ************************************************************************** */
/*             MEMORY MAPPING DEFINITIONS FOR PIC32CZ4010CA91100              */
/* ************************************************************************** */
...
#define FCR_PFM_SIZE                   _UINT32_(0x00400000)    /* 4096kB Memory segment type: flash */
#define FCR_PFM_PAGE_SIZE              _UINT32_(      4096)
#define FCR_PFM_NB_OF_PAGES            _UINT32_(      1024)
...
/* ************************************************************************** */
/*                  DEVICE SIGNATURES FOR PIC32CZ4010CA91100                  */
/* ************************************************************************** */
#define CHIP_DSU_DID                   _UINT32_(0X1921B053)

/* ************************************************************************** */
/*               ELECTRICAL DEFINITIONS FOR PIC32CZ4010CA91100                */
/* ************************************************************************** */

/* ************************************************************************** */
/*                  Event Generator IDs for C32CZ4010CA91100                  */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                    Event User IDs for C32CZ4010CA91100                     */
/* ************************************************************************** */
