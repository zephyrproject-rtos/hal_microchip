...
#ifndef _SAMA7D_LCDC_COMPONENT_H_
#define _SAMA7D_LCDC_COMPONENT_H_
...
#define LCDC_LCDCFG5_Msk                      _UINT32_(0x00FF38FF)                                 /* (LCDC_LCDCFG5) Register Mask  */

/* LEGACY mode */
#define LCDC_LCDCFG5_LEGACY_MODE_Pos          _UINT32_(8)                                          /* (LCDC_LCDCFG5) LCDC Output Mode Position */
#define LCDC_LCDCFG5_LEGACY_MODE_Msk          (_UINT32_(0x7) << LCDC_LCDCFG5_LEGACY_MODE_Pos)      /* (LCDC_LCDCFG5) LCDC Output Mode Mask */
#define LCDC_LCDCFG5_LEGACY_MODE(value)       (LCDC_LCDCFG5_LEGACY_MODE_Msk & (_UINT32_(value) << LCDC_LCDCFG5_LEGACY_MODE_Pos))
#define   LCDC_LCDCFG5_LEGACY_MODE_OUTPUT_12BPP_Val _UINT32_(0x0)                                        /* (LCDC_LCDCFG5) LCD Output mode is set to 12 bits per pixel  */
#define   LCDC_LCDCFG5_LEGACY_MODE_OUTPUT_16BPP_Val _UINT32_(0x1)                                        /* (LCDC_LCDCFG5) LCD Output mode is set to 16 bits per pixel  */
#define   LCDC_LCDCFG5_LEGACY_MODE_OUTPUT_18BPP_Val _UINT32_(0x2)                                        /* (LCDC_LCDCFG5) LCD Output mode is set to 18 bits per pixel  */
#define   LCDC_LCDCFG5_LEGACY_MODE_OUTPUT_24BPP_Val _UINT32_(0x3)                                        /* (LCDC_LCDCFG5) LCD Output mode is set to 24 bits per pixel  */
#define LCDC_LCDCFG5_LEGACY_MODE_OUTPUT_12BPP (LCDC_LCDCFG5_LEGACY_MODE_OUTPUT_12BPP_Val << LCDC_LCDCFG5_LEGACY_MODE_Pos) /* (LCDC_LCDCFG5) LCD Output mode is set to 12 bits per pixel Position */
#define LCDC_LCDCFG5_LEGACY_MODE_OUTPUT_16BPP (LCDC_LCDCFG5_LEGACY_MODE_OUTPUT_16BPP_Val << LCDC_LCDCFG5_LEGACY_MODE_Pos) /* (LCDC_LCDCFG5) LCD Output mode is set to 16 bits per pixel Position */
#define LCDC_LCDCFG5_LEGACY_MODE_OUTPUT_18BPP (LCDC_LCDCFG5_LEGACY_MODE_OUTPUT_18BPP_Val << LCDC_LCDCFG5_LEGACY_MODE_Pos) /* (LCDC_LCDCFG5) LCD Output mode is set to 18 bits per pixel Position */
#define LCDC_LCDCFG5_LEGACY_MODE_OUTPUT_24BPP (LCDC_LCDCFG5_LEGACY_MODE_OUTPUT_24BPP_Val << LCDC_LCDCFG5_LEGACY_MODE_Pos) /* (LCDC_LCDCFG5) LCD Output mode is set to 24 bits per pixel Position */
#define LCDC_LCDCFG5_LEGACY_Msk               _UINT32_(0x00000700)                                 /* (LCDC_LCDCFG5_LEGACY) Register Mask  */

/* DPI mode */
#define LCDC_LCDCFG5_DPI_MODE_Pos             _UINT32_(8)                                          /* (LCDC_LCDCFG5) LCDC Output Mode Position */
#define LCDC_LCDCFG5_DPI_MODE_Msk             (_UINT32_(0x7) << LCDC_LCDCFG5_DPI_MODE_Pos)         /* (LCDC_LCDCFG5) LCDC Output Mode Mask */
#define LCDC_LCDCFG5_DPI_MODE(value)          (LCDC_LCDCFG5_DPI_MODE_Msk & (_UINT32_(value) << LCDC_LCDCFG5_DPI_MODE_Pos))
#define   LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_16BPPCFG1_Val _UINT32_(0x0)                                        /* (LCDC_LCDCFG5) LCD Output mode is set to 16 bits per pixel Configuration 1  */
#define   LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_16BPPCFG2_Val _UINT32_(0x1)                                        /* (LCDC_LCDCFG5) LCD Output mode is set to 16 bits per pixel Configuration 2  */
#define   LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_16BPPCFG3_Val _UINT32_(0x2)                                        /* (LCDC_LCDCFG5) LCD Output mode is set to 16 bits per pixel Configuration 3  */
#define   LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_18BPPCFG1_Val _UINT32_(0x3)                                        /* (LCDC_LCDCFG5) LCD Output mode is set to 18 bits per pixel Configuration 1  */
#define   LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_18BPPCFG2_Val _UINT32_(0x4)                                        /* (LCDC_LCDCFG5) LCD Output mode is set to 18 bits per pixel Configuration 2  */
#define   LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_24BPP_Val _UINT32_(0x5)                                        /* (LCDC_LCDCFG5) LCD Output mode is set to 24 bits per pixel  */
#define LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_16BPPCFG1 (LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_16BPPCFG1_Val << LCDC_LCDCFG5_DPI_MODE_Pos) /* (LCDC_LCDCFG5) LCD Output mode is set to 16 bits per pixel Configuration 1 Position */
#define LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_16BPPCFG2 (LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_16BPPCFG2_Val << LCDC_LCDCFG5_DPI_MODE_Pos) /* (LCDC_LCDCFG5) LCD Output mode is set to 16 bits per pixel Configuration 2 Position */
#define LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_16BPPCFG3 (LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_16BPPCFG3_Val << LCDC_LCDCFG5_DPI_MODE_Pos) /* (LCDC_LCDCFG5) LCD Output mode is set to 16 bits per pixel Configuration 3 Position */
#define LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_18BPPCFG1 (LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_18BPPCFG1_Val << LCDC_LCDCFG5_DPI_MODE_Pos) /* (LCDC_LCDCFG5) LCD Output mode is set to 18 bits per pixel Configuration 1 Position */
#define LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_18BPPCFG2 (LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_18BPPCFG2_Val << LCDC_LCDCFG5_DPI_MODE_Pos) /* (LCDC_LCDCFG5) LCD Output mode is set to 18 bits per pixel Configuration 2 Position */
#define LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_24BPP (LCDC_LCDCFG5_DPI_MODE_OUTPUT_DPI_24BPP_Val << LCDC_LCDCFG5_DPI_MODE_Pos) /* (LCDC_LCDCFG5) LCD Output mode is set to 24 bits per pixel Position */
...
#endif /* _SAMA7D_LCDC_COMPONENT_H_ */
