...
#ifndef _SAMA7D_GPU2DC_COMPONENT_H_
#define _SAMA7D_GPU2DC_COMPONENT_H_
...
#define GPU2DC_AQHiClockControl_CLK2D_DIS(value) (GPU2DC_AQHiClockControl_CLK2D_DIS_Msk & (_UINT32_(value) << GPU2DC_AQHiClockControl_CLK2D_DIS_Pos)) /* Assignment of value for CLK2D_DIS in the GPU2DC_AQHiClockControl register */
...
#define GPU2DC_AQHiClockControl_FSCALE_VAL(value) (GPU2DC_AQHiClockControl_FSCALE_VAL_Msk & (_UINT32_(value) << GPU2DC_AQHiClockControl_FSCALE_VAL_Pos)) /* Assignment of value for FSCALE_VAL in the GPU2DC_AQHiClockControl register */
...
#define GPU2DC_AQHiClockControl_FSCALE_CMD_LOAD(value) (GPU2DC_AQHiClockControl_FSCALE_CMD_LOAD_Msk & (_UINT32_(value) << GPU2DC_AQHiClockControl_FSCALE_CMD_LOAD_Pos)) /* Assignment of value for FSCALE_CMD_LOAD in the GPU2DC_AQHiClockControl register */
...
#define GPU2DC_AQHiClockControl_DISABLE_RAM_CLOCK_GATING(value) (GPU2DC_AQHiClockControl_DISABLE_RAM_CLOCK_GATING_Msk & (_UINT32_(value) << GPU2DC_AQHiClockControl_DISABLE_RAM_CLOCK_GATING_Pos)) /* Assignment of value for DISABLE_RAM_CLOCK_GATING in the GPU2DC_AQHiClockControl register */
...
#define GPU2DC_AQHiClockControl_SOFT_RESET(value) (GPU2DC_AQHiClockControl_SOFT_RESET_Msk & (_UINT32_(value) << GPU2DC_AQHiClockControl_SOFT_RESET_Pos)) /* Assignment of value for SOFT_RESET in the GPU2DC_AQHiClockControl register */
...
#define GPU2DC_AQHiClockControl_IDLE3_D(value) (GPU2DC_AQHiClockControl_IDLE3_D_Msk & (_UINT32_(value) << GPU2DC_AQHiClockControl_IDLE3_D_Pos)) /* Assignment of value for IDLE3_D in the GPU2DC_AQHiClockControl register */
...
#define GPU2DC_AQHiClockControl_IDLE2_D(value) (GPU2DC_AQHiClockControl_IDLE2_D_Msk & (_UINT32_(value) << GPU2DC_AQHiClockControl_IDLE2_D_Pos)) /* Assignment of value for IDLE2_D in the GPU2DC_AQHiClockControl register */
...
#define GPU2DC_AQHiClockControl_IDLE_VG(value) (GPU2DC_AQHiClockControl_IDLE_VG_Msk & (_UINT32_(value) << GPU2DC_AQHiClockControl_IDLE_VG_Pos)) /* Assignment of value for IDLE_VG in the GPU2DC_AQHiClockControl register */
...
#define GPU2DC_AQHiClockControl_ISOLATE_GPU(value) (GPU2DC_AQHiClockControl_ISOLATE_GPU_Msk & (_UINT32_(value) << GPU2DC_AQHiClockControl_ISOLATE_GPU_Pos)) /* Assignment of value for ISOLATE_GPU in the GPU2DC_AQHiClockControl register */
...
#define GPU2DC_AQHiIdle_IDLE_FE(value)        (GPU2DC_AQHiIdle_IDLE_FE_Msk & (_UINT32_(value) << GPU2DC_AQHiIdle_IDLE_FE_Pos)) /* Assignment of value for IDLE_FE in the GPU2DC_AQHiIdle register */
...
#define GPU2DC_AQHiIdle_IDLE_DE(value)        (GPU2DC_AQHiIdle_IDLE_DE_Msk & (_UINT32_(value) << GPU2DC_AQHiIdle_IDLE_DE_Pos)) /* Assignment of value for IDLE_DE in the GPU2DC_AQHiIdle register */
...
#define GPU2DC_AQHiIdle_IDLE_PE(value)        (GPU2DC_AQHiIdle_IDLE_PE_Msk & (_UINT32_(value) << GPU2DC_AQHiIdle_IDLE_PE_Pos)) /* Assignment of value for IDLE_PE in the GPU2DC_AQHiIdle register */
...
#define GPU2DC_AQHiIdle_IDLE_SH(value)        (GPU2DC_AQHiIdle_IDLE_SH_Msk & (_UINT32_(value) << GPU2DC_AQHiIdle_IDLE_SH_Pos)) /* Assignment of value for IDLE_SH in the GPU2DC_AQHiIdle register */
...
#define GPU2DC_AQHiIdle_IDLE_PA(value)        (GPU2DC_AQHiIdle_IDLE_PA_Msk & (_UINT32_(value) << GPU2DC_AQHiIdle_IDLE_PA_Pos)) /* Assignment of value for IDLE_PA in the GPU2DC_AQHiIdle register */
...
#define GPU2DC_AQHiIdle_IDLE_SE(value)        (GPU2DC_AQHiIdle_IDLE_SE_Msk & (_UINT32_(value) << GPU2DC_AQHiIdle_IDLE_SE_Pos)) /* Assignment of value for IDLE_SE in the GPU2DC_AQHiIdle register */
...
#define GPU2DC_AQHiIdle_IDLE_RA(value)        (GPU2DC_AQHiIdle_IDLE_RA_Msk & (_UINT32_(value) << GPU2DC_AQHiIdle_IDLE_RA_Pos)) /* Assignment of value for IDLE_RA in the GPU2DC_AQHiIdle register */
...
#define GPU2DC_AQHiIdle_IDLE_TX(value)        (GPU2DC_AQHiIdle_IDLE_TX_Msk & (_UINT32_(value) << GPU2DC_AQHiIdle_IDLE_TX_Pos)) /* Assignment of value for IDLE_TX in the GPU2DC_AQHiIdle register */
...
#define GPU2DC_AQHiIdle_IDLE_VG(value)        (GPU2DC_AQHiIdle_IDLE_VG_Msk & (_UINT32_(value) << GPU2DC_AQHiIdle_IDLE_VG_Pos)) /* Assignment of value for IDLE_VG in the GPU2DC_AQHiIdle register */
...
#define GPU2DC_AQHiIdle_IDLE_IM(value)        (GPU2DC_AQHiIdle_IDLE_IM_Msk & (_UINT32_(value) << GPU2DC_AQHiIdle_IDLE_IM_Pos)) /* Assignment of value for IDLE_IM in the GPU2DC_AQHiIdle register */
...
#define GPU2DC_AQHiIdle_IDLE_FP(value)        (GPU2DC_AQHiIdle_IDLE_FP_Msk & (_UINT32_(value) << GPU2DC_AQHiIdle_IDLE_FP_Pos)) /* Assignment of value for IDLE_FP in the GPU2DC_AQHiIdle register */
...
#define GPU2DC_AQHiIdle_IDLE_TS(value)        (GPU2DC_AQHiIdle_IDLE_TS_Msk & (_UINT32_(value) << GPU2DC_AQHiIdle_IDLE_TS_Pos)) /* Assignment of value for IDLE_TS in the GPU2DC_AQHiIdle register */
...
#define GPU2DC_AQAxiConfig_AWCACHE(value)     (GPU2DC_AQAxiConfig_AWCACHE_Msk & (_UINT32_(value) << GPU2DC_AQAxiConfig_AWCACHE_Pos)) /* Assignment of value for AWCACHE in the GPU2DC_AQAxiConfig register */
...
#define GPU2DC_AQAxiStatus_WR_ERR_ID(value)   (GPU2DC_AQAxiStatus_WR_ERR_ID_Msk & (_UINT32_(value) << GPU2DC_AQAxiStatus_WR_ERR_ID_Pos)) /* Assignment of value for WR_ERR_ID in the GPU2DC_AQAxiStatus register */
...
#define GPU2DC_AQAxiStatus_RD_ERR_ID(value)   (GPU2DC_AQAxiStatus_RD_ERR_ID_Msk & (_UINT32_(value) << GPU2DC_AQAxiStatus_RD_ERR_ID_Pos)) /* Assignment of value for RD_ERR_ID in the GPU2DC_AQAxiStatus register */
...
#define GPU2DC_AQAxiStatus_DET_WR_ERR(value)  (GPU2DC_AQAxiStatus_DET_WR_ERR_Msk & (_UINT32_(value) << GPU2DC_AQAxiStatus_DET_WR_ERR_Pos)) /* Assignment of value for DET_WR_ERR in the GPU2DC_AQAxiStatus register */
...
#define GPU2DC_AQAxiStatus_DET_RD_ERR(value)  (GPU2DC_AQAxiStatus_DET_RD_ERR_Msk & (_UINT32_(value) << GPU2DC_AQAxiStatus_DET_RD_ERR_Pos)) /* Assignment of value for DET_RD_ERR in the GPU2DC_AQAxiStatus register */
...
#define GPU2DC_AQIntrAcknowledge_INTR_VEC(value) (GPU2DC_AQIntrAcknowledge_INTR_VEC_Msk & (_UINT32_(value) << GPU2DC_AQIntrAcknowledge_INTR_VEC_Pos)) /* Assignment of value for INTR_VEC in the GPU2DC_AQIntrAcknowledge register */
...
#define GPU2DC_AQIntrAcknowledge_MMU_EXCEPTION(value) (GPU2DC_AQIntrAcknowledge_MMU_EXCEPTION_Msk & (_UINT32_(value) << GPU2DC_AQIntrAcknowledge_MMU_EXCEPTION_Pos)) /* Assignment of value for MMU_EXCEPTION in the GPU2DC_AQIntrAcknowledge register */
...
#define GPU2DC_AQIntrAcknowledge_AXI_EXCEPTION(value) (GPU2DC_AQIntrAcknowledge_AXI_EXCEPTION_Msk & (_UINT32_(value) << GPU2DC_AQIntrAcknowledge_AXI_EXCEPTION_Pos)) /* Assignment of value for AXI_EXCEPTION in the GPU2DC_AQIntrAcknowledge register */
...
#define GPU2DC_AQIntrEnbl_INTR_ENBL_VEC(value) (GPU2DC_AQIntrEnbl_INTR_ENBL_VEC_Msk & (_UINT32_(value) << GPU2DC_AQIntrEnbl_INTR_ENBL_VEC_Pos)) /* Assignment of value for INTR_ENBL_VEC in the GPU2DC_AQIntrEnbl register */
...
#define GPU2DC_AQIntrEnbl_MMU_EXCEPTION_INTR_ENBL(value) (GPU2DC_AQIntrEnbl_MMU_EXCEPTION_INTR_ENBL_Msk & (_UINT32_(value) << GPU2DC_AQIntrEnbl_MMU_EXCEPTION_INTR_ENBL_Pos)) /* Assignment of value for MMU_EXCEPTION_INTR_ENBL in the GPU2DC_AQIntrEnbl register */
...
#define GPU2DC_AQIntrEnbl_AXI_EXCEPTION_INTR_ENBL(value) (GPU2DC_AQIntrEnbl_AXI_EXCEPTION_INTR_ENBL_Msk & (_UINT32_(value) << GPU2DC_AQIntrEnbl_AXI_EXCEPTION_INTR_ENBL_Pos)) /* Assignment of value for AXI_EXCEPTION_INTR_ENBL in the GPU2DC_AQIntrEnbl register */
...
#define GPU2DC_gcProductId_GRADE_LEVEL(value) (GPU2DC_gcProductId_GRADE_LEVEL_Msk & (_UINT32_(value) << GPU2DC_gcProductId_GRADE_LEVEL_Pos)) /* Assignment of value for GRADE_LEVEL in the GPU2DC_gcProductId register */
...
#define GPU2DC_gcProductId_NUM(value)         (GPU2DC_gcProductId_NUM_Msk & (_UINT32_(value) << GPU2DC_gcProductId_NUM_Pos)) /* Assignment of value for NUM in the GPU2DC_gcProductId register */
...
#define GPU2DC_gcProductId_TYPE(value)        (GPU2DC_gcProductId_TYPE_Msk & (_UINT32_(value) << GPU2DC_gcProductId_TYPE_Pos)) /* Assignment of value for TYPE in the GPU2DC_gcProductId register */
...
#define GPU2DC_gcModulePowerControls_ENABLE_MODULE_CLOCK_GATING(value) (GPU2DC_gcModulePowerControls_ENABLE_MODULE_CLOCK_GATING_Msk & (_UINT32_(value) << GPU2DC_gcModulePowerControls_ENABLE_MODULE_CLOCK_GATING_Pos)) /* Assignment of value for ENABLE_MODULE_CLOCK_GATING in the GPU2DC_gcModulePowerControls register */
...
#define GPU2DC_gcModulePowerControls_DISABLE_STALL_MODULE_CLOCK_GATING(value) (GPU2DC_gcModulePowerControls_DISABLE_STALL_MODULE_CLOCK_GATING_Msk & (_UINT32_(value) << GPU2DC_gcModulePowerControls_DISABLE_STALL_MODULE_CLOCK_GATING_Pos)) /* Assignment of value for DISABLE_STALL_MODULE_CLOCK_GATING in the GPU2DC_gcModulePowerControls register */
...
#define GPU2DC_gcModulePowerControls_DISABLE_STARVE_MODULE_CLOCK_GATING(value) (GPU2DC_gcModulePowerControls_DISABLE_STARVE_MODULE_CLOCK_GATING_Msk & (_UINT32_(value) << GPU2DC_gcModulePowerControls_DISABLE_STARVE_MODULE_CLOCK_GATING_Pos)) /* Assignment of value for DISABLE_STARVE_MODULE_CLOCK_GATING in the GPU2DC_gcModulePowerControls register */
...
#define GPU2DC_gcModulePowerControls_TURN_OFF_COUNTER(value) (GPU2DC_gcModulePowerControls_TURN_OFF_COUNTER_Msk & (_UINT32_(value) << GPU2DC_gcModulePowerControls_TURN_OFF_COUNTER_Pos)) /* Assignment of value for TURN_OFF_COUNTER in the GPU2DC_gcModulePowerControls register */
...
#define GPU2DC_gcregMMUControl_ENABLE(value)  (GPU2DC_gcregMMUControl_ENABLE_Msk & (_UINT32_(value) << GPU2DC_gcregMMUControl_ENABLE_Pos)) /* Assignment of value for ENABLE in the GPU2DC_gcregMMUControl register */
...
#define GPU2DC_AQMemoryDebug_MAX_OUTSTANDING_READS(value) (GPU2DC_AQMemoryDebug_MAX_OUTSTANDING_READS_Msk & (_UINT32_(value) << GPU2DC_AQMemoryDebug_MAX_OUTSTANDING_READS_Pos)) /* Assignment of value for MAX_OUTSTANDING_READS in the GPU2DC_AQMemoryDebug register */
...
#define GPU2DC_AQCmdBufferAddr_ADDRESS(value) (GPU2DC_AQCmdBufferAddr_ADDRESS_Msk & (_UINT32_(value) << GPU2DC_AQCmdBufferAddr_ADDRESS_Pos)) /* Assignment of value for ADDRESS in the GPU2DC_AQCmdBufferAddr register */
...
#define GPU2DC_AQCmdBufferAddr_TYPE(value)    (GPU2DC_AQCmdBufferAddr_TYPE_Msk & (_UINT32_(value) << GPU2DC_AQCmdBufferAddr_TYPE_Pos)) /* Assignment of value for TYPE in the GPU2DC_AQCmdBufferAddr register */
...
#define GPU2DC_AQCmdBufferCtrl_PREFETCH(value) (GPU2DC_AQCmdBufferCtrl_PREFETCH_Msk & (_UINT32_(value) << GPU2DC_AQCmdBufferCtrl_PREFETCH_Pos)) /* Assignment of value for PREFETCH in the GPU2DC_AQCmdBufferCtrl register */
...
#define GPU2DC_AQCmdBufferCtrl_ENABLE(value)  (GPU2DC_AQCmdBufferCtrl_ENABLE_Msk & (_UINT32_(value) << GPU2DC_AQCmdBufferCtrl_ENABLE_Pos)) /* Assignment of value for ENABLE in the GPU2DC_AQCmdBufferCtrl register */
...
#define GPU2DC_AQFEDebugCurCmdAdr_CUR_CMD_ADR(value) (GPU2DC_AQFEDebugCurCmdAdr_CUR_CMD_ADR_Msk & (_UINT32_(value) << GPU2DC_AQFEDebugCurCmdAdr_CUR_CMD_ADR_Pos)) /* Assignment of value for CUR_CMD_ADR in the GPU2DC_AQFEDebugCurCmdAdr register */
#define GPU2DC_AQFEDebugCurCmdAdr_Msk         _UINT32_(0xFFFFFFF8)                                 /* (GPU2DC_AQFEDebugCurCmdAdr) Register Mask  */


/* GPU2DC register offsets definitions */
...
#endif /* _SAMA7D_GPU2DC_COMPONENT_H_ */
