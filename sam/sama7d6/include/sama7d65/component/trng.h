...
#ifndef _SAMA7D_TRNG_COMPONENT_H_
#define _SAMA7D_TRNG_COMPONENT_H_
...
#define TRNG_IER_RCHT(value)                  (TRNG_IER_RCHT_Msk & (_UINT32_(value) << TRNG_IER_RCHT_Pos)) /* Assignment of value for RCHT in the TRNG_IER register */
...
#define TRNG_IER_APHT(value)                  (TRNG_IER_APHT_Msk & (_UINT32_(value) << TRNG_IER_APHT_Pos)) /* Assignment of value for APHT in the TRNG_IER register */
...
#define TRNG_IDR_RCHT(value)                  (TRNG_IDR_RCHT_Msk & (_UINT32_(value) << TRNG_IDR_RCHT_Pos)) /* Assignment of value for RCHT in the TRNG_IDR register */
...
#define TRNG_IDR_APHT(value)                  (TRNG_IDR_APHT_Msk & (_UINT32_(value) << TRNG_IDR_APHT_Pos)) /* Assignment of value for APHT in the TRNG_IDR register */
...
#define TRNG_IMR_RCHT(value)                  (TRNG_IMR_RCHT_Msk & (_UINT32_(value) << TRNG_IMR_RCHT_Pos)) /* Assignment of value for RCHT in the TRNG_IMR register */
...
#define TRNG_IMR_APHT(value)                  (TRNG_IMR_APHT_Msk & (_UINT32_(value) << TRNG_IMR_APHT_Pos)) /* Assignment of value for APHT in the TRNG_IMR register */
...
#define TRNG_ISR_RCHT(value)                  (TRNG_ISR_RCHT_Msk & (_UINT32_(value) << TRNG_ISR_RCHT_Pos)) /* Assignment of value for RCHT in the TRNG_ISR register */
...
#define TRNG_ISR_APHT(value)                  (TRNG_ISR_APHT_Msk & (_UINT32_(value) << TRNG_ISR_APHT_Pos)) /* Assignment of value for APHT in the TRNG_ISR register */
...
#define TRNG_HTMR_THRESHOLD(value)            (TRNG_HTMR_THRESHOLD_Msk & (_UINT32_(value) << TRNG_HTMR_THRESHOLD_Pos)) /* Assignment of value for THRESHOLD in the TRNG_HTMR register */
...
#define TRNG_FIR_F0(value)                    (TRNG_FIR_F0_Msk & (_UINT32_(value) << TRNG_FIR_F0_Pos)) /* Assignment of value for F0 in the TRNG_FIR register */
#define   TRNG_FIR_F0_0_Val                   _UINT32_(0x0)                                        /* (TRNG_FIR) Clears the fault. The flag TRNG_WPSR.SDEE is automatically cleared.  */
#define   TRNG_FIR_F0_1_Val                   _UINT32_(0x1)                                        /* (TRNG_FIR) Injects a single fault on the reinforced safety for the TRNG_CR.ENABLE bit if 0x544649 ("TFI" in ASCII) is written in the FIKEY field at the same time. The TRNG remains in the same state, the flag TRNG_ISR.SECE=1 and the flag TRNG_WPSR.SDEE=1.  */
...
#define TRNG_FIR_F0_1                         (TRNG_FIR_F0_1_Val << TRNG_FIR_F0_Pos)               /* (TRNG_FIR) Injects a single fault on the reinforced safety for the TRNG_CR.ENABLE bit if 0x544649 ("TFI" in ASCII) is written in the FIKEY field at the same time. The TRNG remains in the same state, the flag TRNG_ISR.SECE=1 and the flag TRNG_WPSR.SDEE=1. Position */
...
#define TRNG_FIR_F1(value)                    (TRNG_FIR_F1_Msk & (_UINT32_(value) << TRNG_FIR_F1_Pos)) /* Assignment of value for F1 in the TRNG_FIR register */
...
#define   TRNG_FIR_F1_1_Val                   _UINT32_(0x1)                                        /* (TRNG_FIR) Injects a single fault on the reinforced safety for the TRNG_WPMR.WPEN bit if 0x544649 ("TFI" in ASCII) is written in the FIKEY field at the same time. The TRNG protection remains active for Mode registers, the flag TRNG_ISR.SECE=1 and the flag TRNG_WPSR.SDEE=1.  */
...
#define TRNG_FIR_F1_1                         (TRNG_FIR_F1_1_Val << TRNG_FIR_F1_Pos)               /* (TRNG_FIR) Injects a single fault on the reinforced safety for the TRNG_WPMR.WPEN bit if 0x544649 ("TFI" in ASCII) is written in the FIKEY field at the same time. The TRNG protection remains active for Mode registers, the flag TRNG_ISR.SECE=1 and the flag TRNG_WPSR.SDEE=1. Position */
...
#define TRNG_FIR_F2(value)                    (TRNG_FIR_F2_Msk & (_UINT32_(value) << TRNG_FIR_F2_Pos)) /* Assignment of value for F2 in the TRNG_FIR register */
...
#define   TRNG_FIR_F2_1_Val                   _UINT32_(0x1)                                        /* (TRNG_FIR) Injects a single fault on the reinforced safety for the TRNG_WPMR.WPITEN bit if 0x544649 ("TFI" in ASCII) is written in the FIKEY field at the same time. The TRNG protection remains active for interrupt registers, the flag TRNG_ISR.SECE=1 and the flag TRNG_WPSR.SDEE=1.  */
...
#define TRNG_FIR_F2_1                         (TRNG_FIR_F2_1_Val << TRNG_FIR_F2_Pos)               /* (TRNG_FIR) Injects a single fault on the reinforced safety for the TRNG_WPMR.WPITEN bit if 0x544649 ("TFI" in ASCII) is written in the FIKEY field at the same time. The TRNG protection remains active for interrupt registers, the flag TRNG_ISR.SECE=1 and the flag TRNG_WPSR.SDEE=1. Position */
...
#define TRNG_FIR_F3(value)                    (TRNG_FIR_F3_Msk & (_UINT32_(value) << TRNG_FIR_F3_Pos)) /* Assignment of value for F3 in the TRNG_FIR register */
...
#define   TRNG_FIR_F3_1_Val                   _UINT32_(0x1)                                        /* (TRNG_FIR) Injects a single fault on the reinforced safety for the TRNG_WPMR.WPEN bit if 0x544649 ("TFI" in ASCII) is written in the FIKEY field at the same time. The TRNG Control register remains protected, the flag TRNG_ISR.SECE=1 and the flag TRNG_WPSR.SDEE=1.  */
...
#define TRNG_FIR_F3_1                         (TRNG_FIR_F3_1_Val << TRNG_FIR_F3_Pos)               /* (TRNG_FIR) Injects a single fault on the reinforced safety for the TRNG_WPMR.WPEN bit if 0x544649 ("TFI" in ASCII) is written in the FIKEY field at the same time. The TRNG Control register remains protected, the flag TRNG_ISR.SECE=1 and the flag TRNG_WPSR.SDEE=1. Position */
...
#define TRNG_FIR_F4(value)                    (TRNG_FIR_F4_Msk & (_UINT32_(value) << TRNG_FIR_F4_Pos)) /* Assignment of value for F4 in the TRNG_FIR register */
#define   TRNG_FIR_F4_0_Val                   _UINT32_(0x0)                                        /* (TRNG_FIR) Clears the fault. The flag TRNG_WPSR.SDEE is automatically cleared.  */
#define   TRNG_FIR_F4_1_Val                   _UINT32_(0x1)                                        /* (TRNG_FIR) Injects a single fault on the reinforced safety for the TRNG_IMR.WPCREN bit if 0x544649 ("TFI" in ASCII) is written in the FIKEY field at the same time. The TRNG remains in the same state, the flag TRNG_ISR.SECE=1 and the flag TRNG_WPSR.SDEE=1.  */
...
#define TRNG_FIR_F4_1                         (TRNG_FIR_F4_1_Val << TRNG_FIR_F4_Pos)               /* (TRNG_FIR) Injects a single fault on the reinforced safety for the TRNG_IMR.WPCREN bit if 0x544649 ("TFI" in ASCII) is written in the FIKEY field at the same time. The TRNG remains in the same state, the flag TRNG_ISR.SECE=1 and the flag TRNG_WPSR.SDEE=1. Position */
...
#define TRNG_FIR_FSEQE(value)                 (TRNG_FIR_FSEQE_Msk & (_UINT32_(value) << TRNG_FIR_FSEQE_Pos)) /* Assignment of value for FSEQE in the TRNG_FIR register */
...
#define TRNG_FIR_NSFHT(value)                 (TRNG_FIR_NSFHT_Msk & (_UINT32_(value) << TRNG_FIR_NSFHT_Pos)) /* Assignment of value for NSFHT in the TRNG_FIR register */
...
#define TRNG_FIR_FIRDIS(value)                (TRNG_FIR_FIRDIS_Msk & (_UINT32_(value) << TRNG_FIR_FIRDIS_Pos)) /* Assignment of value for FIRDIS in the TRNG_FIR register */
...
#define TRNG_FIR_FIKEY(value)                 (TRNG_FIR_FIKEY_Msk & (_UINT32_(value) << TRNG_FIR_FIKEY_Pos)) /* Assignment of value for FIKEY in the TRNG_FIR register */
...
#define TRNG_WPMR_LCKWPEN(value)              (TRNG_WPMR_LCKWPEN_Msk & (_UINT32_(value) << TRNG_WPMR_LCKWPEN_Pos)) /* Assignment of value for LCKWPEN in the TRNG_WPMR register */
...
#define TRNG_WPMR_LCKITEN(value)              (TRNG_WPMR_LCKITEN_Msk & (_UINT32_(value) << TRNG_WPMR_LCKITEN_Pos)) /* Assignment of value for LCKITEN in the TRNG_WPMR register */
...
#define TRNG_WPMR_LCKCREN(value)              (TRNG_WPMR_LCKCREN_Msk & (_UINT32_(value) << TRNG_WPMR_LCKCREN_Pos)) /* Assignment of value for LCKCREN in the TRNG_WPMR register */
...
#define TRNG_WPSR_SDEE(value)                 (TRNG_WPSR_SDEE_Msk & (_UINT32_(value) << TRNG_WPSR_SDEE_Pos)) /* Assignment of value for SDEE in the TRNG_WPSR register */
...
#endif /* _SAMA7D_TRNG_COMPONENT_H_ */
