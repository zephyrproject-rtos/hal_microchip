...
#ifndef _SAMA7D_PUF_COMPONENT_H_
#define _SAMA7D_PUF_COMPONENT_H_
...
#define PUF_DATA_DEST_SO(value)               (PUF_DATA_DEST_SO_Msk & (_UINT32_(value) << PUF_DATA_DEST_SO_Pos)) /* Assignment of value for SO in the PUF_DATA_DEST register */
...
#define PUF_ASIER_SECE(value)                 (PUF_ASIER_SECE_Msk & (_UINT32_(value) << PUF_ASIER_SECE_Pos)) /* Assignment of value for SECE in the PUF_ASIER register */
...
#define PUF_ASISR_SECE(value)                 (PUF_ASISR_SECE_Msk & (_UINT32_(value) << PUF_ASISR_SECE_Pos)) /* Assignment of value for SECE in the PUF_ASISR register */
...
#define PUF_WPMR_WPEN(value)                  (PUF_WPMR_WPEN_Msk & (_UINT32_(value) << PUF_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the PUF_WPMR register */
...
#define PUF_WPMR_WPITEN(value)                (PUF_WPMR_WPITEN_Msk & (_UINT32_(value) << PUF_WPMR_WPITEN_Pos)) /* Assignment of value for WPITEN in the PUF_WPMR register */
...
#define PUF_WPMR_FIRSTE(value)                (PUF_WPMR_FIRSTE_Msk & (_UINT32_(value) << PUF_WPMR_FIRSTE_Pos)) /* Assignment of value for FIRSTE in the PUF_WPMR register */
...
#define PUF_WPMR_LCKWPEN(value)               (PUF_WPMR_LCKWPEN_Msk & (_UINT32_(value) << PUF_WPMR_LCKWPEN_Pos)) /* Assignment of value for LCKWPEN in the PUF_WPMR register */
...
#define PUF_WPMR_LCKWPITEN(value)             (PUF_WPMR_LCKWPITEN_Msk & (_UINT32_(value) << PUF_WPMR_LCKWPITEN_Pos)) /* Assignment of value for LCKWPITEN in the PUF_WPMR register */
...
#define PUF_WPMR_WPKEY(value)                 (PUF_WPMR_WPKEY_Msk & (_UINT32_(value) << PUF_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the PUF_WPMR register */
...
#define PUF_WPSR_WPVS(value)                  (PUF_WPSR_WPVS_Msk & (_UINT32_(value) << PUF_WPSR_WPVS_Pos)) /* Assignment of value for WPVS in the PUF_WPSR register */
...
#define PUF_WPSR_SWE(value)                   (PUF_WPSR_SWE_Msk & (_UINT32_(value) << PUF_WPSR_SWE_Pos)) /* Assignment of value for SWE in the PUF_WPSR register */
...
#define PUF_WPSR_WPSRC(value)                 (PUF_WPSR_WPSRC_Msk & (_UINT32_(value) << PUF_WPSR_WPSRC_Pos)) /* Assignment of value for WPSRC in the PUF_WPSR register */
...
#define PUF_WPSR_SWETYP(value)                (PUF_WPSR_SWETYP_Msk & (_UINT32_(value) << PUF_WPSR_SWETYP_Pos)) /* Assignment of value for SWETYP in the PUF_WPSR register */
...
#endif /* _SAMA7D_PUF_COMPONENT_H_ */
