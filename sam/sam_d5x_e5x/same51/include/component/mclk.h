...
#define MCLK_AHBMASK_Msk                      _UINT32_(0x00FEB75F)                                 /* (MCLK_AHBMASK) Register Mask  */
...
#define MCLK_AHBMASK_SDHC_Msk                 (_UINT32_(0x1) << MCLK_AHBMASK_SDHC_Pos)             /* (MCLK_AHBMASK Mask) SDHC */
...
#define MCLK_APBCMASK_Msk                     _UINT32_(0x00006FF8)                                 /* (MCLK_APBCMASK) Register Mask  */
