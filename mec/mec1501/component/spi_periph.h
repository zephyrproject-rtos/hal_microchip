...
#define MCHP_SPIP_GIRQ_VAL		(1ul << MCHP_SPIP_GIRQ_POS)
...
#define MCHP_SPIP_CFG_SINGLE		(0ul << 0)
#define MCHP_SPIP_CFG_QUAD		(1ul << 0)
#define MCHP_SPIP_CFG_TAR_POS		8
#define MCHP_SPIP_CFG_TAR_MASK0		0x03u
#define MCHP_SPIP_CFG_TAR_MASK		(0x03ul << 8)
#define MCHP_SPIP_CFG_TAR_1		(0x00ul << 8)
#define MCHP_SPIP_CFG_TAR_2		(0x01ul << 8)
#define MCHP_SPIP_CFG_TAR_4		(0x02ul << 8)
#define MCHP_SPIP_CFG_TAR_8		(0x03ul << 8)
#define MCHP_SPIP_CFG_WTM_POS		16
#define MCHP_SPIP_CFG_WTM_MASK0		0xffu
#define MCHP_SPIP_CFG_WTM_MASK		(0xfful << 16)

/* SPIP Status register */
#define MCHP_SPIP_STS_REG_OFS		4
#define MCHP_SPIP_STS_REG_MASK		0x1FFFEF7Bul
#define MCHP_SPIP_SPI_STS_MWD		(1ul << 0)
#define MCHP_SPIP_SPI_STS_MRD		(1ul << 1)
#define MCHP_SPIP_SPI_STS_MWB		(1ul << 3)
#define MCHP_SPIP_SPI_STS_MRB		(1ul << 4)
#define MCHP_SPIP_SPI_STS_SRTB		(1ul << 5)
#define MCHP_SPIP_SPI_STS_PHI_REQ	(1ul << 6)
#define MCHP_SPIP_SPI_STS_RXFE		(1ul << 8)
#define MCHP_SPIP_SPI_STS_RXFF		(1ul << 9)
#define MCHP_SPIP_SPI_STS_TXFE		(1ul << 10)
#define MCHP_SPIP_SPI_STS_TXFF		(1ul << 11)
#define MCHP_SPIP_SPI_STS_SCCE		(1ul << 13)
#define MCHP_SPIP_SPI_STS_OBF		(1ul << 15)
#define MCHP_SPIP_SPI_STS_SPIMR		(1ul << 16)
#define MCHP_SPIP_SPI_STS_RXF_RSTD	(1ul << 17)
#define MCHP_SPIP_SPI_STS_TXF_RSTD	(1ul << 18)
#define MCHP_SPIP_SPI_STS_LIM0		(1ul << 19)
#define MCHP_SPIP_SPI_STS_LIM1		(1ul << 20)
#define MCHP_SPIP_SPI_STS_ABERR		(1ul << 21)
#define MCHP_SPIP_SPI_STS_UNDEF_CMD	(1ul << 22)
#define MCHP_SPIP_SPI_STS_DVB		(1ul << 23)
#define MCHP_SPIP_SPI_STS_RXF_SZ	(1ul << 24)
#define MCHP_SPIP_SPI_STS_TXF_UNF	(1ul << 25)
#define MCHP_SPIP_SPI_STS_TXF_OVF	(1ul << 26)
#define MCHP_SPIP_SPI_STS_RXF_UNF	(1ul << 27)
#define MCHP_SPIP_SPI_STS_RXF_OVF	(1ul << 28)

/* SPIP EC Status register */
#define MCHP_SPIP_EC_STS_REG_OFS	8
#define MCHP_SPIP_EC_STS_REG_MASK	0x1FFFEF7Bul
#define MCHP_SPIP_EC_STS_MWD		(1ul << 0)
#define MCHP_SPIP_EC_STS_MRD		(1ul << 1)
#define MCHP_SPIP_EC_STS_MWB		(1ul << 3)
#define MCHP_SPIP_EC_STS_MRB		(1ul << 4)
#define MCHP_SPIP_EC_STS_SRTB		(1ul << 5)
#define MCHP_SPIP_EC_STS_PHI_REQ	(1ul << 6)
#define MCHP_SPIP_EC_STS_RXFE		(1ul << 8)
#define MCHP_SPIP_EC_STS_RXFF		(1ul << 9)
#define MCHP_SPIP_EC_STS_TXFE		(1ul << 10)
#define MCHP_SPIP_EC_STS_TXFF		(1ul << 11)
#define MCHP_SPIP_EC_STS_SCCE		(1ul << 13)
#define MCHP_SPIP_EC_STS_IBF		(1ul << 14)
#define MCHP_SPIP_EC_STS_OBF		(1ul << 15)
#define MCHP_SPIP_EC_STS_SPIMR		(1ul << 16)
#define MCHP_SPIP_EC_STS_RXF_RSTD	(1ul << 17)
#define MCHP_SPIP_EC_STS_TXF_RSTD	(1ul << 18)
#define MCHP_SPIP_EC_STS_LIM0		(1ul << 19)
#define MCHP_SPIP_EC_STS_LIM1		(1ul << 20)
#define MCHP_SPIP_EC_STS_ABERR		(1ul << 21)
#define MCHP_SPIP_EC_STS_UNDEF_CMD	(1ul << 22)
#define MCHP_SPIP_EC_STS_DVB		(1ul << 23)
#define MCHP_SPIP_EC_STS_RXF_SZ		(1ul << 24)
#define MCHP_SPIP_EC_STS_TXF_UNF	(1ul << 25)
#define MCHP_SPIP_EC_STS_TXF_OVF	(1ul << 26)
#define MCHP_SPIP_EC_STS_RXF_UNF	(1ul << 27)
#define MCHP_SPIP_EC_STS_RXF_OVF	(1ul << 28)

/* SPIP SPI Interrupt Enable register */
#define MCHP_SPIP_SPI_IEN_REG_OFS	0x0C
#define MCHP_SPIP_SPI_IEN_REG_MASK	0x1FFFAF7Bul
#define MCHP_SPIP_SPI_IEN_MWD		(1ul << 0)
#define MCHP_SPIP_SPI_IEN_MRD		(1ul << 1)
#define MCHP_SPIP_SPI_IEN_MWB		(1ul << 3)
#define MCHP_SPIP_SPI_IEN_MRB		(1ul << 4)
#define MCHP_SPIP_SPI_IEN_SRTB		(1ul << 5)
#define MCHP_SPIP_SPI_IEN_PHI_REQ	(1ul << 6)
#define MCHP_SPIP_SPI_IEN_RXFE		(1ul << 8)
#define MCHP_SPIP_SPI_IEN_RXFF		(1ul << 9)
#define MCHP_SPIP_SPI_IEN_TXFE		(1ul << 10)
#define MCHP_SPIP_SPI_IEN_TXFF		(1ul << 11)
#define MCHP_SPIP_SPI_IEN_SCCE		(1ul << 13)
#define MCHP_SPIP_SPI_IEN_OBF		(1ul << 15)
#define MCHP_SPIP_SPI_IEN_SPIMR		(1ul << 16)
#define MCHP_SPIP_SPI_IEN_RXF_RSTD	(1ul << 17)
#define MCHP_SPIP_SPI_IEN_TXF_RSTD	(1ul << 18)
#define MCHP_SPIP_SPI_IEN_LIM0		(1ul << 19)
#define MCHP_SPIP_SPI_IEN_LIM1		(1ul << 20)
#define MCHP_SPIP_SPI_IEN_ABERR		(1ul << 21)
#define MCHP_SPIP_SPI_IEN_UNDEF_CMD	(1ul << 22)
#define MCHP_SPIP_SPI_IEN_DVB		(1ul << 23)
#define MCHP_SPIP_SPI_IEN_RXF_SZ	(1ul << 24)
#define MCHP_SPIP_SPI_IEN_TXF_UNF	(1ul << 25)
#define MCHP_SPIP_SPI_IEN_TXF_OVF	(1ul << 26)
#define MCHP_SPIP_SPI_IEN_RXF_UNF	(1ul << 27)
#define MCHP_SPIP_SPI_IEN_RXF_OVF	(1ul << 28)

/* SPIP EC Interrupt Enable register */
#define MCHP_SPIP_EC_IEN_REG_OFS	0x10
#define MCHP_SPIP_EC_IEN_REG_MASK	0x1FFFEF7Bul
#define MCHP_SPIP_EC_IEN_MWD		(1ul << 0)
#define MCHP_SPIP_EC_IEN_MRD		(1ul << 1)
#define MCHP_SPIP_EC_IEN_MWB		(1ul << 3)
#define MCHP_SPIP_EC_IEN_MRB		(1ul << 4)
#define MCHP_SPIP_EC_IEN_SRTB		(1ul << 5)
#define MCHP_SPIP_EC_IEN_PHI_REQ	(1ul << 6)
#define MCHP_SPIP_EC_IEN_RXFE		(1ul << 8)
#define MCHP_SPIP_EC_IEN_RXFF		(1ul << 9)
#define MCHP_SPIP_EC_IEN_TXFE		(1ul << 10)
#define MCHP_SPIP_EC_IEN_TXFF		(1ul << 11)
#define MCHP_SPIP_EC_IEN_SCCE		(1ul << 13)
#define MCHP_SPIP_EC_IEN_IBF		(1ul << 14)
#define MCHP_SPIP_EC_IEN_OBF		(1ul << 15)
#define MCHP_SPIP_EC_IEN_SPIMR		(1ul << 16)
#define MCHP_SPIP_EC_IEN_RXF_RSTD	(1ul << 17)
#define MCHP_SPIP_EC_IEN_TXF_RSTD	(1ul << 18)
#define MCHP_SPIP_EC_IEN_LIM0		(1ul << 19)
#define MCHP_SPIP_EC_IEN_LIM1		(1ul << 20)
#define MCHP_SPIP_EC_IEN_ABERR		(1ul << 21)
#define MCHP_SPIP_EC_IEN_UNDEF_CMD	(1ul << 22)
#define MCHP_SPIP_EC_IEN_DVB		(1ul << 23)
#define MCHP_SPIP_EC_IEN_RXF_SZ		(1ul << 24)
#define MCHP_SPIP_EC_IEN_TXF_UNF	(1ul << 25)
#define MCHP_SPIP_EC_IEN_TXF_OVF	(1ul << 26)
#define MCHP_SPIP_EC_IEN_RXF_UNF	(1ul << 27)
#define MCHP_SPIP_EC_IEN_RXF_OVF	(1ul << 28)
...
#define MCHP_SPIP_MCFG_BAR0_EN		(1ul << 0)
#define MCHP_SPIP_MCFG_BAR1_EN_POS	1
#define MCHP_SPIP_MCFG_BAR1_EN		(1ul << 1)
...
#define MCHP_SPIP_SYSCFG_SRST		(1ul << 0)
#define MCHP_SPIP_SYSCFG_LOCK_WM	(1ul << 1)
#define MCHP_SPIP_SYSCFG_LOCK_TAR	(1ul << 2)
#define MCHP_SPIP_SYSCFG_LOCK_WC	(1ul << 3)
#define MCHP_SPIP_SYSCFG_LOCK_SPI_STS	(1ul << 4)
#define MCHP_SPIP_SYSCFG_LOCK_SPI_IEN	(1ul << 5)
#define MCHP_SPIP_SYSCFG_LOCK_MBA0	(1ul << 6)
#define MCHP_SPIP_SYSCFG_LOCK_MBA1	(1ul << 7)
#define MCHP_SPIP_SYSCFG_LOCK_TST	(1ul << 10)
#define MCHP_SPIP_SYSCFG_LOCK_ALL	0x04FEul
#define MCHP_SPIP_SYSCFG_ACT		(1ul << 16)
#define MCHP_SPIP_SYSCFG_MASK_EC	(1ul << 17)
#define MCHP_SPIP_SYSCFG_SIMPLE_MODE	(1ul << 18)
#define MCHP_SPIP_SYSCFG_ECDA		(1ul << 19)
