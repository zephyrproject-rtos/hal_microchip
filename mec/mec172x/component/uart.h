...
/** @file uart.h
 * MEC172x UART Peripheral Library API
 */
/** @defgroup MEC172x Peripherals UART
 */

#ifndef _COMPONENT_UART_H
#define _COMPONENT_UART_H
...
#endif /* #ifndef _COMPONENT_MCHP_UART_H */
/* end uart.h */
/**   @}
 */
