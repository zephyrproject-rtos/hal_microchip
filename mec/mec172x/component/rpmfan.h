...
/** @file rpmfan.h
 * MEC172x RPM to PWM Fan controller
 */
/** @defgroup MEC172x Peripherals RPMFAN
 */

#ifndef _COMPONENT_RPMFAN_H
#define _COMPONENT_RPMFAN_H
...
#endif	/* #ifndef _COMPONENT_RPMFAN_H */
/* end rpmfan.h */
/**   @}
 */
