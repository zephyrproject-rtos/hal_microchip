...
/** @file led.h
 * MEC172x Breathing-Blinking LED definitions
 */
/** @defgroup MEC172x Peripherals LED
 */

#ifndef _COMPONENT_LED_H
#define _COMPONENT_LED_H
...
#define MCHP_LED_ADDR(n) \
	(MCHP_LED_BASE_ADDR + ((uint32_t)(n) * MCHP_LED_SPACING))
