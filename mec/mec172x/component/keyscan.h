...
/** @file keyscan.h
 * MEC172x Keyboard matrix scan controller registers
 */
/** @defgroup MEC172x Peripherals KSCAN
 */

#ifndef _COMPONENT_KSCAN_H
#define _COMPONENT_KSCAN_H
...
#endif	/* #ifndef _COMPONENT_KSCAN_H */
/* end kscan.h */
/**   @}
 */
