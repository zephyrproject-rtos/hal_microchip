...
/** @file ps2_ctrl.h
 * MEC172x PS/2 Controller Registers
 */
/** @defgroup MEC172x Peripherals PS/2
 */

#ifndef _COMPONENT_PS2_CTRL_H
#define _COMPONENT_PS2_CTRL_H
...
#endif	/* #ifndef _COMPONENT_PS2_CTRL_H */
/* end ps2_ctrl.h */
/**   @}
 */
