...
/** @file vbat.h
 * MEC172x VBAT Registers and memory definitions
 */
/** @defgroup MEC172x Peripherals VBAT
 */

#ifndef _COMPONENT_VBAT_H
#define _COMPONENT_VBAT_H
...
/* Monotonic Counter least significant word (32-bit)
 * Read-only. Incrementes by one on read. */
...
#endif /* #ifndef _COMPONENT_VBAT_H */
/* end vbat.h */
/**   @}
 */
