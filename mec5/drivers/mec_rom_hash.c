...
typedef void (*rom_hash_init_state_td)(struct mchphash *c, struct mchphashstate *h, char *dmamem);
...
typedef int (*rom_hash_feed_td)(struct mchphash *c, const char *msg, size_t sz);
typedef int (*rom_hash_digest_td)(struct mchphash *c, char *digest);
