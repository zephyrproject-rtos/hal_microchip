...
/**
 * @file qtm_scroller_0x000b_api.h
 * @brief Top-level include file for touch peripheral.
 *
 * This header provides a central place to include macro mapping headers
 * for Microchip touch support for scroller module. These headers map
 * scroller data containers and associated peripheral headers to generic names
