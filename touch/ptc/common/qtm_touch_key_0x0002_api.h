...
/**
 * @file qtm_touch_key_0x0002_api.h
...
/* Sensor group data */
typedef struct {
	uint8_t qtm_keys_status;        /* Status byte - bitfield: Bit 7 = REBURST_REQ, Bits 6:1 =
					   Reserved, Bit 0 = Detect */
 ...
 * Notes  : none
 */
touch_ret_t qtm_key_suspend(uint16_t which_sensor_key,
 ...
 * Notes  : none
 */
touch_ret_t qtm_key_resume(uint16_t which_sensor_key,
			   qtm_touch_key_control_t *qtm_lib_key_group_ptr);
